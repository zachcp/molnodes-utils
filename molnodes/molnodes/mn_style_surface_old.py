...
class MN_style_surface_old(bpy.types.Operator):
	bl_idname = "node.mn_style_surface_old"
	bl_label = "MN_style_surface_old"
	...
	def execute(self, context):
		...
		def _mn_utils_to_instance_centred_node_group():
			...
			#Socket Geometry
			geometry_socket_6 = _mn_utils_to_instance_centred.interface.new_socket(name = "Geometry", in_out='OUTPUT', socket_type = 'NodeSocketGeometry')
			...
			#node Bounding Box
			bounding_box_1 = _mn_utils_to_instance_centred.nodes.new("GeometryNodeBoundBox")
			...
			#node Vector Math
			vector_math_1 = _mn_utils_to_instance_centred.nodes.new("ShaderNodeVectorMath")
			vector_math_1.label = "-x"
			...
			#node Group Input
			group_input_6 = _mn_utils_to_instance_centred.nodes.new("NodeGroupInput")
			...
			#node Group Output
			group_output_6 = _mn_utils_to_instance_centred.nodes.new("NodeGroupOutput")
			group_output_6.name = "Group Output"
			group_output_6.is_active_output = True
			
			#node Reroute.001
			reroute_001_3 = _mn_utils_to_instance_centred.nodes.new("NodeReroute")
			reroute_001_3.name = "Reroute.001"
			
			
			
			#Set locations
			bounding_box_1.location = (-338.7969970703125, -30.0)
			transform_geometry.location = (21.2030029296875, 90.0)
			transform_geometry_001.location = (361.2030029296875, 90.0)
			vector_math_1.location = (-178.7969970703125, -50.0)
			mix.location = (-178.7969970703125, -90.0)
			group_input_6.location = (-600.0, 100.0)
			geometry_to_instance.location = (181.2030029296875, 90.0)
			group_output_6.location = (560.0, 100.0)
			reroute_001_3.location = (-380.0, 40.0)
			...
			#reroute_001_3.Output -> transform_geometry.Geometry
			_mn_utils_to_instance_centred.links.new(reroute_001_3.outputs[0], transform_geometry.inputs[0])
			#reroute_001_3.Output -> bounding_box_1.Geometry
			_mn_utils_to_instance_centred.links.new(reroute_001_3.outputs[0], bounding_box_1.inputs[0])
			...
			#mix.Result -> vector_math_1.Vector
			_mn_utils_to_instance_centred.links.new(mix.outputs[1], vector_math_1.inputs[0])
			#vector_math_1.Vector -> transform_geometry.Translation
			_mn_utils_to_instance_centred.links.new(vector_math_1.outputs[0], transform_geometry.inputs[1])
			...
			#bounding_box_1.Min -> mix.A
			_mn_utils_to_instance_centred.links.new(bounding_box_1.outputs[1], mix.inputs[4])
			...
			#bounding_box_1.Max -> mix.B
			_mn_utils_to_instance_centred.links.new(bounding_box_1.outputs[2], mix.inputs[5])
			#group_input_6.Input -> reroute_001_3.Input
			_mn_utils_to_instance_centred.links.new(group_input_6.outputs[0], reroute_001_3.inputs[0])
			#transform_geometry_001.Geometry -> group_output_6.Geometry
			_mn_utils_to_instance_centred.links.new(transform_geometry_001.outputs[0], group_output_6.inputs[0])
		...
		def mn_style_surface_old_node_group():
			mn_style_surface_old = bpy.data.node_groups.new(type = 'GeometryNodeTree', name = "MN_style_surface_old")
			...
			#Socket Geometry
			geometry_socket_7 = mn_style_surface_old.interface.new_socket(name = "Geometry", in_out='OUTPUT', socket_type = 'NodeSocketGeometry')
			geometry_socket_7.attribute_domain = 'POINT'
			
			#Socket Instances
			instances_socket = mn_style_surface_old.interface.new_socket(name = "Instances", in_out='OUTPUT', socket_type = 'NodeSocketGeometry')
			instances_socket.attribute_domain = 'POINT'
			
			#Socket Atoms
			atoms_socket_3 = mn_style_surface_old.interface.new_socket(name = "Atoms", in_out='INPUT', socket_type = 'NodeSocketGeometry')
			atoms_socket_3.attribute_domain = 'POINT'
			atoms_socket_3.description = "Atomic geometry that contains vertices and edges"
			
			#Socket Selection
			selection_socket_1 = mn_style_surface_old.interface.new_socket(name = "Selection", in_out='INPUT', socket_type = 'NodeSocketBool')
			...
			#Socket Quality
			quality_socket_1 = mn_style_surface_old.interface.new_socket(name = "Quality", in_out='INPUT', socket_type = 'NodeSocketInt')
			...
			#Panel Surface
			surface_panel = mn_style_surface_old.interface.new_panel("Surface", default_closed=True)
			#Socket Scale Radii
			scale_radii_socket_1 = mn_style_surface_old.interface.new_socket(name = "Scale Radii", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = surface_panel)
			...
			#Socket Probe Size
			probe_size_socket_2 = mn_style_surface_old.interface.new_socket(name = "Probe Size", in_out='INPUT', socket_type = 'NodeSocketFloat', parent = surface_panel)
			probe_size_socket_2.default_value = 0.800000011920929
			...
			probe_size_socket_2.description = "Scale the probe that is used to check for solvent accessibility"
			
			#Socket Separate
			separate_socket = mn_style_surface_old.interface.new_socket(name = "Separate", in_out='INPUT', socket_type = 'NodeSocketBool', parent = surface_panel)
			separate_socket.default_value = True
			...
			#Socket Attribute
			attribute_socket = mn_style_surface_old.interface.new_socket(name = "Attribute", in_out='INPUT', socket_type = 'NodeSocketString', parent = surface_panel)
			attribute_socket.default_value = "chain_id"
			attribute_socket.attribute_domain = 'POINT'
			attribute_socket.description = "Attribute to separate the surface by"
			
			
			#Panel Color
			color_panel = mn_style_surface_old.interface.new_panel("Color", default_closed=True)
			#Socket Color by CA
			color_by_ca_socket_1 = mn_style_surface_old.interface.new_socket(name = "Color by CA", in_out='INPUT', socket_type = 'NodeSocketBool', parent = color_panel)
			color_by_ca_socket_1.default_value = True
			...
			#Socket Color Blur
			color_blur_socket = mn_style_surface_old.interface.new_socket(name = "Color Blur", in_out='INPUT', socket_type = 'NodeSocketInt', parent = color_panel)
			color_blur_socket.default_value = 2
			...
			color_blur_socket.description = "When coloring the surface, blur colors from nearby atoms"
			
			
			#Panel Material
			material_panel = mn_style_surface_old.interface.new_panel("Material", default_closed=True)
			#Socket Shade Smooth
			shade_smooth_socket_1 = mn_style_surface_old.interface.new_socket(name = "Shade Smooth", in_out='INPUT', socket_type = 'NodeSocketBool', parent = material_panel)
			...
			#Socket Material
			material_socket_1 = mn_style_surface_old.interface.new_socket(name = "Material", in_out='INPUT', socket_type = 'NodeSocketMaterial', parent = material_panel)
			...
			#node Named Attribute
			named_attribute_1 = mn_style_surface_old.nodes.new("GeometryNodeInputNamedAttribute")
			named_attribute_1.name = "Named Attribute"
			named_attribute_1.data_type = 'INT'
			
			#node Compare
			compare_2 = mn_style_surface_old.nodes.new("FunctionNodeCompare")
			...
			#node Repeat Input
			repeat_input = mn_style_surface_old.nodes.new("GeometryNodeRepeatInput")
			repeat_input.name = "Repeat Input"
			#node Attribute Statistic
			attribute_statistic = mn_style_surface_old.nodes.new("GeometryNodeAttributeStatistic")
			...
			#node Reroute
			reroute_2 = mn_style_surface_old.nodes.new("NodeReroute")
			reroute_2.name = "Reroute"
			#node Math.001
			math_001_3 = mn_style_surface_old.nodes.new("ShaderNodeMath")
			...
			separate_geometry_002 = mn_style_surface_old.nodes.new("GeometryNodeSeparateGeometry")
			separate_geometry_002.name = "Separate Geometry.002"
			separate_geometry_002.domain = 'POINT'
			
			#node Join Geometry
			join_geometry = mn_style_surface_old.nodes.new("GeometryNodeJoinGeometry")
			join_geometry.name = "Join Geometry"
			
			#node Separate Geometry.001
			separate_geometry_001_1 = mn_style_surface_old.nodes.new("GeometryNodeSeparateGeometry")
			...
			#node Math
			math_2 = mn_style_surface_old.nodes.new("ShaderNodeMath")
			math_2.label = "x + 1"
			math_2.name = "Math"
			math_2.hide = True
			...
			join_geometry_001 = mn_style_surface_old.nodes.new("GeometryNodeJoinGeometry")
			join_geometry_001.name = "Join Geometry.001"
			
			#node Group
			group = mn_style_surface_old.nodes.new("GeometryNodeGroup")
			group.name = "Group"
			group.node_tree = _mn_utils_to_instance_centred
			
			#node Separate Geometry
			separate_geometry_1 = mn_style_surface_old.nodes.new("GeometryNodeSeparateGeometry")
			separate_geometry_1.name = "Separate Geometry"
			separate_geometry_1.domain = 'POINT'
			
			#node Reroute.001
			reroute_001_4 = mn_style_surface_old.nodes.new("NodeReroute")
			reroute_001_4.name = "Reroute.001"
			#node Group Output
			group_output_7 = mn_style_surface_old.nodes.new("NodeGroupOutput")
			group_output_7.name = "Group Output"
			group_output_7.is_active_output = True
			
			#node Repeat Output
			repeat_output = mn_style_surface_old.nodes.new("GeometryNodeRepeatOutput")
			...
			join_geometry_002 = mn_style_surface_old.nodes.new("GeometryNodeJoinGeometry")
			join_geometry_002.name = "Join Geometry.002"
			
			#node Group Input
			group_input_7 = mn_style_surface_old.nodes.new("NodeGroupInput")
			...
			#node Reroute.002
			reroute_002_2 = mn_style_surface_old.nodes.new("NodeReroute")
			reroute_002_2.name = "Reroute.002"
			#node Group Input.001
			group_input_001 = mn_style_surface_old.nodes.new("NodeGroupInput")
			group_input_001.name = "Group Input.001"
			group_input_001.outputs[6].hide = True
			
			#node Math.002
			math_002_1 = mn_style_surface_old.nodes.new("ShaderNodeMath")
			math_002_1.name = "Math.002"
			math_002_1.operation = 'MULTIPLY'
			math_002_1.use_clamp = False
			#Value_001
			math_002_1.inputs[1].default_value = 3.0
			
			#node Math.003
			math_003_2 = mn_style_surface_old.nodes.new("ShaderNodeMath")
			...
			#node Group Input.002
			group_input_002_1 = mn_style_surface_old.nodes.new("NodeGroupInput")
			...
			#Set locations
			named_attribute_1.location = (-702.0, 60.0)
			compare_2.location = (-40.0, -200.0)
			repeat_input.location = (-40.0, 100.0)
			attribute_statistic.location = (-300.0, 100.0)
			reroute_2.location = (-340.0, -100.0)
			math_001_3.location = (-300.0, 140.0)
			separate_geometry_002.location = (-521.051513671875, -390.30389404296875)
			join_geometry.location = (800.0, -60.0)
			separate_geometry_001_1.location = (-740.0, -380.0)
			group_071.location = (440.0, -580.0)
			group_070.location = (442.05645751953125, -137.9451904296875)
			math_2.location = (260.0, 61.039306640625)
			join_geometry_001.location = (1680.0, -20.0)
			group.location = (800.0, -140.0)
			separate_geometry_1.location = (220.0, -40.0)
			reroute_001_4.location = (2040.0, -160.0)
			group_output_7.location = (2260.0, 140.0)
			repeat_output.location = (1860.0, 180.0)
			join_geometry_002.location = (2100.0, 160.0)
			group_input_7.location = (-980.0, -460.0)
			reroute_002_2.location = (-120.0, -580.0)
			group_input_001.location = (-480.0, -740.0)
			math_002_1.location = (-300.0, -700.0)
			math_003_2.location = (-300.0, -540.0)
			group_input_002_1.location = (-880.0, 60.0)
			...
			group.width, group.height = 225.6224365234375, 100.0
			...
			#repeat_input.i -> math_2.Value
			mn_style_surface_old.links.new(repeat_input.outputs[1], math_2.inputs[0])
			#math_2.Value -> repeat_output.i
			mn_style_surface_old.links.new(math_2.outputs[0], repeat_output.inputs[1])
			#repeat_input.Atoms -> separate_geometry_1.Geometry
			mn_style_surface_old.links.new(repeat_input.outputs[0], separate_geometry_1.inputs[0])
			#repeat_input.i -> compare_2.A
			mn_style_surface_old.links.new(repeat_input.outputs[1], compare_2.inputs[2])
			#named_attribute_1.Attribute -> attribute_statistic.Attribute
			mn_style_surface_old.links.new(named_attribute_1.outputs[0], attribute_statistic.inputs[2])
			#named_attribute_1.Attribute -> compare_2.B
			mn_style_surface_old.links.new(named_attribute_1.outputs[0], compare_2.inputs[3])
			#compare_2.Result -> separate_geometry_1.Selection
			mn_style_surface_old.links.new(compare_2.outputs[0], separate_geometry_1.inputs[1])
			#separate_geometry_1.Inverted -> repeat_output.Atoms
			mn_style_surface_old.links.new(separate_geometry_1.outputs[1], repeat_output.inputs[0])
			#separate_geometry_1.Selection -> group_070.Atoms
			mn_style_surface_old.links.new(separate_geometry_1.outputs[0], group_070.inputs[0])
			#group_070.Geometry -> join_geometry.Geometry
			mn_style_surface_old.links.new(group_070.outputs[0], join_geometry.inputs[0])
			#join_geometry.Geometry -> repeat_output.Surfaces
			mn_style_surface_old.links.new(join_geometry.outputs[0], repeat_output.inputs[2])
			#group_input_001.Material -> group_070.Material
			mn_style_surface_old.links.new(group_input_001.outputs[10], group_070.inputs[9])
			#group_input_7.Atoms -> separate_geometry_001_1.Geometry
			mn_style_surface_old.links.new(group_input_7.outputs[0], separate_geometry_001_1.inputs[0])
			#group_input_7.Selection -> separate_geometry_001_1.Selection
			mn_style_surface_old.links.new(group_input_7.outputs[1], separate_geometry_001_1.inputs[1])
			#reroute_2.Output -> attribute_statistic.Geometry
			mn_style_surface_old.links.new(reroute_2.outputs[0], attribute_statistic.inputs[0])
			#reroute_2.Output -> repeat_input.Atoms
			mn_style_surface_old.links.new(reroute_2.outputs[0], repeat_input.inputs[1])
			#reroute_002_2.Output -> group_070.Quality
			mn_style_surface_old.links.new(reroute_002_2.outputs[0], group_070.inputs[2])
			#group_input_001.Scale Radii -> group_070.Scale Radii
			mn_style_surface_old.links.new(group_input_001.outputs[3], group_070.inputs[3])
			#group_input_001.Probe Size -> group_070.Probe Size
			mn_style_surface_old.links.new(group_input_001.outputs[4], group_070.inputs[4])
			#group_input_001.Color by CA -> group_070.Color by CA
			mn_style_surface_old.links.new(group_input_001.outputs[7], group_070.inputs[6])
			#group_input_001.Color Blur -> group_070.Interpolate Color
			mn_style_surface_old.links.new(group_input_001.outputs[8], group_070.inputs[7])
			#group_input_001.Shade Smooth -> group_070.Shade Smooth
			mn_style_surface_old.links.new(group_input_001.outputs[9], group_070.inputs[8])
			#group.Geometry -> join_geometry_001.Geometry
			mn_style_surface_old.links.new(group.outputs[0], join_geometry_001.inputs[0])
			#join_geometry_001.Geometry -> repeat_output.Instances
			mn_style_surface_old.links.new(join_geometry_001.outputs[0], repeat_output.inputs[3])
			#repeat_output.Instances -> group_output_7.Instances
			mn_style_surface_old.links.new(repeat_output.outputs[3], group_output_7.inputs[1])
			#math_001_3.Value -> repeat_input.Iterations
			mn_style_surface_old.links.new(math_001_3.outputs[0], repeat_input.inputs[0])
			#attribute_statistic.Max -> math_001_3.Value
			mn_style_surface_old.links.new(attribute_statistic.outputs[4], math_001_3.inputs[0])
			#group_input_001.Material -> group_071.Material
			mn_style_surface_old.links.new(group_input_001.outputs[10], group_071.inputs[9])
			#reroute_002_2.Output -> group_071.Quality
			mn_style_surface_old.links.new(reroute_002_2.outputs[0], group_071.inputs[2])
			#group_input_001.Scale Radii -> group_071.Scale Radii
			mn_style_surface_old.links.new(group_input_001.outputs[3], group_071.inputs[3])
			#group_input_001.Probe Size -> group_071.Probe Size
			mn_style_surface_old.links.new(group_input_001.outputs[4], group_071.inputs[4])
			#group_input_001.Color by CA -> group_071.Color by CA
			mn_style_surface_old.links.new(group_input_001.outputs[7], group_071.inputs[6])
			#group_input_001.Color Blur -> group_071.Interpolate Color
			mn_style_surface_old.links.new(group_input_001.outputs[8], group_071.inputs[7])
			#group_input_001.Shade Smooth -> group_071.Shade Smooth
			mn_style_surface_old.links.new(group_input_001.outputs[9], group_071.inputs[8])
			#separate_geometry_001_1.Selection -> separate_geometry_002.Geometry
			mn_style_surface_old.links.new(separate_geometry_001_1.outputs[0], separate_geometry_002.inputs[0])
			#group_input_7.Separate -> separate_geometry_002.Selection
			mn_style_surface_old.links.new(group_input_7.outputs[5], separate_geometry_002.inputs[1])
			#separate_geometry_002.Selection -> reroute_2.Input
			mn_style_surface_old.links.new(separate_geometry_002.outputs[0], reroute_2.inputs[0])
			#separate_geometry_002.Inverted -> group_071.Atoms
			mn_style_surface_old.links.new(separate_geometry_002.outputs[1], group_071.inputs[0])
			#reroute_001_4.Output -> join_geometry_002.Geometry
			mn_style_surface_old.links.new(reroute_001_4.outputs[0], join_geometry_002.inputs[0])
			#join_geometry_002.Geometry -> group_output_7.Geometry
			mn_style_surface_old.links.new(join_geometry_002.outputs[0], group_output_7.inputs[0])
			#group_070.Geometry -> group.Input
			mn_style_surface_old.links.new(group_070.outputs[0], group.inputs[0])
			#group_071.Geometry -> reroute_001_4.Input
			mn_style_surface_old.links.new(group_071.outputs[0], reroute_001_4.inputs[0])
			#group_input_001.Quality -> math_002_1.Value
			mn_style_surface_old.links.new(group_input_001.outputs[2], math_002_1.inputs[0])
			#math_002_1.Value -> math_003_2.Value
			mn_style_surface_old.links.new(math_002_1.outputs[0], math_003_2.inputs[0])
			#math_003_2.Value -> reroute_002_2.Input
			mn_style_surface_old.links.new(math_003_2.outputs[0], reroute_002_2.inputs[0])
			#group_input_002_1.Attribute -> named_attribute_1.Name
			mn_style_surface_old.links.new(group_input_002_1.outputs[6], named_attribute_1.inputs[0])
			#repeat_input.Instances -> join_geometry_001.Geometry
			mn_style_surface_old.links.new(repeat_input.outputs[3], join_geometry_001.inputs[0])
			#repeat_input.Surfaces -> join_geometry.Geometry
			mn_style_surface_old.links.new(repeat_input.outputs[2], join_geometry.inputs[0])
			#repeat_output.Surfaces -> join_geometry_002.Geometry
			mn_style_surface_old.links.new(repeat_output.outputs[2], join_geometry_002.inputs[0])
		...
		mod = obj.modifiers.new(name = "MN_style_surface_old", type = 'NODES')
		mod.node_group = mn_style_surface_old
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(MN_style_surface_old.bl_idname)
