...
class MN_dna_style_ball_and_stick(bpy.types.Operator):
	bl_idname = "node.mn_dna_style_ball_and_stick"
	bl_label = "MN_dna_style_ball_and_stick"
	...
	def execute(self, context):
		...
		def mn_dna_style_ball_and_stick_node_group():
			mn_dna_style_ball_and_stick = bpy.data.node_groups.new(type = 'GeometryNodeTree', name = "MN_dna_style_ball_and_stick")
			...
			#Socket Bases
			bases_socket = mn_dna_style_ball_and_stick.interface.new_socket(name = "Bases", in_out='OUTPUT', socket_type = 'NodeSocketGeometry')
			bases_socket.attribute_domain = 'POINT'
			
			#Socket Bases
			bases_socket_1 = mn_dna_style_ball_and_stick.interface.new_socket(name = "Bases", in_out='INPUT', socket_type = 'NodeSocketGeometry')
			...
			#Socket Material
			material_socket_1 = mn_dna_style_ball_and_stick.interface.new_socket(name = "Material", in_out='INPUT', socket_type = 'NodeSocketMaterial')
			...
			#node Named Attribute.002
			named_attribute_002_2 = mn_dna_style_ball_and_stick.nodes.new("GeometryNodeInputNamedAttribute")
			named_attribute_002_2.name = "Named Attribute.002"
			named_attribute_002_2.data_type = 'INT'
			#Name
			named_attribute_002_2.inputs[0].default_value = "res_name"
			
			#node Compare.001
			compare_001 = mn_dna_style_ball_and_stick.nodes.new("FunctionNodeCompare")
			...
			#node Compare.002
			compare_002_1 = mn_dna_style_ball_and_stick.nodes.new("FunctionNodeCompare")
			compare_002_1.name = "Compare.002"
			compare_002_1.data_type = 'INT'
			compare_002_1.mode = 'ELEMENT'
			compare_002_1.operation = 'EQUAL'
			#B_INT
			compare_002_1.inputs[3].default_value = 31
			
			#node Compare.003
			compare_003_1 = mn_dna_style_ball_and_stick.nodes.new("FunctionNodeCompare")
			compare_003_1.name = "Compare.003"
			compare_003_1.data_type = 'INT'
			compare_003_1.mode = 'ELEMENT'
			compare_003_1.operation = 'EQUAL'
			#B_INT
			compare_003_1.inputs[3].default_value = 32
			
			#node Compare.004
			compare_004_1 = mn_dna_style_ball_and_stick.nodes.new("FunctionNodeCompare")
			compare_004_1.name = "Compare.004"
			compare_004_1.data_type = 'INT'
			compare_004_1.mode = 'ELEMENT'
			compare_004_1.operation = 'EQUAL'
			#B_INT
			compare_004_1.inputs[3].default_value = 33
			
			#node Geometry to Instance
			geometry_to_instance = mn_dna_style_ball_and_stick.nodes.new("GeometryNodeGeometryToInstance")
			geometry_to_instance.name = "Geometry to Instance"
			
			#node Group Output
			group_output_2 = mn_dna_style_ball_and_stick.nodes.new("NodeGroupOutput")
			group_output_2.name = "Group Output"
			group_output_2.is_active_output = True
			
			#node Realize Instances
			realize_instances_1 = mn_dna_style_ball_and_stick.nodes.new("GeometryNodeRealizeInstances")
			...
			separate_geometry_002 = mn_dna_style_ball_and_stick.nodes.new("GeometryNodeSeparateGeometry")
			separate_geometry_002.name = "Separate Geometry.002"
			separate_geometry_002.domain = 'POINT'
			
			#node Separate Geometry.001
			separate_geometry_001_1 = mn_dna_style_ball_and_stick.nodes.new("GeometryNodeSeparateGeometry")
			separate_geometry_001_1.name = "Separate Geometry.001"
			separate_geometry_001_1.domain = 'POINT'
			
			#node Group Input
			group_input_2 = mn_dna_style_ball_and_stick.nodes.new("NodeGroupInput")
			group_input_2.name = "Group Input"
			
			#node Group
			group_1 = mn_dna_style_ball_and_stick.nodes.new("GeometryNodeGroup")
			group_1.name = "Group"
			group_1.node_tree = _mn_utils_style_old_ball_and_stick
			
			#node Group.001
			group_001 = mn_dna_style_ball_and_stick.nodes.new("GeometryNodeGroup")
			group_001.name = "Group.001"
			group_001.node_tree = _mn_utils_style_old_ball_and_stick
			
			#node Separate Geometry.003
			separate_geometry_003 = mn_dna_style_ball_and_stick.nodes.new("GeometryNodeSeparateGeometry")
			separate_geometry_003.name = "Separate Geometry.003"
			separate_geometry_003.domain = 'POINT'
			
			#node Group.002
			group_002 = mn_dna_style_ball_and_stick.nodes.new("GeometryNodeGroup")
			group_002.name = "Group.002"
			group_002.node_tree = _mn_utils_style_old_ball_and_stick
			
			#node Group.003
			group_003 = mn_dna_style_ball_and_stick.nodes.new("GeometryNodeGroup")
			group_003.name = "Group.003"
			group_003.node_tree = _mn_utils_style_old_ball_and_stick
			
			#node Separate Geometry.004
			separate_geometry_004 = mn_dna_style_ball_and_stick.nodes.new("GeometryNodeSeparateGeometry")
			...
			#Set locations
			named_attribute_002_2.location = (-271.8153076171875, 270.0)
			compare_001.location = (-73.56605529785156, 281.95001220703125)
			compare_002_1.location = (-60.0, -200.0)
			compare_003_1.location = (-60.0, -620.0)
			compare_004_1.location = (-60.0, -1040.0)
			geometry_to_instance.location = (1220.4346923828125, -9.42071533203125)
			group_output_2.location = (1567.566162109375, -43.01692199707031)
			realize_instances_1.location = (-280.0, 120.0)
			separate_geometry_002.location = (120.0, -180.0)
			separate_geometry_001_1.location = (108.18467712402344, 290.0)
			group_input_2.location = (-508.1846923828125, -0.0)
			group_1.location = (450.9639892578125, 332.1063232421875)
			group_001.location = (440.0, -160.0)
			separate_geometry_003.location = (120.0, -600.0)
			group_002.location = (440.0, -660.0)
			group_003.location = (440.0, -1140.0)
			separate_geometry_004.location = (120.0, -1020.0)
			...
			group_002.width, group_002.height = 200.0, 100.0
			group_003.width, group_003.height = 200.0, 100.0
			separate_geometry_004.width, separate_geometry_004.height = 140.0, 100.0
			
			#initialize mn_dna_style_ball_and_stick links
			#group_input_2.Bases -> realize_instances_1.Geometry
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[0], realize_instances_1.inputs[0])
			#realize_instances_1.Geometry -> separate_geometry_001_1.Geometry
			mn_dna_style_ball_and_stick.links.new(realize_instances_1.outputs[0], separate_geometry_001_1.inputs[0])
			#compare_001.Result -> separate_geometry_001_1.Selection
			mn_dna_style_ball_and_stick.links.new(compare_001.outputs[0], separate_geometry_001_1.inputs[1])
			#named_attribute_002_2.Attribute -> compare_001.A
			mn_dna_style_ball_and_stick.links.new(named_attribute_002_2.outputs[0], compare_001.inputs[2])
			#realize_instances_1.Geometry -> separate_geometry_002.Geometry
			mn_dna_style_ball_and_stick.links.new(realize_instances_1.outputs[0], separate_geometry_002.inputs[0])
			#compare_002_1.Result -> separate_geometry_002.Selection
			mn_dna_style_ball_and_stick.links.new(compare_002_1.outputs[0], separate_geometry_002.inputs[1])
			#named_attribute_002_2.Attribute -> compare_002_1.A
			mn_dna_style_ball_and_stick.links.new(named_attribute_002_2.outputs[0], compare_002_1.inputs[2])
			#realize_instances_1.Geometry -> separate_geometry_003.Geometry
			mn_dna_style_ball_and_stick.links.new(realize_instances_1.outputs[0], separate_geometry_003.inputs[0])
			#compare_003_1.Result -> separate_geometry_003.Selection
			mn_dna_style_ball_and_stick.links.new(compare_003_1.outputs[0], separate_geometry_003.inputs[1])
			#named_attribute_002_2.Attribute -> compare_003_1.A
			mn_dna_style_ball_and_stick.links.new(named_attribute_002_2.outputs[0], compare_003_1.inputs[2])
			#realize_instances_1.Geometry -> separate_geometry_004.Geometry
			mn_dna_style_ball_and_stick.links.new(realize_instances_1.outputs[0], separate_geometry_004.inputs[0])
			#compare_004_1.Result -> separate_geometry_004.Selection
			mn_dna_style_ball_and_stick.links.new(compare_004_1.outputs[0], separate_geometry_004.inputs[1])
			#named_attribute_002_2.Attribute -> compare_004_1.A
			mn_dna_style_ball_and_stick.links.new(named_attribute_002_2.outputs[0], compare_004_1.inputs[2])
			#geometry_to_instance.Instances -> group_output_2.Bases
			mn_dna_style_ball_and_stick.links.new(geometry_to_instance.outputs[0], group_output_2.inputs[0])
			#separate_geometry_001_1.Selection -> group_1.Atoms
			mn_dna_style_ball_and_stick.links.new(separate_geometry_001_1.outputs[0], group_1.inputs[0])
			#group_input_2.Selection -> group_1.Selection
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[1], group_1.inputs[1])
			#group_input_2.Shade Smooth -> group_1.Shade Smooth
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[2], group_1.inputs[2])
			#group_input_2.Ball Resolution -> group_1.Ball Resolution
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[3], group_1.inputs[3])
			#group_input_2.Ball Radius -> group_1.Ball Radius
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[4], group_1.inputs[4])
			#group_input_2.Find Bonds -> group_1.Find Bonds
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[5], group_1.inputs[5])
			#group_input_2.Bond Resolution -> group_1.Bond Resolution
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[6], group_1.inputs[6])
			#group_input_2.Bond Radius -> group_1.Bond Radius
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[7], group_1.inputs[7])
			#group_input_2.Material -> group_1.Material
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[8], group_1.inputs[14])
			#group_input_2.Split Double Bonds -> group_1.Split Double Bonds
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[9], group_1.inputs[8])
			#group_input_2.Double Bond Curve -> group_1.Double Bond Curve
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[10], group_1.inputs[9])
			#group_input_2.Double Bond Width -> group_1.Double Bond Width
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[11], group_1.inputs[10])
			#group_input_2.Double Bond Resolution -> group_1.Double Bond Resolution
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[12], group_1.inputs[11])
			#group_input_2.Double Bond Radius -> group_1.Double Bond Radius
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[13], group_1.inputs[12])
			#group_input_2.Double Bond Rotate -> group_1.Double Bond Rotate
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[14], group_1.inputs[13])
			#group_input_2.Selection -> group_001.Selection
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[1], group_001.inputs[1])
			#group_input_2.Shade Smooth -> group_001.Shade Smooth
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[2], group_001.inputs[2])
			#group_input_2.Ball Resolution -> group_001.Ball Resolution
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[3], group_001.inputs[3])
			#group_input_2.Ball Radius -> group_001.Ball Radius
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[4], group_001.inputs[4])
			#group_input_2.Find Bonds -> group_001.Find Bonds
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[5], group_001.inputs[5])
			#group_input_2.Bond Resolution -> group_001.Bond Resolution
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[6], group_001.inputs[6])
			#group_input_2.Bond Radius -> group_001.Bond Radius
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[7], group_001.inputs[7])
			#group_input_2.Material -> group_001.Material
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[8], group_001.inputs[14])
			#group_input_2.Split Double Bonds -> group_001.Split Double Bonds
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[9], group_001.inputs[8])
			#group_input_2.Double Bond Curve -> group_001.Double Bond Curve
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[10], group_001.inputs[9])
			#group_input_2.Double Bond Width -> group_001.Double Bond Width
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[11], group_001.inputs[10])
			#group_input_2.Double Bond Resolution -> group_001.Double Bond Resolution
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[12], group_001.inputs[11])
			#group_input_2.Double Bond Radius -> group_001.Double Bond Radius
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[13], group_001.inputs[12])
			#group_input_2.Double Bond Rotate -> group_001.Double Bond Rotate
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[14], group_001.inputs[13])
			#separate_geometry_002.Selection -> group_001.Atoms
			mn_dna_style_ball_and_stick.links.new(separate_geometry_002.outputs[0], group_001.inputs[0])
			#group_input_2.Shade Smooth -> group_002.Shade Smooth
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[2], group_002.inputs[2])
			#group_input_2.Ball Resolution -> group_002.Ball Resolution
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[3], group_002.inputs[3])
			#group_input_2.Ball Radius -> group_002.Ball Radius
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[4], group_002.inputs[4])
			#group_input_2.Find Bonds -> group_002.Find Bonds
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[5], group_002.inputs[5])
			#group_input_2.Bond Resolution -> group_002.Bond Resolution
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[6], group_002.inputs[6])
			#group_input_2.Bond Radius -> group_002.Bond Radius
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[7], group_002.inputs[7])
			#group_input_2.Material -> group_002.Material
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[8], group_002.inputs[14])
			#group_input_2.Split Double Bonds -> group_002.Split Double Bonds
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[9], group_002.inputs[8])
			#group_input_2.Double Bond Curve -> group_002.Double Bond Curve
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[10], group_002.inputs[9])
			#group_input_2.Double Bond Width -> group_002.Double Bond Width
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[11], group_002.inputs[10])
			#group_input_2.Double Bond Resolution -> group_002.Double Bond Resolution
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[12], group_002.inputs[11])
			#group_input_2.Double Bond Radius -> group_002.Double Bond Radius
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[13], group_002.inputs[12])
			#group_input_2.Double Bond Rotate -> group_002.Double Bond Rotate
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[14], group_002.inputs[13])
			#separate_geometry_003.Selection -> group_002.Atoms
			mn_dna_style_ball_and_stick.links.new(separate_geometry_003.outputs[0], group_002.inputs[0])
			#group_input_2.Selection -> group_002.Selection
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[1], group_002.inputs[1])
			#group_input_2.Shade Smooth -> group_003.Shade Smooth
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[2], group_003.inputs[2])
			#group_input_2.Ball Resolution -> group_003.Ball Resolution
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[3], group_003.inputs[3])
			#group_input_2.Ball Radius -> group_003.Ball Radius
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[4], group_003.inputs[4])
			#group_input_2.Find Bonds -> group_003.Find Bonds
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[5], group_003.inputs[5])
			#group_input_2.Bond Resolution -> group_003.Bond Resolution
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[6], group_003.inputs[6])
			#group_input_2.Bond Radius -> group_003.Bond Radius
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[7], group_003.inputs[7])
			#group_input_2.Material -> group_003.Material
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[8], group_003.inputs[14])
			#group_input_2.Split Double Bonds -> group_003.Split Double Bonds
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[9], group_003.inputs[8])
			#group_input_2.Double Bond Curve -> group_003.Double Bond Curve
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[10], group_003.inputs[9])
			#group_input_2.Double Bond Width -> group_003.Double Bond Width
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[11], group_003.inputs[10])
			#group_input_2.Double Bond Resolution -> group_003.Double Bond Resolution
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[12], group_003.inputs[11])
			#group_input_2.Double Bond Radius -> group_003.Double Bond Radius
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[13], group_003.inputs[12])
			#group_input_2.Double Bond Rotate -> group_003.Double Bond Rotate
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[14], group_003.inputs[13])
			#group_input_2.Selection -> group_003.Selection
			mn_dna_style_ball_and_stick.links.new(group_input_2.outputs[1], group_003.inputs[1])
			#separate_geometry_004.Selection -> group_003.Atoms
			mn_dna_style_ball_and_stick.links.new(separate_geometry_004.outputs[0], group_003.inputs[0])
			#group_003.Ball and Stick Mesh -> geometry_to_instance.Geometry
			mn_dna_style_ball_and_stick.links.new(group_003.outputs[0], geometry_to_instance.inputs[0])
			#group_002.Ball and Stick Mesh -> geometry_to_instance.Geometry
			mn_dna_style_ball_and_stick.links.new(group_002.outputs[0], geometry_to_instance.inputs[0])
			#group_001.Ball and Stick Mesh -> geometry_to_instance.Geometry
			mn_dna_style_ball_and_stick.links.new(group_001.outputs[0], geometry_to_instance.inputs[0])
			#group_1.Ball and Stick Mesh -> geometry_to_instance.Geometry
			mn_dna_style_ball_and_stick.links.new(group_1.outputs[0], geometry_to_instance.inputs[0])
		...
		mod = obj.modifiers.new(name = "MN_dna_style_ball_and_stick", type = 'NODES')
		mod.node_group = mn_dna_style_ball_and_stick
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(MN_dna_style_ball_and_stick.bl_idname)
