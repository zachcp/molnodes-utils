...
class Style_Cartoon(bpy.types.Operator):
	bl_idname = "node.style_cartoon"
	bl_label = "Style Cartoon"
	...
	def execute(self, context):
		...
		def _field_offset_node_group():
			...
			value_socket_4.default_value = False
			...
			value_socket_5.default_value = False
		...
		def _mn_utils_style_cartoon_node_group():
			...
			selection_socket_6.default_value = True
			...
			interpolate_color_socket.default_value = True
		...
		def is_peptide_node_group():
			...
			#Socket Selection
			selection_socket_7 = is_peptide.interface.new_socket(name = "Selection", in_out='OUTPUT', socket_type = 'NodeSocketBool')
			selection_socket_7.default_value = False
			selection_socket_7.attribute_domain = 'POINT'
			selection_socket_7.description = "True if atoms are part of a peptide"
			
			#Socket Inverted
			inverted_socket_5 = is_peptide.interface.new_socket(name = "Inverted", in_out='OUTPUT', socket_type = 'NodeSocketBool')
			inverted_socket_5.default_value = False
			inverted_socket_5.attribute_domain = 'POINT'
			
			#Socket And
			and_socket_6 = is_peptide.interface.new_socket(name = "And", in_out='INPUT', socket_type = 'NodeSocketBool')
			and_socket_6.default_value = True
			and_socket_6.attribute_domain = 'POINT'
			and_socket_6.hide_value = True
			
			#Socket Or
			or_socket_5 = is_peptide.interface.new_socket(name = "Or", in_out='INPUT', socket_type = 'NodeSocketBool')
			...
			#node Group Input
			group_input_40 = is_peptide.nodes.new("NodeGroupInput")
			group_input_40.name = "Group Input"
			
			#node Boolean Math.001
			boolean_math_001_8 = is_peptide.nodes.new("FunctionNodeBooleanMath")
			boolean_math_001_8.name = "Boolean Math.001"
			boolean_math_001_8.operation = 'AND'
			
			#node Group
			group_14 = is_peptide.nodes.new("GeometryNodeGroup")
			group_14.name = "Group"
			group_14.node_tree = _mn_select_peptide
			
			#node Group Output
			group_output_41 = is_peptide.nodes.new("NodeGroupOutput")
			group_output_41.name = "Group Output"
			group_output_41.is_active_output = True
			
			#node Group.001
			group_001_9 = is_peptide.nodes.new("GeometryNodeGroup")
			group_001_9.name = "Group.001"
			group_001_9.node_tree = fallback_boolean
			#Socket_2
			group_001_9.inputs[0].default_value = "is_peptide"
			
			#node Boolean Math.002
			boolean_math_002_5 = is_peptide.nodes.new("FunctionNodeBooleanMath")
			boolean_math_002_5.name = "Boolean Math.002"
			boolean_math_002_5.operation = 'OR'
			
			#node Boolean Math
			boolean_math_10 = is_peptide.nodes.new("FunctionNodeBooleanMath")
			...
			#Set locations
			group_input_40.location = (-200.0, 0.0)
			boolean_math_001_8.location = (-40.0, 0.0)
			group_14.location = (-340.0, -140.0)
			group_output_41.location = (320.0, 0.0)
			group_001_9.location = (-40.0, -140.0)
			boolean_math_002_5.location = (140.0, 5.243539333343506)
			boolean_math_10.location = (140.0, -120.0)
			
			#Set dimensions
			group_input_40.width, group_input_40.height = 140.0, 100.0
			boolean_math_001_8.width, boolean_math_001_8.height = 140.0, 100.0
			group_14.width, group_14.height = 247.90924072265625, 100.0
			...
			#boolean_math_002_5.Boolean -> group_output_41.Selection
			is_peptide.links.new(boolean_math_002_5.outputs[0], group_output_41.inputs[0])
			#group_input_40.And -> boolean_math_001_8.Boolean
			is_peptide.links.new(group_input_40.outputs[0], boolean_math_001_8.inputs[0])
			#group_14.Is Peptide -> group_001_9.Fallback
			is_peptide.links.new(group_14.outputs[2], group_001_9.inputs[1])
			#group_001_9.Boolean -> boolean_math_001_8.Boolean
			is_peptide.links.new(group_001_9.outputs[0], boolean_math_001_8.inputs[1])
			#boolean_math_001_8.Boolean -> boolean_math_002_5.Boolean
			is_peptide.links.new(boolean_math_001_8.outputs[0], boolean_math_002_5.inputs[0])
			#group_input_40.Or -> boolean_math_002_5.Boolean
			is_peptide.links.new(group_input_40.outputs[1], boolean_math_002_5.inputs[1])
			#boolean_math_002_5.Boolean -> boolean_math_10.Boolean
			is_peptide.links.new(boolean_math_002_5.outputs[0], boolean_math_10.inputs[0])
			#boolean_math_10.Boolean -> group_output_41.Inverted
			is_peptide.links.new(boolean_math_10.outputs[0], group_output_41.inputs[1])
			return is_peptide
		...
		def boolean_run_mask_node_group():
			...
			#node Group Output
			group_output_42 = boolean_run_mask.nodes.new("NodeGroupOutput")
			group_output_42.name = "Group Output"
			group_output_42.is_active_output = True
			
			#node Group Input
			group_input_41 = boolean_run_mask.nodes.new("NodeGroupInput")
			group_input_41.name = "Group Input"
			group_input_41.outputs[3].hide = True
			
			#node Accumulate Field
			accumulate_field_1 = boolean_run_mask.nodes.new("GeometryNodeAccumulateField")
			...
			#node Accumulate Field.001
			accumulate_field_001_1 = boolean_run_mask.nodes.new("GeometryNodeAccumulateField")
			...
			#node Compare
			compare_7 = boolean_run_mask.nodes.new("FunctionNodeCompare")
			...
			#node Boolean Math.002
			boolean_math_002_6 = boolean_run_mask.nodes.new("FunctionNodeBooleanMath")
			boolean_math_002_6.name = "Boolean Math.002"
			boolean_math_002_6.operation = 'AND'
			
			#node Reroute
			reroute_11 = boolean_run_mask.nodes.new("NodeReroute")
			reroute_11.name = "Reroute"
			#node Boolean Math.003
			boolean_math_003_4 = boolean_run_mask.nodes.new("FunctionNodeBooleanMath")
			boolean_math_003_4.name = "Boolean Math.003"
			boolean_math_003_4.operation = 'AND'
			
			#node Compare.001
			compare_001_4 = boolean_run_mask.nodes.new("FunctionNodeCompare")
			compare_001_4.name = "Compare.001"
			compare_001_4.data_type = 'INT'
			compare_001_4.mode = 'ELEMENT'
			compare_001_4.operation = 'GREATER_THAN'
			
			#node Boolean Math.004
			boolean_math_004_5 = boolean_run_mask.nodes.new("FunctionNodeBooleanMath")
			boolean_math_004_5.name = "Boolean Math.004"
			boolean_math_004_5.operation = 'AND'
			
			#node Compare.002
			compare_002_2 = boolean_run_mask.nodes.new("FunctionNodeCompare")
			...
			#node Math
			math_7 = boolean_run_mask.nodes.new("ShaderNodeMath")
			math_7.name = "Math"
			math_7.operation = 'SUBTRACT'
			math_7.use_clamp = False
			
			#node Group Input.001
			group_input_001_3 = boolean_run_mask.nodes.new("NodeGroupInput")
			...
			#Set locations
			group_output_42.location = (860.0001220703125, 60.0)
			group_input_41.location = (-460.0031433105469, 0.0)
			accumulate_field_1.location = (-100.0, -300.0)
			boolean_math_001_9.location = (-260.0, -300.0)
			accumulate_field_001_1.location = (60.0, -300.0)
			compare_7.location = (260.0031433105469, -80.0)
			boolean_math_002_6.location = (260.0, 60.0)
			reroute_11.location = (-260.0031433105469, -29.36541748046875)
			boolean_math_003_4.location = (420.0, 60.0)
			compare_001_4.location = (420.0, -80.0)
			boolean_math_004_5.location = (580.0, 60.0)
			compare_002_2.location = (580.0, -80.0)
			math_7.location = (420.0, -240.0)
			group_input_001_3.location = (580.0, -240.0)
			...
			#boolean_math_001_9.Boolean -> accumulate_field_1.Value
			boolean_run_mask.links.new(boolean_math_001_9.outputs[0], accumulate_field_1.inputs[0])
			#reroute_11.Output -> boolean_math_001_9.Boolean
			boolean_run_mask.links.new(reroute_11.outputs[0], boolean_math_001_9.inputs[0])
			#compare_7.Result -> boolean_math_002_6.Boolean
			boolean_run_mask.links.new(compare_7.outputs[0], boolean_math_002_6.inputs[1])
			#group_input_41.Boolean -> reroute_11.Input
			boolean_run_mask.links.new(group_input_41.outputs[0], reroute_11.inputs[0])
			#boolean_math_004_5.Boolean -> group_output_42.Boolean
			boolean_run_mask.links.new(boolean_math_004_5.outputs[0], group_output_42.inputs[0])
			#group_input_41.Lag Start -> compare_7.B
			boolean_run_mask.links.new(group_input_41.outputs[1], compare_7.inputs[3])
			#boolean_math_002_6.Boolean -> boolean_math_003_4.Boolean
			boolean_run_mask.links.new(boolean_math_002_6.outputs[0], boolean_math_003_4.inputs[0])
			#accumulate_field_001_1.Total -> compare_001_4.A
			boolean_run_mask.links.new(accumulate_field_001_1.outputs[2], compare_001_4.inputs[2])
			#group_input_41.Min Length -> compare_001_4.B
			boolean_run_mask.links.new(group_input_41.outputs[2], compare_001_4.inputs[3])
			#compare_001_4.Result -> boolean_math_003_4.Boolean
			boolean_run_mask.links.new(compare_001_4.outputs[0], boolean_math_003_4.inputs[1])
			#reroute_11.Output -> boolean_math_002_6.Boolean
			boolean_run_mask.links.new(reroute_11.outputs[0], boolean_math_002_6.inputs[0])
			#accumulate_field_1.Trailing -> accumulate_field_001_1.Group ID
			boolean_run_mask.links.new(accumulate_field_1.outputs[1], accumulate_field_001_1.inputs[1])
			#boolean_math_003_4.Boolean -> boolean_math_004_5.Boolean
			boolean_run_mask.links.new(boolean_math_003_4.outputs[0], boolean_math_004_5.inputs[0])
			#accumulate_field_001_1.Total -> math_7.Value
			boolean_run_mask.links.new(accumulate_field_001_1.outputs[2], math_7.inputs[0])
			#accumulate_field_001_1.Leading -> math_7.Value
			boolean_run_mask.links.new(accumulate_field_001_1.outputs[0], math_7.inputs[1])
			#math_7.Value -> compare_002_2.A
			boolean_run_mask.links.new(math_7.outputs[0], compare_002_2.inputs[2])
			#group_input_001_3.Trim End -> compare_002_2.B
			boolean_run_mask.links.new(group_input_001_3.outputs[3], compare_002_2.inputs[3])
			#compare_002_2.Result -> boolean_math_004_5.Boolean
			boolean_run_mask.links.new(compare_002_2.outputs[0], boolean_math_004_5.inputs[1])
			#accumulate_field_001_1.Leading -> compare_7.A
			boolean_run_mask.links.new(accumulate_field_001_1.outputs[0], compare_7.inputs[2])
		...
		def world_to_angstrom_node_group():
			...
			#node Group Output
			group_output_43 = world_to_angstrom.nodes.new("NodeGroupOutput")
			group_output_43.name = "Group Output"
			group_output_43.is_active_output = True
			
			#node Group Input
			group_input_42 = world_to_angstrom.nodes.new("NodeGroupInput")
			group_input_42.name = "Group Input"
			
			#node Group
			group_15 = world_to_angstrom.nodes.new("GeometryNodeGroup")
			group_15.name = "Group"
			group_15.node_tree = _mn_world_scale
			
			#node Math
			math_8 = world_to_angstrom.nodes.new("ShaderNodeMath")
			math_8.name = "Math"
			...
			#Set locations
			group_output_43.location = (190.0, 0.0)
			group_input_42.location = (-200.0, 0.0)
			group_15.location = (0.0, -80.0)
			math_8.location = (0.0, 80.0)
			...
			#group_15.world_scale -> math_8.Value
			world_to_angstrom.links.new(group_15.outputs[0], math_8.inputs[1])
			#group_input_42.World -> math_8.Value
			world_to_angstrom.links.new(group_input_42.outputs[0], math_8.inputs[0])
			#math_8.Value -> group_output_43.Angstrom
			world_to_angstrom.links.new(math_8.outputs[0], group_output_43.inputs[0])
		...
		def nodegroup_001_node_group():
			...
			#Socket Value
			value_socket_9 = nodegroup_001.interface.new_socket(name = "Value", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
			...
			#node Group Output
			group_output_44 = nodegroup_001.nodes.new("NodeGroupOutput")
			group_output_44.name = "Group Output"
			group_output_44.is_active_output = True
			
			#node Group Input
			group_input_43 = nodegroup_001.nodes.new("NodeGroupInput")
			...
			#node Math.002
			math_002_2 = nodegroup_001.nodes.new("ShaderNodeMath")
			math_002_2.name = "Math.002"
			math_002_2.operation = 'DIVIDE'
			math_002_2.use_clamp = False
			#Value
			math_002_2.inputs[0].default_value = 1.0
			
			#node Group.001
			group_001_10 = nodegroup_001.nodes.new("GeometryNodeGroup")
			group_001_10.name = "Group.001"
			group_001_10.node_tree = world_to_angstrom
			
			
			
			
			#Set locations
			group_output_44.location = (670.8533325195312, -4.1087493896484375)
			group_input_43.location = (-280.0, 0.0)
			vector_math_002_1.location = (-80.0, 0.0)
			math_002_2.location = (260.0, 0.0)
			group_001_10.location = (80.0, 0.0)
			...
			group_001_10.width, group_001_10.height = 152.50686645507812, 100.0
			
			#initialize nodegroup_001 links
			#group_001_10.Angstrom -> math_002_2.Value
			nodegroup_001.links.new(group_001_10.outputs[0], math_002_2.inputs[1])
			#group_input_43.Vector -> vector_math_002_1.Vector
			nodegroup_001.links.new(group_input_43.outputs[1], vector_math_002_1.inputs[1])
			#group_input_43.Vector -> vector_math_002_1.Vector
			nodegroup_001.links.new(group_input_43.outputs[0], vector_math_002_1.inputs[0])
			#math_002_2.Value -> group_output_44.Value
			nodegroup_001.links.new(math_002_2.outputs[0], group_output_44.inputs[0])
			#vector_math_002_1.Value -> group_001_10.World
			nodegroup_001.links.new(vector_math_002_1.outputs[1], group_001_10.inputs[0])
		...
		def hbond_energy_node_group():
			...
			#node Group Output
			group_output_45 = hbond_energy.nodes.new("NodeGroupOutput")
			group_output_45.name = "Group Output"
			group_output_45.is_active_output = True
			
			#node Group Input
			group_input_44 = hbond_energy.nodes.new("NodeGroupInput")
			...
			#node Math.002
			math_002_3 = hbond_energy.nodes.new("ShaderNodeMath")
			...
			#node Vector Math
			vector_math_6 = hbond_energy.nodes.new("ShaderNodeVectorMath")
			...
			#node Compare
			compare_8 = hbond_energy.nodes.new("FunctionNodeCompare")
			compare_8.label = "Cutoff kcal/mol"
			compare_8.name = "Compare"
			compare_8.data_type = 'FLOAT'
			compare_8.mode = 'ELEMENT'
			compare_8.operation = 'LESS_THAN'
			#B
			compare_8.inputs[1].default_value = -0.5
			
			#node Group Input.001
			group_input_001_4 = hbond_energy.nodes.new("NodeGroupInput")
			...
			#Set locations
			group_output_45.location = (900.0, 40.0)
			group_input_44.location = (-644.257568359375, 10.571624755859375)
			...
			math_002_3.location = (-180.0, 60.0)
			...
			vector_math_6.location = (480.0, -60.0)
			math_007_1.location = (160.0, 100.0)
			compare_8.location = (720.0, 220.0)
			group_input_001_4.location = (320.0, -60.0)
			...
			hbond_energy.links.new(math_002_3.outputs[0], math_003_2.inputs[0])
			...
			#group_008_2.Value -> math_002_3.Value
			hbond_energy.links.new(group_008_2.outputs[0], math_002_3.inputs[1])
			...
			#group_003_3.Value -> math_002_3.Value
			hbond_energy.links.new(group_003_3.outputs[0], math_002_3.inputs[0])
			#math_005_1.Value -> math_006_1.Value
			hbond_energy.links.new(math_005_1.outputs[0], math_006_1.inputs[0])
			#math_006_1.Value -> group_output_45.Bond Energy
			hbond_energy.links.new(math_006_1.outputs[0], group_output_45.inputs[1])
			#math_004_1.Value -> math_007_1.Value
			hbond_energy.links.new(math_004_1.outputs[0], math_007_1.inputs[0])
			#vector_math_6.Vector -> group_output_45.Bond Vector
			hbond_energy.links.new(vector_math_6.outputs[0], group_output_45.inputs[2])
			#math_006_1.Value -> compare_8.A
			hbond_energy.links.new(math_006_1.outputs[0], compare_8.inputs[0])
			#compare_8.Result -> group_output_45.Is Bonded
			hbond_energy.links.new(compare_8.outputs[0], group_output_45.inputs[0])
			#group_input_44.O -> group_003_3.Vector
			hbond_energy.links.new(group_input_44.outputs[0], group_003_3.inputs[0])
			#group_input_44.N -> group_003_3.Vector
			hbond_energy.links.new(group_input_44.outputs[2], group_003_3.inputs[1])
			#group_input_44.C -> group_008_2.Vector
			hbond_energy.links.new(group_input_44.outputs[1], group_008_2.inputs[0])
			#group_input_44.H -> group_008_2.Vector
			hbond_energy.links.new(group_input_44.outputs[3], group_008_2.inputs[1])
			#group_input_44.O -> group_009_2.Vector
			hbond_energy.links.new(group_input_44.outputs[0], group_009_2.inputs[0])
			#group_input_44.H -> group_009_2.Vector
			hbond_energy.links.new(group_input_44.outputs[3], group_009_2.inputs[1])
			#group_input_44.C -> group_010_1.Vector
			hbond_energy.links.new(group_input_44.outputs[1], group_010_1.inputs[0])
			#group_input_44.N -> group_010_1.Vector
			hbond_energy.links.new(group_input_44.outputs[2], group_010_1.inputs[1])
			#group_input_001_4.H -> vector_math_6.Vector
			hbond_energy.links.new(group_input_001_4.outputs[3], vector_math_6.inputs[1])
			#group_input_001_4.O -> vector_math_6.Vector
			hbond_energy.links.new(group_input_001_4.outputs[0], vector_math_6.inputs[0])
			return hbond_energy
		...
		def offset_vector_node_group():
			...
			#Socket Value
			value_socket_10 = offset_vector.interface.new_socket(name = "Value", in_out='OUTPUT', socket_type = 'NodeSocketVector')
			value_socket_10.default_value = (0.0, 0.0, 0.0)
			value_socket_10.min_value = -3.4028234663852886e+38
			value_socket_10.max_value = 3.4028234663852886e+38
			...
			#node Group Output
			group_output_46 = offset_vector.nodes.new("NodeGroupOutput")
			group_output_46.name = "Group Output"
			group_output_46.is_active_output = True
			
			#node Group Input
			group_input_45 = offset_vector.nodes.new("NodeGroupInput")
			...
			#node Math
			math_9 = offset_vector.nodes.new("ShaderNodeMath")
			math_9.name = "Math"
			...
			#Set locations
			group_output_46.location = (300.0, 20.0)
			group_input_45.location = (-273.81378173828125, 0.0)
			evaluate_at_index_4.location = (120.0, 20.0)
			math_9.location = (-60.0, 20.0)
			...
			#group_input_45.Position -> evaluate_at_index_4.Value
			offset_vector.links.new(group_input_45.outputs[1], evaluate_at_index_4.inputs[1])
			#evaluate_at_index_4.Value -> group_output_46.Value
			offset_vector.links.new(evaluate_at_index_4.outputs[0], group_output_46.inputs[0])
			#group_input_45.Index -> math_9.Value
			offset_vector.links.new(group_input_45.outputs[0], math_9.inputs[0])
			#group_input_45.Offset -> math_9.Value
			offset_vector.links.new(group_input_45.outputs[2], math_9.inputs[1])
			#math_9.Value -> evaluate_at_index_4.Index
			offset_vector.links.new(math_9.outputs[0], evaluate_at_index_4.inputs[0])
		...
		def backbone_nh_node_group():
			...
			#Socket Value
			value_socket_11 = backbone_nh.interface.new_socket(name = "Value", in_out='INPUT', socket_type = 'NodeSocketFloat')
			value_socket_11.default_value = 1.0
			value_socket_11.min_value = -10000.0
			value_socket_11.max_value = 10000.0
			...
			#node Group Output
			group_output_47 = backbone_nh.nodes.new("NodeGroupOutput")
			group_output_47.name = "Group Output"
			group_output_47.is_active_output = True
			
			#node Group Input
			group_input_46 = backbone_nh.nodes.new("NodeGroupInput")
			...
			#node Named Attribute.001
			named_attribute_001_6 = backbone_nh.nodes.new("GeometryNodeInputNamedAttribute")
			named_attribute_001_6.name = "Named Attribute.001"
			named_attribute_001_6.data_type = 'FLOAT_VECTOR'
			#Name
			named_attribute_001_6.inputs[0].default_value = "backbone_CA"
			
			#node Named Attribute.002
			named_attribute_002_2 = backbone_nh.nodes.new("GeometryNodeInputNamedAttribute")
			named_attribute_002_2.name = "Named Attribute.002"
			named_attribute_002_2.data_type = 'FLOAT_VECTOR'
			#Name
			named_attribute_002_2.inputs[0].default_value = "backbone_C"
			...
			#node Vector Math
			vector_math_7 = backbone_nh.nodes.new("ShaderNodeVectorMath")
			...
			#Set locations
			group_output_47.location = (620.0, 0.0)
			group_input_46.location = (-630.0, 0.0)
			named_attribute_7.location = (-430.0, 140.0)
			named_attribute_001_6.location = (-430.0, 0.0)
			named_attribute_002_2.location = (-430.0, -140.0)
			group_002_5.location = (-210.0, -120.0)
			vector_math_7.location = (-50.0, 0.0)
			...
			named_attribute_001_6.width, named_attribute_001_6.height = 189.579833984375, 100.0
			named_attribute_002_2.width, named_attribute_002_2.height = 189.579833984375, 100.0
			...
			#named_attribute_001_6.Attribute -> vector_math_001_2.Vector
			backbone_nh.links.new(named_attribute_001_6.outputs[0], vector_math_001_2.inputs[1])
			#named_attribute_002_2.Attribute -> group_002_5.Position
			backbone_nh.links.new(named_attribute_002_2.outputs[0], group_002_5.inputs[1])
			#named_attribute_7.Attribute -> vector_math_7.Vector
			backbone_nh.links.new(named_attribute_7.outputs[0], vector_math_7.inputs[0])
			#vector_math_7.Vector -> vector_math_003_2.Vector
			backbone_nh.links.new(vector_math_7.outputs[0], vector_math_003_2.inputs[0])
			...
			#group_002_5.Value -> vector_math_7.Vector
			backbone_nh.links.new(group_002_5.outputs[0], vector_math_7.inputs[1])
			...
			#named_attribute_7.Attribute -> vector_math_001_2.Vector
			backbone_nh.links.new(named_attribute_7.outputs[0], vector_math_001_2.inputs[0])
			...
			#named_attribute_7.Attribute -> vector_math_006_2.Vector
			backbone_nh.links.new(named_attribute_7.outputs[0], vector_math_006_2.inputs[0])
			#vector_math_006_2.Vector -> group_output_47.H
			backbone_nh.links.new(vector_math_006_2.outputs[0], group_output_47.inputs[0])
			#group_input_46.Value -> group_003_4.Value
			backbone_nh.links.new(group_input_46.outputs[0], group_003_4.inputs[0])
		...
		def mn_topo_backbone_node_group():
			...
			#node Group Output
			group_output_48 = mn_topo_backbone.nodes.new("NodeGroupOutput")
			group_output_48.name = "Group Output"
			group_output_48.is_active_output = True
			
			#node Group Input
			group_input_47 = mn_topo_backbone.nodes.new("NodeGroupInput")
			group_input_47.name = "Group Input"
			
			#node Named Attribute.001
			named_attribute_001_7 = mn_topo_backbone.nodes.new("GeometryNodeInputNamedAttribute")
			named_attribute_001_7.name = "Named Attribute.001"
			named_attribute_001_7.data_type = 'FLOAT_VECTOR'
			#Name
			named_attribute_001_7.inputs[0].default_value = "backbone_O"
			
			#node Named Attribute.002
			named_attribute_002_3 = mn_topo_backbone.nodes.new("GeometryNodeInputNamedAttribute")
			...
			#node Math
			math_10 = mn_topo_backbone.nodes.new("ShaderNodeMath")
			math_10.name = "Math"
			...
			#node Reroute
			reroute_12 = mn_topo_backbone.nodes.new("NodeReroute")
			reroute_12.name = "Reroute"
			#node Group
			group_16 = mn_topo_backbone.nodes.new("GeometryNodeGroup")
			group_16.name = "Group"
			group_16.node_tree = backbone_nh
			#Socket_1
			group_16.inputs[0].default_value = 1.0099999904632568
			...
			#node Switch
			switch_10 = mn_topo_backbone.nodes.new("GeometryNodeSwitch")
			switch_10.name = "Switch"
			switch_10.input_type = 'VECTOR'
			
			#node Boolean Math
			boolean_math_11 = mn_topo_backbone.nodes.new("FunctionNodeBooleanMath")
			...
			#Set locations
			group_output_48.location = (320.0, -220.0)
			group_input_47.location = (-520.0, -260.0)
			named_attribute_001_7.location = (-300.0, 40.0)
			named_attribute_002_3.location = (-300.0, -100.0)
			evaluate_at_index_5.location = (80.0, -14.04681396484375)
			math_10.location = (-260.0, -260.0)
			...
			reroute_12.location = (20.0, -340.0)
			group_16.location = (-640.0, -920.0)
			evaluate_at_index_004_1.location = (77.81956481933594, -655.5125732421875)
			named_attribute_005.location = (-640.0, -780.0)
			switch_10.location = (-240.0, -780.0)
			boolean_math_11.location = (-420.0, -780.0)
			
			#Set dimensions
			group_output_48.width, group_output_48.height = 140.0, 100.0
			group_input_47.width, group_input_47.height = 140.0, 100.0
			named_attribute_001_7.width, named_attribute_001_7.height = 186.42977905273438, 100.0
			named_attribute_002_3.width, named_attribute_002_3.height = 186.42977905273438, 100.0
			...
			group_16.width, group_16.height = 186.0294189453125, 100.0
			...
			#named_attribute_001_7.Attribute -> evaluate_at_index_5.Value
			mn_topo_backbone.links.new(named_attribute_001_7.outputs[0], evaluate_at_index_5.inputs[1])
			#reroute_12.Output -> evaluate_at_index_5.Index
			mn_topo_backbone.links.new(reroute_12.outputs[0], evaluate_at_index_5.inputs[0])
			#group_input_47.Offset -> math_10.Value
			mn_topo_backbone.links.new(group_input_47.outputs[0], math_10.inputs[0])
			#reroute_12.Output -> evaluate_at_index_001_4.Index
			mn_topo_backbone.links.new(reroute_12.outputs[0], evaluate_at_index_001_4.inputs[0])
			#named_attribute_002_3.Attribute -> evaluate_at_index_001_4.Value
			mn_topo_backbone.links.new(named_attribute_002_3.outputs[0], evaluate_at_index_001_4.inputs[1])
			#reroute_12.Output -> evaluate_at_index_002_1.Index
			mn_topo_backbone.links.new(reroute_12.outputs[0], evaluate_at_index_002_1.inputs[0])
			...
			#reroute_12.Output -> evaluate_at_index_003_1.Index
			mn_topo_backbone.links.new(reroute_12.outputs[0], evaluate_at_index_003_1.inputs[0])
			...
			#index_4.Index -> math_10.Value
			mn_topo_backbone.links.new(index_4.outputs[0], math_10.inputs[1])
			#math_10.Value -> reroute_12.Input
			mn_topo_backbone.links.new(math_10.outputs[0], reroute_12.inputs[0])
			#evaluate_at_index_003_1.Value -> group_output_48.N
			mn_topo_backbone.links.new(evaluate_at_index_003_1.outputs[0], group_output_48.inputs[3])
			#evaluate_at_index_002_1.Value -> group_output_48.CA
			mn_topo_backbone.links.new(evaluate_at_index_002_1.outputs[0], group_output_48.inputs[2])
			#evaluate_at_index_001_4.Value -> group_output_48.C
			mn_topo_backbone.links.new(evaluate_at_index_001_4.outputs[0], group_output_48.inputs[1])
			#evaluate_at_index_5.Value -> group_output_48.O
			mn_topo_backbone.links.new(evaluate_at_index_5.outputs[0], group_output_48.inputs[0])
			#reroute_12.Output -> evaluate_at_index_004_1.Index
			mn_topo_backbone.links.new(reroute_12.outputs[0], evaluate_at_index_004_1.inputs[0])
			#evaluate_at_index_004_1.Value -> group_output_48.NH
			mn_topo_backbone.links.new(evaluate_at_index_004_1.outputs[0], group_output_48.inputs[4])
			#group_16.H -> switch_10.True
			mn_topo_backbone.links.new(group_16.outputs[0], switch_10.inputs[2])
			#switch_10.Output -> evaluate_at_index_004_1.Value
			mn_topo_backbone.links.new(switch_10.outputs[0], evaluate_at_index_004_1.inputs[1])
			#named_attribute_005.Exists -> boolean_math_11.Boolean
			mn_topo_backbone.links.new(named_attribute_005.outputs[1], boolean_math_11.inputs[0])
			#boolean_math_11.Boolean -> switch_10.Switch
			mn_topo_backbone.links.new(boolean_math_11.outputs[0], switch_10.inputs[0])
			#named_attribute_005.Attribute -> switch_10.False
			mn_topo_backbone.links.new(named_attribute_005.outputs[0], switch_10.inputs[1])
		...
		def hbond_backbone_check_node_group():
			...
			#node Group Output
			group_output_49 = hbond_backbone_check.nodes.new("NodeGroupOutput")
			group_output_49.name = "Group Output"
			group_output_49.is_active_output = True
			
			#node Group Input
			group_input_48 = hbond_backbone_check.nodes.new("NodeGroupInput")
			...
			#node Math
			math_11 = hbond_backbone_check.nodes.new("ShaderNodeMath")
			math_11.name = "Math"
			math_11.operation = 'ADD'
			math_11.use_clamp = False
			
			#node Math.001
			math_001_7 = hbond_backbone_check.nodes.new("ShaderNodeMath")
			math_001_7.name = "Math.001"
			math_001_7.operation = 'ADD'
			math_001_7.use_clamp = False
			
			#node Math.002
			math_002_4 = hbond_backbone_check.nodes.new("ShaderNodeMath")
			...
			#node Compare
			compare_9 = hbond_backbone_check.nodes.new("FunctionNodeCompare")
			compare_9.name = "Compare"
			compare_9.data_type = 'FLOAT'
			compare_9.mode = 'ELEMENT'
			compare_9.operation = 'GREATER_THAN'
			
			#node Integer
			integer_2 = hbond_backbone_check.nodes.new("FunctionNodeInputInt")
			integer_2.name = "Integer"
			integer_2.integer = 2
			
			#node Frame
			frame_3 = hbond_backbone_check.nodes.new("NodeFrame")
			...
			#node Switch
			switch_11 = hbond_backbone_check.nodes.new("GeometryNodeSwitch")
			switch_11.name = "Switch"
			switch_11.input_type = 'BOOLEAN'
			#False
			switch_11.inputs[1].default_value = False
			
			#node Compare.001
			compare_001_5 = hbond_backbone_check.nodes.new("FunctionNodeCompare")
			compare_001_5.name = "Compare.001"
			compare_001_5.data_type = 'FLOAT'
			compare_001_5.mode = 'ELEMENT'
			compare_001_5.operation = 'LESS_THAN'
			
			#node Vector Math
			vector_math_8 = hbond_backbone_check.nodes.new("ShaderNodeVectorMath")
			vector_math_8.name = "Vector Math"
			vector_math_8.operation = 'LENGTH'
			
			#node Group
			group_17 = hbond_backbone_check.nodes.new("GeometryNodeGroup")
			group_17.name = "Group"
			group_17.node_tree = mn_units
			#Input_1
			group_17.inputs[0].default_value = 3.0
			...
			compare_9.parent = frame_3
			integer_2.parent = frame_3
			
			#Set locations
			group_output_49.location = (820.0, 240.0)
			group_input_48.location = (-680.0, 140.0)
			...
			math_001_7.location = (-480.0, 80.0)
			math_002_4.location = (70.0, 640.0)
			math_003_3.location = (240.0, 640.0)
			compare_9.location = (420.0, 640.0)
			integer_2.location = (240.0, 500.0)
			frame_3.location = (-70.0, 40.0)
			switch_11.location = (620.0, 340.0)
			compare_001_5.location = (520.0, 140.0)
			vector_math_8.location = (260.0, 20.0)
			group_17.location = (520.0, -20.0)
			...
			frame_3.width, frame_3.height = 550.0, 284.0
			...
			#math_001_7.Value -> evaluate_at_index_001_5.Index
			hbond_backbone_check.links.new(math_001_7.outputs[0], evaluate_at_index_001_5.inputs[0])
			#math_001_7.Value -> evaluate_at_index_6.Index
			hbond_backbone_check.links.new(math_001_7.outputs[0], evaluate_at_index_6.inputs[0])
			...
			#group_008_3.Bond Energy -> group_output_49.Bond Energy
			hbond_backbone_check.links.new(group_008_3.outputs[1], group_output_49.inputs[1])
			#group_008_3.Bond Vector -> group_output_49.H->O
			hbond_backbone_check.links.new(group_008_3.outputs[2], group_output_49.inputs[2])
			#math_11.Value -> evaluate_at_index_002_2.Index
			hbond_backbone_check.links.new(math_11.outputs[0], evaluate_at_index_002_2.inputs[0])
			#math_11.Value -> evaluate_at_index_003_2.Index
			hbond_backbone_check.links.new(math_11.outputs[0], evaluate_at_index_003_2.inputs[0])
			#group_input_48.CO Index -> math_11.Value
			hbond_backbone_check.links.new(group_input_48.outputs[0], math_11.inputs[0])
			#group_input_48.CO Offset -> math_11.Value
			hbond_backbone_check.links.new(group_input_48.outputs[1], math_11.inputs[1])
			#group_input_48.NH Index -> math_001_7.Value
			hbond_backbone_check.links.new(group_input_48.outputs[2], math_001_7.inputs[0])
			#group_input_48.NH Offset -> math_001_7.Value
			hbond_backbone_check.links.new(group_input_48.outputs[3], math_001_7.inputs[1])
			#math_11.Value -> math_002_4.Value
			hbond_backbone_check.links.new(math_11.outputs[0], math_002_4.inputs[0])
			#math_001_7.Value -> math_002_4.Value
			hbond_backbone_check.links.new(math_001_7.outputs[0], math_002_4.inputs[1])
			#math_002_4.Value -> math_003_3.Value
			hbond_backbone_check.links.new(math_002_4.outputs[0], math_003_3.inputs[0])
			#math_003_3.Value -> compare_9.A
			hbond_backbone_check.links.new(math_003_3.outputs[0], compare_9.inputs[0])
			#integer_2.Integer -> compare_9.B
			hbond_backbone_check.links.new(integer_2.outputs[0], compare_9.inputs[1])
			#compare_9.Result -> switch_11.Switch
			hbond_backbone_check.links.new(compare_9.outputs[0], switch_11.inputs[0])
			#group_008_3.Bond Vector -> vector_math_8.Vector
			hbond_backbone_check.links.new(group_008_3.outputs[2], vector_math_8.inputs[0])
			#vector_math_8.Value -> compare_001_5.A
			hbond_backbone_check.links.new(vector_math_8.outputs[1], compare_001_5.inputs[0])
			#group_17.Angstrom -> compare_001_5.B
			hbond_backbone_check.links.new(group_17.outputs[0], compare_001_5.inputs[1])
			#switch_11.Output -> group_output_49.Is Bonded
			hbond_backbone_check.links.new(switch_11.outputs[0], group_output_49.inputs[0])
			#group_008_3.Is Bonded -> switch_11.True
			hbond_backbone_check.links.new(group_008_3.outputs[0], switch_11.inputs[2])
			...
			#group_009_3.NH -> evaluate_at_index_001_5.Value
			hbond_backbone_check.links.new(group_009_3.outputs[4], evaluate_at_index_001_5.inputs[1])
		...
		def boolean_run_fill_node_group():
			...
			#node Group Output
			group_output_50 = boolean_run_fill.nodes.new("NodeGroupOutput")
			group_output_50.name = "Group Output"
			group_output_50.is_active_output = True
			
			#node Group Input
			group_input_49 = boolean_run_fill.nodes.new("NodeGroupInput")
			group_input_49.name = "Group Input"
			
			#node Accumulate Field
			accumulate_field_2 = boolean_run_fill.nodes.new("GeometryNodeAccumulateField")
			...
			#node Accumulate Field.001
			accumulate_field_001_2 = boolean_run_fill.nodes.new("GeometryNodeAccumulateField")
			accumulate_field_001_2.name = "Accumulate Field.001"
			accumulate_field_001_2.data_type = 'INT'
			accumulate_field_001_2.domain = 'POINT'
			#Value
			accumulate_field_001_2.inputs[0].default_value = 1
			
			#node Compare
			compare_10 = boolean_run_fill.nodes.new("FunctionNodeCompare")
			compare_10.name = "Compare"
			compare_10.data_type = 'INT'
			compare_10.mode = 'ELEMENT'
			compare_10.operation = 'LESS_EQUAL'
			
			#node Compare.001
			compare_001_6 = boolean_run_fill.nodes.new("FunctionNodeCompare")
			...
			#node Boolean Math
			boolean_math_12 = boolean_run_fill.nodes.new("FunctionNodeBooleanMath")
			boolean_math_12.name = "Boolean Math"
			boolean_math_12.operation = 'OR'
			
			#node Reroute
			reroute_13 = boolean_run_fill.nodes.new("NodeReroute")
			reroute_13.name = "Reroute"
			#node Reroute.001
			reroute_001_10 = boolean_run_fill.nodes.new("NodeReroute")
			reroute_001_10.name = "Reroute.001"
			#node Reroute.003
			reroute_003_4 = boolean_run_fill.nodes.new("NodeReroute")
			reroute_003_4.name = "Reroute.003"
			#node Reroute.002
			reroute_002_7 = boolean_run_fill.nodes.new("NodeReroute")
			reroute_002_7.name = "Reroute.002"
			
			
			
			#Set locations
			group_output_50.location = (430.0, 0.0)
			group_input_49.location = (-480.0, -20.0)
			accumulate_field_2.location = (-220.0, -120.0)
			accumulate_field_001_2.location = (-60.0, -120.0)
			compare_10.location = (100.0, -120.0)
			compare_001_6.location = (100.0, -280.0)
			boolean_math_010_2.location = (260.0, -120.0)
			boolean_math_12.location = (260.0, 20.0)
			reroute_13.location = (60.0, -380.0)
			reroute_001_10.location = (-280.0, -380.0)
			reroute_003_4.location = (-300.0, -80.0)
			reroute_002_7.location = (-240.0, -60.0)
			...
			#accumulate_field_001_2.Trailing -> compare_10.A
			boolean_run_fill.links.new(accumulate_field_001_2.outputs[1], compare_10.inputs[2])
			#accumulate_field_2.Leading -> accumulate_field_001_2.Group ID
			boolean_run_fill.links.new(accumulate_field_2.outputs[0], accumulate_field_001_2.inputs[1])
			#compare_001_6.Result -> boolean_math_010_2.Boolean
			boolean_run_fill.links.new(compare_001_6.outputs[0], boolean_math_010_2.inputs[1])
			#compare_10.Result -> boolean_math_010_2.Boolean
			boolean_run_fill.links.new(compare_10.outputs[0], boolean_math_010_2.inputs[0])
			#accumulate_field_001_2.Total -> compare_001_6.A
			boolean_run_fill.links.new(accumulate_field_001_2.outputs[2], compare_001_6.inputs[2])
			#reroute_13.Output -> compare_10.B
			boolean_run_fill.links.new(reroute_13.outputs[0], compare_10.inputs[3])
			#reroute_13.Output -> compare_001_6.B
			boolean_run_fill.links.new(reroute_13.outputs[0], compare_001_6.inputs[3])
			#reroute_002_7.Output -> accumulate_field_2.Value
			boolean_run_fill.links.new(reroute_002_7.outputs[0], accumulate_field_2.inputs[0])
			#reroute_002_7.Output -> boolean_math_12.Boolean
			boolean_run_fill.links.new(reroute_002_7.outputs[0], boolean_math_12.inputs[0])
			#boolean_math_010_2.Boolean -> boolean_math_12.Boolean
			boolean_run_fill.links.new(boolean_math_010_2.outputs[0], boolean_math_12.inputs[1])
			#boolean_math_12.Boolean -> group_output_50.Boolean
			boolean_run_fill.links.new(boolean_math_12.outputs[0], group_output_50.inputs[0])
			#reroute_001_10.Output -> reroute_13.Input
			boolean_run_fill.links.new(reroute_001_10.outputs[0], reroute_13.inputs[0])
			#reroute_003_4.Output -> reroute_001_10.Input
			boolean_run_fill.links.new(reroute_003_4.outputs[0], reroute_001_10.inputs[0])
			#group_input_49.Fill Size -> reroute_003_4.Input
			boolean_run_fill.links.new(group_input_49.outputs[1], reroute_003_4.inputs[0])
			#group_input_49.Boolean -> reroute_002_7.Input
			boolean_run_fill.links.new(group_input_49.outputs[0], reroute_002_7.inputs[0])
		...
		def offset_boolean_node_group():
			...
			#node Group Output
			group_output_51 = offset_boolean.nodes.new("NodeGroupOutput")
			group_output_51.name = "Group Output"
			group_output_51.is_active_output = True
			
			#node Group Input
			group_input_50 = offset_boolean.nodes.new("NodeGroupInput")
			...
			#node Math
			math_12 = offset_boolean.nodes.new("ShaderNodeMath")
			math_12.name = "Math"
			...
			#Set locations
			group_output_51.location = (190.0, 0.0)
			group_input_50.location = (-344.3331298828125, -46.23834991455078)
			evaluate_at_index_7.location = (0.0, 0.0)
			math_12.location = (-160.0, 0.0)
			...
			#evaluate_at_index_7.Value -> group_output_51.Boolean
			offset_boolean.links.new(evaluate_at_index_7.outputs[0], group_output_51.inputs[0])
			#group_input_50.Boolean -> evaluate_at_index_7.Value
			offset_boolean.links.new(group_input_50.outputs[1], evaluate_at_index_7.inputs[1])
			#group_input_50.Index -> math_12.Value
			offset_boolean.links.new(group_input_50.outputs[0], math_12.inputs[1])
			#math_12.Value -> evaluate_at_index_7.Index
			offset_boolean.links.new(math_12.outputs[0], evaluate_at_index_7.inputs[0])
			#group_input_50.Offset -> math_12.Value
			offset_boolean.links.new(group_input_50.outputs[2], math_12.inputs[0])
		...
		def vector_angle_node_group():
			...
			#node Group Input
			group_input_51 = vector_angle.nodes.new("NodeGroupInput")
			...
			#node Vector Math
			vector_math_9 = vector_angle.nodes.new("ShaderNodeVectorMath")
			vector_math_9.name = "Vector Math"
			vector_math_9.operation = 'DOT_PRODUCT'
			
			#node Math
			math_13 = vector_angle.nodes.new("ShaderNodeMath")
			math_13.name = "Math"
			math_13.operation = 'ARCCOSINE'
			math_13.use_clamp = False
			
			#node Group Output
			group_output_52 = vector_angle.nodes.new("NodeGroupOutput")
			...
			#Set locations
			group_input_51.location = (-360.0, 0.0)
			vector_math_002_3.location = (-160.0, -60.0)
			vector_math_001_3.location = (-160.0, 60.0)
			vector_math_9.location = (0.0, 60.0)
			math_13.location = (160.0, 60.0)
			group_output_52.location = (340.0, 60.0)
			...
			#vector_math_9.Value -> math_13.Value
			vector_angle.links.new(vector_math_9.outputs[1], math_13.inputs[0])
			#vector_math_002_3.Vector -> vector_math_9.Vector
			vector_angle.links.new(vector_math_002_3.outputs[0], vector_math_9.inputs[1])
			#vector_math_001_3.Vector -> vector_math_9.Vector
			vector_angle.links.new(vector_math_001_3.outputs[0], vector_math_9.inputs[0])
			#math_13.Value -> group_output_52.Angle
			vector_angle.links.new(math_13.outputs[0], group_output_52.inputs[0])
			#group_input_51.A -> vector_math_001_3.Vector
			vector_angle.links.new(group_input_51.outputs[0], vector_math_001_3.inputs[0])
			#group_input_51.B -> vector_math_002_3.Vector
			vector_angle.links.new(group_input_51.outputs[1], vector_math_002_3.inputs[0])
			return vector_angle
		...
		def dihedral_angle_node_group():
			...
			#node Group Output
			group_output_53 = dihedral_angle.nodes.new("NodeGroupOutput")
			group_output_53.name = "Group Output"
			group_output_53.is_active_output = True
			
			#node Reroute.002
			reroute_002_8 = dihedral_angle.nodes.new("NodeReroute")
			reroute_002_8.name = "Reroute.002"
			#node Reroute.001
			reroute_001_11 = dihedral_angle.nodes.new("NodeReroute")
			reroute_001_11.name = "Reroute.001"
			#node Vector Math
			vector_math_10 = dihedral_angle.nodes.new("ShaderNodeVectorMath")
			vector_math_10.name = "Vector Math"
			vector_math_10.operation = 'CROSS_PRODUCT'
			...
			#node Math.001
			math_001_8 = dihedral_angle.nodes.new("ShaderNodeMath")
			math_001_8.name = "Math.001"
			math_001_8.operation = 'SIGN'
			math_001_8.use_clamp = False
			
			#node Reroute
			reroute_14 = dihedral_angle.nodes.new("NodeReroute")
			reroute_14.name = "Reroute"
			#node Math
			math_14 = dihedral_angle.nodes.new("ShaderNodeMath")
			math_14.name = "Math"
			math_14.operation = 'MULTIPLY'
			math_14.use_clamp = False
			
			#node Group Input.003
			group_input_003_1 = dihedral_angle.nodes.new("NodeGroupInput")
			...
			#node Group Input.001
			group_input_001_5 = dihedral_angle.nodes.new("NodeGroupInput")
			...
			#node Group Input
			group_input_52 = dihedral_angle.nodes.new("NodeGroupInput")
			group_input_52.name = "Group Input"
			group_input_52.outputs[0].hide = True
			group_input_52.outputs[2].hide = True
			group_input_52.outputs[3].hide = True
			group_input_52.outputs[4].hide = True
			
			#node Group Input.002
			group_input_002_1 = dihedral_angle.nodes.new("NodeGroupInput")
			...
			group_output_53.location = (920.0, 320.0)
			reroute_002_8.location = (300.0, 260.0)
			reroute_001_11.location = (300.0, 240.0)
			vector_math_10.location = (420.0, 180.0)
			vector_math_001_4.location = (420.0, 40.0)
			math_001_8.location = (580.0, 40.0)
			reroute_14.location = (300.0, 220.0)
			math_14.location = (640.0, 420.0)
			group_input_003_1.location = (-440.0, 0.0)
			group_input_001_5.location = (-440.0, 420.0)
			group_input_52.location = (-440.0, 280.0)
			group_input_002_1.location = (-440.0, 140.0)
			...
			#reroute_002_8.Output -> mn_utils_vector_angle_002.A
			dihedral_angle.links.new(reroute_002_8.outputs[0], mn_utils_vector_angle_002.inputs[0])
			...
			#vector_math_006_3.Vector -> reroute_14.Input
			dihedral_angle.links.new(vector_math_006_3.outputs[0], reroute_14.inputs[0])
			#reroute_001_11.Output -> mn_utils_vector_angle_002.B
			dihedral_angle.links.new(reroute_001_11.outputs[0], mn_utils_vector_angle_002.inputs[1])
			#vector_math_10.Vector -> vector_math_001_4.Vector
			dihedral_angle.links.new(vector_math_10.outputs[0], vector_math_001_4.inputs[0])
			#reroute_14.Output -> vector_math_001_4.Vector
			dihedral_angle.links.new(reroute_14.outputs[0], vector_math_001_4.inputs[1])
			#mn_utils_vector_angle_002.Angle -> math_14.Value
			dihedral_angle.links.new(mn_utils_vector_angle_002.outputs[0], math_14.inputs[0])
			#reroute_001_11.Output -> vector_math_10.Vector
			dihedral_angle.links.new(reroute_001_11.outputs[0], vector_math_10.inputs[1])
			#group_input_002_1.C -> vector_math_003_3.Vector
			dihedral_angle.links.new(group_input_002_1.outputs[2], vector_math_003_3.inputs[1])
			#group_input_52.B -> vector_math_004_3.Vector
			dihedral_angle.links.new(group_input_52.outputs[1], vector_math_004_3.inputs[1])
			#group_input_52.B -> vector_math_006_3.Vector
			dihedral_angle.links.new(group_input_52.outputs[1], vector_math_006_3.inputs[1])
			#group_input_002_1.C -> vector_math_006_3.Vector
			dihedral_angle.links.new(group_input_002_1.outputs[2], vector_math_006_3.inputs[0])
			#math_14.Value -> group_output_53.Angle
			dihedral_angle.links.new(math_14.outputs[0], group_output_53.inputs[0])
			#reroute_002_8.Output -> group_output_53.BA⟂(BC)
			dihedral_angle.links.new(reroute_002_8.outputs[0], group_output_53.inputs[1])
			#reroute_14.Output -> group_output_53.BC
			dihedral_angle.links.new(reroute_14.outputs[0], group_output_53.inputs[3])
			#reroute_001_11.Output -> group_output_53.CD⟂(BC)
			dihedral_angle.links.new(reroute_001_11.outputs[0], group_output_53.inputs[2])
			#reroute_002_8.Output -> vector_math_10.Vector
			dihedral_angle.links.new(reroute_002_8.outputs[0], vector_math_10.inputs[0])
			#vector_math_001_4.Value -> math_001_8.Value
			dihedral_angle.links.new(vector_math_001_4.outputs[1], math_001_8.inputs[0])
			#math_001_8.Value -> math_14.Value
			dihedral_angle.links.new(math_001_8.outputs[0], math_14.inputs[1])
			#vector_math_010_1.Vector -> reroute_001_11.Input
			dihedral_angle.links.new(vector_math_010_1.outputs[0], reroute_001_11.inputs[0])
			#vector_math_008_4.Vector -> reroute_002_8.Input
			dihedral_angle.links.new(vector_math_008_4.outputs[0], reroute_002_8.inputs[0])
			#group_input_001_5.A -> vector_math_004_3.Vector
			dihedral_angle.links.new(group_input_001_5.outputs[0], vector_math_004_3.inputs[0])
			#group_input_003_1.D -> vector_math_003_3.Vector
			dihedral_angle.links.new(group_input_003_1.outputs[3], vector_math_003_3.inputs[0])
		...
		def _mn_topo_phi_psi_node_group():
			...
			#node Group Output
			group_output_54 = _mn_topo_phi_psi.nodes.new("NodeGroupOutput")
			group_output_54.name = "Group Output"
			group_output_54.is_active_output = True
			
			#node Group Input
			group_input_53 = _mn_topo_phi_psi.nodes.new("NodeGroupInput")
			...
			#Set locations
			group_output_54.location = (698.508544921875, 198.78929138183594)
			group_input_53.location = (-520.0, 280.0)
			...
			#index_switch.Output -> group_009_4.A
			_mn_topo_phi_psi.links.new(index_switch.outputs[0], group_009_4.inputs[0])
			#index_switch_001.Output -> group_009_4.C
			_mn_topo_phi_psi.links.new(index_switch_001.outputs[0], group_009_4.inputs[2])
			#group_009_4.Angle -> group_output_54.Angle
			_mn_topo_phi_psi.links.new(group_009_4.outputs[0], group_output_54.inputs[0])
			#group_009_4.BA⟂(BC) -> group_output_54.BA⟂(BC)
			_mn_topo_phi_psi.links.new(group_009_4.outputs[1], group_output_54.inputs[1])
			#group_009_4.BC -> group_output_54.BC
			_mn_topo_phi_psi.links.new(group_009_4.outputs[3], group_output_54.inputs[3])
			#index_switch.Output -> group_output_54.A
			_mn_topo_phi_psi.links.new(index_switch.outputs[0], group_output_54.inputs[4])
			#group_008_4.CA -> group_output_54.B
			_mn_topo_phi_psi.links.new(group_008_4.outputs[2], group_output_54.inputs[5])
			#index_switch_001.Output -> group_output_54.C
			_mn_topo_phi_psi.links.new(index_switch_001.outputs[0], group_output_54.inputs[6])
			#index_switch_002.Output -> group_output_54.D
			_mn_topo_phi_psi.links.new(index_switch_002.outputs[0], group_output_54.inputs[7])
			#group_009_4.CD⟂(BC) -> group_output_54.CD⟂(BC)
			_mn_topo_phi_psi.links.new(group_009_4.outputs[2], group_output_54.inputs[2])
			#menu_switch.Output -> index_switch.Index
			_mn_topo_phi_psi.links.new(menu_switch.outputs[0], index_switch.inputs[0])
			#group_input_53.Menu -> menu_switch.Menu
			_mn_topo_phi_psi.links.new(group_input_53.outputs[0], menu_switch.inputs[0])
		...
		def between_float_node_group():
			...
			#Socket Value
			value_socket_12 = between_float.interface.new_socket(name = "Value", in_out='INPUT', socket_type = 'NodeSocketFloat')
			...
			#node Group Output
			group_output_55 = between_float.nodes.new("NodeGroupOutput")
			group_output_55.name = "Group Output"
			group_output_55.is_active_output = True
			
			#node Group Input
			group_input_54 = between_float.nodes.new("NodeGroupInput")
			group_input_54.name = "Group Input"
			
			#node Compare
			compare_11 = between_float.nodes.new("FunctionNodeCompare")
			compare_11.name = "Compare"
			compare_11.data_type = 'FLOAT'
			compare_11.mode = 'ELEMENT'
			compare_11.operation = 'LESS_EQUAL'
			
			#node Compare.001
			compare_001_7 = between_float.nodes.new("FunctionNodeCompare")
			compare_001_7.name = "Compare.001"
			compare_001_7.data_type = 'FLOAT'
			compare_001_7.mode = 'ELEMENT'
			compare_001_7.operation = 'GREATER_EQUAL'
			
			#node Boolean Math
			boolean_math_13 = between_float.nodes.new("FunctionNodeBooleanMath")
			boolean_math_13.name = "Boolean Math"
			boolean_math_13.operation = 'AND'
			
			
			
			
			#Set locations
			group_output_55.location = (270.0, 0.0)
			group_input_54.location = (-280.0, 0.0)
			compare_11.location = (-80.0, -80.0)
			compare_001_7.location = (-80.0, 80.0)
			boolean_math_13.location = (80.0, 80.0)
			...
			#compare_11.Result -> boolean_math_13.Boolean
			between_float.links.new(compare_11.outputs[0], boolean_math_13.inputs[1])
			#compare_001_7.Result -> boolean_math_13.Boolean
			between_float.links.new(compare_001_7.outputs[0], boolean_math_13.inputs[0])
			#group_input_54.Value -> compare_11.A
			between_float.links.new(group_input_54.outputs[0], compare_11.inputs[2])
			#group_input_54.Value -> compare_001_7.A
			between_float.links.new(group_input_54.outputs[0], compare_001_7.inputs[2])
			#boolean_math_13.Boolean -> group_output_55.Boolean
			between_float.links.new(boolean_math_13.outputs[0], group_output_55.inputs[0])
			#group_input_54.Lower -> compare_001_7.B
			between_float.links.new(group_input_54.outputs[1], compare_001_7.inputs[3])
			#group_input_54.Upper -> compare_11.B
			between_float.links.new(group_input_54.outputs[2], compare_11.inputs[3])
			#group_input_54.Value -> compare_001_7.A
			between_float.links.new(group_input_54.outputs[0], compare_001_7.inputs[0])
			#group_input_54.Value -> compare_11.A
			between_float.links.new(group_input_54.outputs[0], compare_11.inputs[0])
			#group_input_54.Lower -> compare_001_7.B
			between_float.links.new(group_input_54.outputs[1], compare_001_7.inputs[1])
			#group_input_54.Upper -> compare_11.B
			between_float.links.new(group_input_54.outputs[2], compare_11.inputs[1])
		...
		def helix_detect_node_group():
			...
			#node Group Output
			group_output_56 = helix_detect.nodes.new("NodeGroupOutput")
			group_output_56.name = "Group Output"
			group_output_56.is_active_output = True
			
			#node Group Input
			group_input_55 = helix_detect.nodes.new("NodeGroupInput")
			...
			#node Math
			math_15 = helix_detect.nodes.new("ShaderNodeMath")
			math_15.name = "Math"
			...
			#node Reroute
			reroute_15 = helix_detect.nodes.new("NodeReroute")
			reroute_15.name = "Reroute"
			#node Group
			group_18 = helix_detect.nodes.new("GeometryNodeGroup")
			group_18.name = "Group"
			group_18.node_tree = offset_boolean
			#Socket_1
			group_18.inputs[0].default_value = 0
			#Socket_3
			group_18.inputs[2].default_value = -1
			
			#node Boolean Math
			boolean_math_14 = helix_detect.nodes.new("FunctionNodeBooleanMath")
			...
			#node Group.001
			group_001_11 = helix_detect.nodes.new("GeometryNodeGroup")
			group_001_11.name = "Group.001"
			group_001_11.node_tree = offset_boolean
			#Socket_1
			group_001_11.inputs[0].default_value = 0
			
			#node Frame
			frame_4 = helix_detect.nodes.new("NodeFrame")
			frame_4.label = "Look to see if bonded with i - n residue, being end of helix"
			frame_4.name = "Frame"
			frame_4.label_size = 20
			frame_4.shrink = True
			
			#node Frame.001
			frame_001_1 = helix_detect.nodes.new("NodeFrame")
			frame_001_1.label = "i and i-1 are both Hbonded n residues ahead (i..i+n are helix)"
			frame_001_1.name = "Frame.001"
			frame_001_1.label_size = 20
			frame_001_1.shrink = True
			
			#node Frame.002
			frame_002_1 = helix_detect.nodes.new("NodeFrame")
			frame_002_1.label = "Assign to in-between residues"
			...
			#node Boolean Math.003
			boolean_math_003_5 = helix_detect.nodes.new("FunctionNodeBooleanMath")
			...
			#node Math.002
			math_002_5 = helix_detect.nodes.new("ShaderNodeMath")
			math_002_5.name = "Math.002"
			math_002_5.operation = 'DEGREES'
			...
			#node Boolean Math.002
			boolean_math_002_7 = helix_detect.nodes.new("FunctionNodeBooleanMath")
			boolean_math_002_7.name = "Boolean Math.002"
			boolean_math_002_7.operation = 'AND'
			
			#node Frame.003
			frame_003_1 = helix_detect.nodes.new("NodeFrame")
			frame_003_1.label = "extra dihedral check, to discard turns in helix-turn-helix"
			...
			#Set parents
			group_003_5.parent = frame_001_1
			group_017_1.parent = frame_002_1
			group_18.parent = frame_001_1
			boolean_math_14.parent = frame_001_1
			group_001_11.parent = frame_4
			group_002_6.parent = frame_003_1
			group_004_3.parent = frame_003_1
			group_005_4.parent = frame_003_1
			math_002_5.parent = frame_003_1
			group_006_3.parent = frame_003_1
			math_003_4.parent = frame_003_1
			boolean_math_002_7.parent = frame_003_1
			
			#Set locations
			group_output_56.location = (680.0, 180.0)
			group_input_55.location = (-800.0, -260.0)
			group_003_5.location = (-500.0, 100.0)
			group_017_1.location = (320.0, -20.0)
			math_15.location = (-300.0, -180.0)
			reroute_15.location = (-540.0, -200.0)
			group_18.location = (-500.0, 240.0)
			boolean_math_14.location = (-340.0, 240.0)
			boolean_math_001_10.location = (-40.0, 240.0)
			group_001_11.location = (-40.0, 20.0)
			frame_4.location = (-10.0, -20.0)
			frame_001_1.location = (10.0, 40.0)
			frame_002_1.location = (-30.0, 200.0)
			group_002_6.location = (254.93621826171875, -98.54428100585938)
			boolean_math_003_5.location = (500.0, 180.0)
			group_004_3.location = (254.93621826171875, -378.5442810058594)
			group_005_4.location = (574.9362182617188, -98.54428100585938)
			math_002_5.location = (414.93621826171875, -98.54428100585938)
			group_006_3.location = (574.9362182617188, -378.5442810058594)
			math_003_4.location = (414.93621826171875, -378.5442810058594)
			boolean_math_002_7.location = (774.9362182617188, -98.54428100585938)
			frame_003_1.location = (35.0, 99.0)
			...
			frame_4.width, frame_4.height = 200.0, 187.0
			frame_001_1.width, frame_001_1.height = 360.0, 474.0
			frame_002_1.width, frame_002_1.height = 204.8421630859375, 165.0
			...
			frame_003_1.width, frame_003_1.height = 720.0, 602.0
			
			#initialize helix_detect links
			#group_input_55.Helix Size -> math_15.Value
			helix_detect.links.new(group_input_55.outputs[0], math_15.inputs[0])
			#group_input_55.Helix Size -> reroute_15.Input
			helix_detect.links.new(group_input_55.outputs[0], reroute_15.inputs[0])
			#reroute_15.Output -> group_003_5.NH Offset
			helix_detect.links.new(reroute_15.outputs[0], group_003_5.inputs[3])
			#group_003_5.Is Bonded -> group_18.Boolean
			helix_detect.links.new(group_003_5.outputs[0], group_18.inputs[1])
			#group_18.Boolean -> boolean_math_14.Boolean
			helix_detect.links.new(group_18.outputs[0], boolean_math_14.inputs[0])
			#group_003_5.Is Bonded -> boolean_math_14.Boolean
			helix_detect.links.new(group_003_5.outputs[0], boolean_math_14.inputs[1])
			#boolean_math_001_10.Boolean -> group_017_1.Boolean
			helix_detect.links.new(boolean_math_001_10.outputs[0], group_017_1.inputs[0])
			#boolean_math_14.Boolean -> boolean_math_001_10.Boolean
			helix_detect.links.new(boolean_math_14.outputs[0], boolean_math_001_10.inputs[0])
			#boolean_math_14.Boolean -> group_001_11.Boolean
			helix_detect.links.new(boolean_math_14.outputs[0], group_001_11.inputs[1])
			#group_001_11.Boolean -> boolean_math_001_10.Boolean
			helix_detect.links.new(group_001_11.outputs[0], boolean_math_001_10.inputs[1])
			#math_15.Value -> group_001_11.Offset
			helix_detect.links.new(math_15.outputs[0], group_001_11.inputs[2])
			#reroute_15.Output -> group_017_1.Fill Size
			helix_detect.links.new(reroute_15.outputs[0], group_017_1.inputs[1])
			#group_017_1.Boolean -> boolean_math_003_5.Boolean
			helix_detect.links.new(group_017_1.outputs[0], boolean_math_003_5.inputs[0])
			#boolean_math_003_5.Boolean -> group_output_56.Boolean
			helix_detect.links.new(boolean_math_003_5.outputs[0], group_output_56.inputs[0])
			#boolean_math_002_7.Boolean -> boolean_math_003_5.Boolean
			helix_detect.links.new(boolean_math_002_7.outputs[0], boolean_math_003_5.inputs[1])
			#group_002_6.Angle -> math_002_5.Value
			helix_detect.links.new(group_002_6.outputs[0], math_002_5.inputs[0])
			#math_002_5.Value -> group_005_4.Value
			helix_detect.links.new(math_002_5.outputs[0], group_005_4.inputs[0])
			#math_003_4.Value -> group_006_3.Value
			helix_detect.links.new(math_003_4.outputs[0], group_006_3.inputs[0])
			#group_004_3.Angle -> math_003_4.Value
			helix_detect.links.new(group_004_3.outputs[0], math_003_4.inputs[0])
			#group_005_4.Boolean -> boolean_math_002_7.Boolean
			helix_detect.links.new(group_005_4.outputs[0], boolean_math_002_7.inputs[0])
			#group_006_3.Boolean -> boolean_math_002_7.Boolean
			helix_detect.links.new(group_006_3.outputs[0], boolean_math_002_7.inputs[1])
			return helix_detect
		...
		def _mn_topo_calc_helix_node_group():
			...
			#node Group Output
			group_output_57 = _mn_topo_calc_helix.nodes.new("NodeGroupOutput")
			group_output_57.name = "Group Output"
			group_output_57.is_active_output = True
			
			#node Group.001
			group_001_12 = _mn_topo_calc_helix.nodes.new("GeometryNodeGroup")
			group_001_12.name = "Group.001"
			group_001_12.node_tree = boolean_run_mask
			#Socket_2
			group_001_12.inputs[1].default_value = 0
			#Socket_3
			group_001_12.inputs[2].default_value = 5
			#Socket_6
			group_001_12.inputs[3].default_value = 0
			
			#node Boolean Math.004
			boolean_math_004_6 = _mn_topo_calc_helix.nodes.new("FunctionNodeBooleanMath")
			boolean_math_004_6.name = "Boolean Math.004"
			boolean_math_004_6.operation = 'OR'
			...
			#node Group
			group_19 = _mn_topo_calc_helix.nodes.new("GeometryNodeGroup")
			group_19.name = "Group"
			group_19.node_tree = helix_detect
			#Socket_1
			group_19.inputs[0].default_value = 3
			...
			#node Switch
			switch_12 = _mn_topo_calc_helix.nodes.new("GeometryNodeSwitch")
			switch_12.name = "Switch"
			switch_12.input_type = 'INT'
			#False
			switch_12.inputs[1].default_value = -1
			
			#node Switch.001
			switch_001_3 = _mn_topo_calc_helix.nodes.new("GeometryNodeSwitch")
			...
			#node Frame
			frame_5 = _mn_topo_calc_helix.nodes.new("NodeFrame")
			frame_5.label = "If part of a helix, return the Index of the CA that is bonded"
			frame_5.name = "Frame"
			...
			#Set parents
			group_004_4.parent = frame_5
			index_5.parent = frame_5
			switch_12.parent = frame_5
			switch_001_3.parent = frame_5
			group_005_5.parent = frame_5
			switch_002_3.parent = frame_5
			group_006_4.parent = frame_5
			
			#Set locations
			group_output_57.location = (900.0, 620.0)
			group_001_12.location = (660.0, 620.0)
			boolean_math_004_6.location = (320.0, 620.0)
			boolean_math_005_3.location = (500.0, 620.0)
			group_19.location = (137.64556884765625, 620.0)
			...
			group_19.width, group_19.height = 142.35443115234375, 100.0
			...
			frame_5.width, frame_5.height = 700.0, 372.0
			
			#initialize _mn_topo_calc_helix links
			#boolean_math_004_6.Boolean -> boolean_math_005_3.Boolean
			_mn_topo_calc_helix.links.new(boolean_math_004_6.outputs[0], boolean_math_005_3.inputs[0])
			#group_001_12.Boolean -> group_output_57.Is Helix
			_mn_topo_calc_helix.links.new(group_001_12.outputs[0], group_output_57.inputs[0])
			#group_19.Boolean -> boolean_math_004_6.Boolean
			_mn_topo_calc_helix.links.new(group_19.outputs[0], boolean_math_004_6.inputs[0])
			#group_002_7.Boolean -> boolean_math_004_6.Boolean
			_mn_topo_calc_helix.links.new(group_002_7.outputs[0], boolean_math_004_6.inputs[1])
			...
			#boolean_math_005_3.Boolean -> group_001_12.Boolean
			_mn_topo_calc_helix.links.new(boolean_math_005_3.outputs[0], group_001_12.inputs[0])
			#index_5.Index -> group_004_4.Value
			_mn_topo_calc_helix.links.new(index_5.outputs[0], group_004_4.inputs[1])
			#group_004_4.Value -> switch_12.True
			_mn_topo_calc_helix.links.new(group_004_4.outputs[0], switch_12.inputs[2])
			#group_19.Boolean -> switch_12.Switch
			_mn_topo_calc_helix.links.new(group_19.outputs[0], switch_12.inputs[0])
			#switch_12.Output -> switch_001_3.False
			_mn_topo_calc_helix.links.new(switch_12.outputs[0], switch_001_3.inputs[1])
			#group_002_7.Boolean -> switch_001_3.Switch
			_mn_topo_calc_helix.links.new(group_002_7.outputs[0], switch_001_3.inputs[0])
			#group_005_5.Value -> switch_001_3.True
			_mn_topo_calc_helix.links.new(group_005_5.outputs[0], switch_001_3.inputs[2])
			#switch_001_3.Output -> switch_002_3.False
			_mn_topo_calc_helix.links.new(switch_001_3.outputs[0], switch_002_3.inputs[1])
			#group_003_6.Boolean -> switch_002_3.Switch
			_mn_topo_calc_helix.links.new(group_003_6.outputs[0], switch_002_3.inputs[0])
			#index_5.Index -> group_005_5.Value
			_mn_topo_calc_helix.links.new(index_5.outputs[0], group_005_5.inputs[1])
			#index_5.Index -> group_006_4.Value
			_mn_topo_calc_helix.links.new(index_5.outputs[0], group_006_4.inputs[1])
			#group_006_4.Value -> switch_002_3.True
			_mn_topo_calc_helix.links.new(group_006_4.outputs[0], switch_002_3.inputs[2])
			#switch_002_3.Output -> group_output_57.Bonded Index
			_mn_topo_calc_helix.links.new(switch_002_3.outputs[0], group_output_57.inputs[1])
		...
		def self_sample_proximity_node_group():
			...
			#node Group Output
			group_output_58 = self_sample_proximity.nodes.new("NodeGroupOutput")
			group_output_58.name = "Group Output"
			group_output_58.is_active_output = True
			
			#node Group Input
			group_input_56 = self_sample_proximity.nodes.new("NodeGroupInput")
			group_input_56.name = "Group Input"
			
			#node Set Position.002
			set_position_002_1 = self_sample_proximity.nodes.new("GeometryNodeSetPosition")
			...
			#Set locations
			group_output_58.location = (4.068901062011719, 95.01506042480469)
			group_input_56.location = (-640.0, 20.0)
			set_position_002_1.location = (-380.0, -20.0)
			...
			#group_input_56.Input -> set_position_002_1.Geometry
			self_sample_proximity.links.new(group_input_56.outputs[0], set_position_002_1.inputs[0])
			#set_position_002_1.Geometry -> sample_nearest_001.Geometry
			self_sample_proximity.links.new(set_position_002_1.outputs[0], sample_nearest_001.inputs[0])
			#group_input_56.Target Position -> set_position_002_1.Position
			self_sample_proximity.links.new(group_input_56.outputs[1], set_position_002_1.inputs[2])
			#group_input_56.Self Position -> sample_nearest_001.Sample Position
			self_sample_proximity.links.new(group_input_56.outputs[2], sample_nearest_001.inputs[1])
			#sample_nearest_001.Index -> group_output_58.Closest Index
			self_sample_proximity.links.new(sample_nearest_001.outputs[0], group_output_58.inputs[0])
		...
		def hbond_backbone_check_backup_node_group():
			...
			#node Group Output
			group_output_59 = hbond_backbone_check_backup.nodes.new("NodeGroupOutput")
			group_output_59.name = "Group Output"
			group_output_59.is_active_output = True
			
			#node Group Input
			group_input_57 = hbond_backbone_check_backup.nodes.new("NodeGroupInput")
			...
			#node Math
			math_16 = hbond_backbone_check_backup.nodes.new("ShaderNodeMath")
			math_16.name = "Math"
			math_16.operation = 'ADD'
			math_16.use_clamp = False
			
			#node Math.001
			math_001_9 = hbond_backbone_check_backup.nodes.new("ShaderNodeMath")
			math_001_9.name = "Math.001"
			math_001_9.operation = 'ADD'
			math_001_9.use_clamp = False
			
			#node Math.002
			math_002_6 = hbond_backbone_check_backup.nodes.new("ShaderNodeMath")
			math_002_6.name = "Math.002"
			math_002_6.operation = 'SUBTRACT'
			...
			#node Compare
			compare_12 = hbond_backbone_check_backup.nodes.new("FunctionNodeCompare")
			compare_12.name = "Compare"
			compare_12.data_type = 'FLOAT'
			compare_12.mode = 'ELEMENT'
			compare_12.operation = 'GREATER_THAN'
			
			#node Integer
			integer_3 = hbond_backbone_check_backup.nodes.new("FunctionNodeInputInt")
			integer_3.name = "Integer"
			integer_3.integer = 1
			
			#node Frame
			frame_6 = hbond_backbone_check_backup.nodes.new("NodeFrame")
			...
			#node Switch
			switch_13 = hbond_backbone_check_backup.nodes.new("GeometryNodeSwitch")
			switch_13.name = "Switch"
			switch_13.input_type = 'BOOLEAN'
			#False
			switch_13.inputs[1].default_value = False
			
			#node Compare.001
			compare_001_8 = hbond_backbone_check_backup.nodes.new("FunctionNodeCompare")
			compare_001_8.name = "Compare.001"
			compare_001_8.data_type = 'FLOAT'
			compare_001_8.mode = 'ELEMENT'
			compare_001_8.operation = 'LESS_THAN'
			
			#node Vector Math
			vector_math_11 = hbond_backbone_check_backup.nodes.new("ShaderNodeVectorMath")
			vector_math_11.name = "Vector Math"
			vector_math_11.operation = 'LENGTH'
			
			#node Group
			group_20 = hbond_backbone_check_backup.nodes.new("GeometryNodeGroup")
			group_20.name = "Group"
			group_20.node_tree = mn_units
			#Input_1
			group_20.inputs[0].default_value = 3.0
			
			
			
			#Set parents
			math_002_6.parent = frame_6
			math_003_5.parent = frame_6
			compare_12.parent = frame_6
			integer_3.parent = frame_6
			
			#Set locations
			group_output_59.location = (820.0, 240.0)
			group_input_57.location = (-680.0, 140.0)
			...
			math_16.location = (-480.0, 240.0)
			math_001_9.location = (-480.0, 80.0)
			math_002_6.location = (70.0, 640.0)
			math_003_5.location = (240.0, 640.0)
			compare_12.location = (420.0, 640.0)
			integer_3.location = (240.0, 500.0)
			frame_6.location = (-70.0, 40.0)
			switch_13.location = (620.0, 340.0)
			compare_001_8.location = (520.0, 140.0)
			vector_math_11.location = (260.0, 20.0)
			group_20.location = (520.0, -20.0)
			...
			frame_6.width, frame_6.height = 550.0, 285.0
			...
			#math_001_9.Value -> evaluate_at_index_001_6.Index
			hbond_backbone_check_backup.links.new(math_001_9.outputs[0], evaluate_at_index_001_6.inputs[0])
			#math_001_9.Value -> evaluate_at_index_8.Index
			hbond_backbone_check_backup.links.new(math_001_9.outputs[0], evaluate_at_index_8.inputs[0])
			...
			#group_009_5.NH -> evaluate_at_index_001_6.Value
			hbond_backbone_check_backup.links.new(group_009_5.outputs[4], evaluate_at_index_001_6.inputs[1])
			#group_009_5.N -> evaluate_at_index_8.Value
			hbond_backbone_check_backup.links.new(group_009_5.outputs[3], evaluate_at_index_8.inputs[1])
			#group_008_5.Bond Energy -> group_output_59.Bond Energy
			hbond_backbone_check_backup.links.new(group_008_5.outputs[1], group_output_59.inputs[1])
			#group_008_5.Bond Vector -> group_output_59.H->O
			hbond_backbone_check_backup.links.new(group_008_5.outputs[2], group_output_59.inputs[2])
			...
			#math_16.Value -> evaluate_at_index_002_3.Index
			hbond_backbone_check_backup.links.new(math_16.outputs[0], evaluate_at_index_002_3.inputs[0])
			#math_16.Value -> evaluate_at_index_003_3.Index
			hbond_backbone_check_backup.links.new(math_16.outputs[0], evaluate_at_index_003_3.inputs[0])
			#group_input_57.CO Index -> math_16.Value
			hbond_backbone_check_backup.links.new(group_input_57.outputs[0], math_16.inputs[0])
			#group_input_57.CO Offset -> math_16.Value
			hbond_backbone_check_backup.links.new(group_input_57.outputs[1], math_16.inputs[1])
			#group_input_57.NH Index -> math_001_9.Value
			hbond_backbone_check_backup.links.new(group_input_57.outputs[2], math_001_9.inputs[0])
			#group_input_57.NH Offset -> math_001_9.Value
			hbond_backbone_check_backup.links.new(group_input_57.outputs[3], math_001_9.inputs[1])
			#math_16.Value -> math_002_6.Value
			hbond_backbone_check_backup.links.new(math_16.outputs[0], math_002_6.inputs[0])
			#math_001_9.Value -> math_002_6.Value
			hbond_backbone_check_backup.links.new(math_001_9.outputs[0], math_002_6.inputs[1])
			#math_002_6.Value -> math_003_5.Value
			hbond_backbone_check_backup.links.new(math_002_6.outputs[0], math_003_5.inputs[0])
			#math_003_5.Value -> compare_12.A
			hbond_backbone_check_backup.links.new(math_003_5.outputs[0], compare_12.inputs[0])
			#integer_3.Integer -> compare_12.B
			hbond_backbone_check_backup.links.new(integer_3.outputs[0], compare_12.inputs[1])
			#compare_12.Result -> switch_13.Switch
			hbond_backbone_check_backup.links.new(compare_12.outputs[0], switch_13.inputs[0])
			#group_008_5.Bond Vector -> vector_math_11.Vector
			hbond_backbone_check_backup.links.new(group_008_5.outputs[2], vector_math_11.inputs[0])
			#vector_math_11.Value -> compare_001_8.A
			hbond_backbone_check_backup.links.new(vector_math_11.outputs[1], compare_001_8.inputs[0])
			#group_20.Angstrom -> compare_001_8.B
			hbond_backbone_check_backup.links.new(group_20.outputs[0], compare_001_8.inputs[1])
			#switch_13.Output -> group_output_59.Is Bonded
			hbond_backbone_check_backup.links.new(switch_13.outputs[0], group_output_59.inputs[0])
			#group_008_5.Is Bonded -> switch_13.True
			hbond_backbone_check_backup.links.new(group_008_5.outputs[0], switch_13.inputs[2])
		...
		def _hbond_i__j__and_hbond_j__i__node_group():
			...
			#node Group Output
			group_output_60 = _hbond_i__j__and_hbond_j__i_.nodes.new("NodeGroupOutput")
			group_output_60.name = "Group Output"
			group_output_60.is_active_output = True
			
			#node Group Input
			group_input_58 = _hbond_i__j__and_hbond_j__i_.nodes.new("NodeGroupInput")
			...
			#node Frame
			frame_7 = _hbond_i__j__and_hbond_j__i_.nodes.new("NodeFrame")
			...
			#node Frame.001
			frame_001_2 = _hbond_i__j__and_hbond_j__i_.nodes.new("NodeFrame")
			...
			#node Boolean Math.003
			boolean_math_003_6 = _hbond_i__j__and_hbond_j__i_.nodes.new("FunctionNodeBooleanMath")
			...
			#Set locations
			group_output_60.location = (640.0, 180.0)
			group_input_58.location = (-235.75640869140625, 47.462432861328125)
			group_010_2.location = (-640.0, 40.0)
			group_011_3.location = (-640.0, -220.0)
			frame_7.location = (635.0, 20.0)
			frame_001_2.location = (630.0, 140.0)
			...
			#group_010_2.Is Bonded -> boolean_math_003_6.Boolean
			_hbond_i__j__and_hbond_j__i_.links.new(group_010_2.outputs[0], boolean_math_003_6.inputs[0])
			#group_011_3.Is Bonded -> boolean_math_003_6.Boolean
			_hbond_i__j__and_hbond_j__i_.links.new(group_011_3.outputs[0], boolean_math_003_6.inputs[1])
			#boolean_math_003_6.Boolean -> group_output_60.Boolean
			_hbond_i__j__and_hbond_j__i_.links.new(boolean_math_003_6.outputs[0], group_output_60.inputs[0])
			#group_input_58.j -> group_010_2.NH Index
			_hbond_i__j__and_hbond_j__i_.links.new(group_input_58.outputs[1], group_010_2.inputs[2])
			#group_input_58.j -> group_011_3.CO Index
			_hbond_i__j__and_hbond_j__i_.links.new(group_input_58.outputs[1], group_011_3.inputs[0])
			#group_input_58.i -> group_010_2.CO Index
			_hbond_i__j__and_hbond_j__i_.links.new(group_input_58.outputs[0], group_010_2.inputs[0])
			#group_input_58.i -> group_011_3.NH Index
			_hbond_i__j__and_hbond_j__i_.links.new(group_input_58.outputs[0], group_011_3.inputs[2])
		...
		def _hbond_i___1__j___1__and_hbond_j___1__i___1__node_group():
			...
			#node Group Output
			group_output_61 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.nodes.new("NodeGroupOutput")
			group_output_61.name = "Group Output"
			group_output_61.is_active_output = True
			
			#node Group Input
			group_input_59 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.nodes.new("NodeGroupInput")
			...
			#node Frame
			frame_8 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.nodes.new("NodeFrame")
			frame_8.label = "Check Backbone O is bonded to an NH"
			frame_8.name = "Frame"
			frame_8.label_size = 20
			frame_8.shrink = True
			
			#node Frame.001
			frame_001_3 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.nodes.new("NodeFrame")
			...
			#node Boolean Math.003
			boolean_math_003_7 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.nodes.new("FunctionNodeBooleanMath")
			...
			group_011_4.parent = frame_8
			
			#Set locations
			group_output_61.location = (625.0, 0.0)
			group_input_59.location = (-394.84100341796875, -236.38262939453125)
			group_010_3.location = (-655.0, 40.0)
			group_011_4.location = (-640.0, -220.0)
			frame_8.location = (635.0, 20.0)
			...
			frame_8.width, frame_8.height = 327.0645751953125, 309.0
			...
			#group_010_3.Is Bonded -> boolean_math_003_7.Boolean
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_010_3.outputs[0], boolean_math_003_7.inputs[0])
			#group_011_4.Is Bonded -> boolean_math_003_7.Boolean
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_011_4.outputs[0], boolean_math_003_7.inputs[1])
			#boolean_math_003_7.Boolean -> group_output_61.Boolean
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(boolean_math_003_7.outputs[0], group_output_61.inputs[0])
			#group_input_59.j -> group_010_3.NH Index
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_input_59.outputs[1], group_010_3.inputs[2])
			#group_input_59.j -> group_011_4.CO Index
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_input_59.outputs[1], group_011_4.inputs[0])
			#group_input_59.i -> group_010_3.CO Index
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_input_59.outputs[0], group_010_3.inputs[0])
			#group_input_59.i -> group_011_4.NH Index
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_input_59.outputs[0], group_011_4.inputs[2])
		...
		def _hbond_i___1_j__and_hbond_j_i___1__node_group():
			...
			#node Group Output
			group_output_62 = _hbond_i___1_j__and_hbond_j_i___1_.nodes.new("NodeGroupOutput")
			group_output_62.name = "Group Output"
			group_output_62.is_active_output = True
			
			#node Group Input
			group_input_60 = _hbond_i___1_j__and_hbond_j_i___1_.nodes.new("NodeGroupInput")
			...
			#node Frame
			frame_9 = _hbond_i___1_j__and_hbond_j_i___1_.nodes.new("NodeFrame")
			...
			#node Frame.001
			frame_001_4 = _hbond_i___1_j__and_hbond_j_i___1_.nodes.new("NodeFrame")
			...
			#node Boolean Math.003
			boolean_math_003_8 = _hbond_i___1_j__and_hbond_j_i___1_.nodes.new("FunctionNodeBooleanMath")
			...
			group_011_5.parent = frame_9
			
			#Set locations
			group_output_62.location = (625.0, 0.0)
			group_input_60.location = (-373.2626953125, 13.94732666015625)
			...
			#group_010_4.Is Bonded -> boolean_math_003_8.Boolean
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_010_4.outputs[0], boolean_math_003_8.inputs[0])
			#group_011_5.Is Bonded -> boolean_math_003_8.Boolean
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_011_5.outputs[0], boolean_math_003_8.inputs[1])
			#boolean_math_003_8.Boolean -> group_output_62.Boolean
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(boolean_math_003_8.outputs[0], group_output_62.inputs[0])
			#group_input_60.j -> group_010_4.NH Index
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_input_60.outputs[1], group_010_4.inputs[2])
			#group_input_60.j -> group_011_5.CO Index
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_input_60.outputs[1], group_011_5.inputs[0])
			#group_input_60.i -> group_010_4.CO Index
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_input_60.outputs[0], group_010_4.inputs[0])
			#group_input_60.i -> group_011_5.NH Index
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_input_60.outputs[0], group_011_5.inputs[2])
		...
		def _hbond_j___1_i_and_hbond_i_j___1__node_group():
			...
			#node Group Output
			group_output_63 = _hbond_j___1_i_and_hbond_i_j___1_.nodes.new("NodeGroupOutput")
			group_output_63.name = "Group Output"
			group_output_63.is_active_output = True
			
			#node Group Input
			group_input_61 = _hbond_j___1_i_and_hbond_i_j___1_.nodes.new("NodeGroupInput")
			...
			#node Frame
			frame_10 = _hbond_j___1_i_and_hbond_i_j___1_.nodes.new("NodeFrame")
			...
			#node Frame.001
			frame_001_5 = _hbond_j___1_i_and_hbond_i_j___1_.nodes.new("NodeFrame")
			...
			#node Boolean Math.003
			boolean_math_003_9 = _hbond_j___1_i_and_hbond_i_j___1_.nodes.new("FunctionNodeBooleanMath")
			...
			group_011_6.parent = frame_10
			
			#Set locations
			group_output_63.location = (625.0, 0.0)
			group_input_61.location = (-360.0, 120.0)
			...
			#group_010_5.Is Bonded -> boolean_math_003_9.Boolean
			_hbond_j___1_i_and_hbond_i_j___1_.links.new(group_010_5.outputs[0], boolean_math_003_9.inputs[0])
			#group_011_6.Is Bonded -> boolean_math_003_9.Boolean
			_hbond_j___1_i_and_hbond_i_j___1_.links.new(group_011_6.outputs[0], boolean_math_003_9.inputs[1])
			#boolean_math_003_9.Boolean -> group_output_63.Boolean
			_hbond_j___1_i_and_hbond_i_j___1_.links.new(boolean_math_003_9.outputs[0], group_output_63.inputs[0])
			#group_input_61.j -> group_011_6.NH Index
			_hbond_j___1_i_and_hbond_i_j___1_.links.new(group_input_61.outputs[1], group_011_6.inputs[2])
			#group_input_61.j -> group_010_5.CO Index
			_hbond_j___1_i_and_hbond_i_j___1_.links.new(group_input_61.outputs[1], group_010_5.inputs[0])
			#group_input_61.i -> group_010_5.NH Index
			_hbond_j___1_i_and_hbond_i_j___1_.links.new(group_input_61.outputs[0], group_010_5.inputs[2])
			#group_input_61.i -> group_011_6.CO Index
			_hbond_j___1_i_and_hbond_i_j___1_.links.new(group_input_61.outputs[0], group_011_6.inputs[0])
		...
		def _dssp_sheet_checks_node_group():
			...
			#node Group Output
			group_output_64 = _dssp_sheet_checks.nodes.new("NodeGroupOutput")
			group_output_64.name = "Group Output"
			group_output_64.is_active_output = True
			
			#node Group Input
			group_input_62 = _dssp_sheet_checks.nodes.new("NodeGroupInput")
			group_input_62.name = "Group Input"
			
			#node Group.001
			group_001_13 = _dssp_sheet_checks.nodes.new("GeometryNodeGroup")
			group_001_13.name = "Group.001"
			group_001_13.node_tree = _hbond_i__j__and_hbond_j__i_
			...
			#node Boolean Math
			boolean_math_15 = _dssp_sheet_checks.nodes.new("FunctionNodeBooleanMath")
			...
			#node Frame
			frame_11 = _dssp_sheet_checks.nodes.new("NodeFrame")
			frame_11.label = "Anti-parallel Bridge"
			frame_11.name = "Frame"
			frame_11.label_size = 20
			frame_11.shrink = True
			
			#node Frame.001
			frame_001_6 = _dssp_sheet_checks.nodes.new("NodeFrame")
			frame_001_6.label = "Paralell Bridge"
			...
			#node Boolean Math.002
			boolean_math_002_8 = _dssp_sheet_checks.nodes.new("FunctionNodeBooleanMath")
			...
			#Set parents
			group_001_13.parent = frame_11
			group_002_8.parent = frame_11
			boolean_math_15.parent = frame_11
			group_004_5.parent = frame_001_6
			boolean_math_001_11.parent = frame_001_6
			group_005_6.parent = frame_001_6
			
			#Set locations
			group_output_64.location = (570.0, 0.0)
			group_input_62.location = (-657.7005004882812, 1.8694610595703125)
			group_001_13.location = (-800.0, 160.0)
			group_002_8.location = (-800.0, 0.0)
			boolean_math_15.location = (-440.0, 160.0)
			group_004_5.location = (-800.0, -300.0)
			frame_11.location = (580.0, 180.0)
			frame_001_6.location = (580.0, 180.0)
			boolean_math_001_11.location = (-440.0, -300.0)
			boolean_math_002_8.location = (380.0, 140.0)
			...
			group_001_13.width, group_001_13.height = 333.0748291015625, 100.0
			...
			frame_11.width, frame_11.height = 560.0, 350.0
			frame_001_6.width, frame_001_6.height = 560.0, 350.0
			...
			#group_001_13.Boolean -> boolean_math_15.Boolean
			_dssp_sheet_checks.links.new(group_001_13.outputs[0], boolean_math_15.inputs[0])
			#group_input_62.j -> group_002_8.j
			_dssp_sheet_checks.links.new(group_input_62.outputs[1], group_002_8.inputs[1])
			#boolean_math_001_11.Boolean -> boolean_math_002_8.Boolean
			_dssp_sheet_checks.links.new(boolean_math_001_11.outputs[0], boolean_math_002_8.inputs[1])
			#group_004_5.Boolean -> boolean_math_001_11.Boolean
			_dssp_sheet_checks.links.new(group_004_5.outputs[0], boolean_math_001_11.inputs[0])
			#group_input_62.j -> group_005_6.j
			_dssp_sheet_checks.links.new(group_input_62.outputs[1], group_005_6.inputs[1])
			#group_002_8.Boolean -> boolean_math_15.Boolean
			_dssp_sheet_checks.links.new(group_002_8.outputs[0], boolean_math_15.inputs[1])
			#group_input_62.j -> group_001_13.j
			_dssp_sheet_checks.links.new(group_input_62.outputs[1], group_001_13.inputs[1])
			#boolean_math_15.Boolean -> boolean_math_002_8.Boolean
			_dssp_sheet_checks.links.new(boolean_math_15.outputs[0], boolean_math_002_8.inputs[0])
			#group_005_6.Boolean -> boolean_math_001_11.Boolean
			_dssp_sheet_checks.links.new(group_005_6.outputs[0], boolean_math_001_11.inputs[1])
			#group_input_62.j -> group_004_5.j
			_dssp_sheet_checks.links.new(group_input_62.outputs[1], group_004_5.inputs[1])
			#boolean_math_002_8.Boolean -> group_output_64.Boolean
			_dssp_sheet_checks.links.new(boolean_math_002_8.outputs[0], group_output_64.inputs[0])
			#group_input_62.Index -> group_001_13.i
			_dssp_sheet_checks.links.new(group_input_62.outputs[0], group_001_13.inputs[0])
			#group_input_62.Index -> group_002_8.i
			_dssp_sheet_checks.links.new(group_input_62.outputs[0], group_002_8.inputs[0])
			#group_input_62.Index -> group_004_5.i
			_dssp_sheet_checks.links.new(group_input_62.outputs[0], group_004_5.inputs[0])
			#group_input_62.Index -> group_005_6.i
			_dssp_sheet_checks.links.new(group_input_62.outputs[0], group_005_6.inputs[0])
			#group_input_62.j -> group_output_64.j
			_dssp_sheet_checks.links.new(group_input_62.outputs[1], group_output_64.inputs[1])
		...
		def _mn_topo_calc_sheet_node_group():
			...
			#Socket Geometry
			geometry_socket_8 = _mn_topo_calc_sheet.interface.new_socket(name = "Geometry", in_out='OUTPUT', socket_type = 'NodeSocketGeometry')
			...
			#Socket Geometry
			geometry_socket_9 = _mn_topo_calc_sheet.interface.new_socket(name = "Geometry", in_out='INPUT', socket_type = 'NodeSocketGeometry')
			geometry_socket_9.attribute_domain = 'POINT'
			
			
			#initialize _mn_topo_calc_sheet nodes
			#node Group Output
			group_output_65 = _mn_topo_calc_sheet.nodes.new("NodeGroupOutput")
			group_output_65.name = "Group Output"
			group_output_65.is_active_output = True
			
			#node Group Input
			group_input_63 = _mn_topo_calc_sheet.nodes.new("NodeGroupInput")
			...
			#node Group
			group_21 = _mn_topo_calc_sheet.nodes.new("GeometryNodeGroup")
			group_21.name = "Group"
			group_21.mute = True
			group_21.node_tree = boolean_run_fill
			#Socket_2
			group_21.inputs[1].default_value = 1
			...
			#node Capture Attribute
			capture_attribute_2 = _mn_topo_calc_sheet.nodes.new("GeometryNodeCaptureAttribute")
			...
			capture_attribute_2.capture_items.new('FLOAT', "Closest Index")
			capture_attribute_2.capture_items["Closest Index"].data_type = 'INT'
			capture_attribute_2.capture_items.new('FLOAT', "Closest Index.001")
			capture_attribute_2.capture_items["Closest Index.001"].data_type = 'INT'
			capture_attribute_2.capture_items.new('FLOAT', "Closest Index.002")
			capture_attribute_2.capture_items["Closest Index.002"].data_type = 'INT'
			...
			#node Boolean Math
			boolean_math_16 = _mn_topo_calc_sheet.nodes.new("FunctionNodeBooleanMath")
			...
			#node Vector Math
			vector_math_12 = _mn_topo_calc_sheet.nodes.new("ShaderNodeVectorMath")
			vector_math_12.name = "Vector Math"
			vector_math_12.operation = 'SUBTRACT'
			...
			#node Group.014
			group_014_2 = _mn_topo_calc_sheet.nodes.new("GeometryNodeGroup")
			group_014_2.name = "Group.014"
			group_014_2.node_tree = self_sample_proximity
			...
			#node Boolean Math.002
			boolean_math_002_9 = _mn_topo_calc_sheet.nodes.new("FunctionNodeBooleanMath")
			...
			#node Boolean Math.003
			boolean_math_003_10 = _mn_topo_calc_sheet.nodes.new("FunctionNodeBooleanMath")
			boolean_math_003_10.name = "Boolean Math.003"
			boolean_math_003_10.operation = 'OR'
			...
			#node Reroute
			reroute_16 = _mn_topo_calc_sheet.nodes.new("NodeReroute")
			reroute_16.name = "Reroute"
			#node Boolean Math.004
			boolean_math_004_7 = _mn_topo_calc_sheet.nodes.new("FunctionNodeBooleanMath")
			boolean_math_004_7.name = "Boolean Math.004"
			boolean_math_004_7.operation = 'OR'
			
			#node Store Named Attribute
			store_named_attribute_4 = _mn_topo_calc_sheet.nodes.new("GeometryNodeStoreNamedAttribute")
			...
			#Name
			store_named_attribute_4.inputs[2].default_value = "tmp_bonded_idx"
			...
			#node Store Named Attribute.004
			store_named_attribute_004_2 = _mn_topo_calc_sheet.nodes.new("GeometryNodeStoreNamedAttribute")
			store_named_attribute_004_2.name = "Store Named Attribute.004"
			store_named_attribute_004_2.data_type = 'INT'
			store_named_attribute_004_2.domain = 'POINT'
			#Name
			store_named_attribute_004_2.inputs[2].default_value = "tmp_bonded_idx"
			
			#node Store Named Attribute.005
			store_named_attribute_005_2 = _mn_topo_calc_sheet.nodes.new("GeometryNodeStoreNamedAttribute")
			...
			#Name
			store_named_attribute_005_2.inputs[2].default_value = "tmp_bonded_idx"
			...
			#node Group.001
			group_001_14 = _mn_topo_calc_sheet.nodes.new("GeometryNodeGroup")
			group_001_14.name = "Group.001"
			group_001_14.node_tree = offset_integer
			#Socket_1
			group_001_14.inputs[0].default_value = 0
			#Socket_2
			group_001_14.inputs[2].default_value = 1
			
			#node Math
			math_17 = _mn_topo_calc_sheet.nodes.new("ShaderNodeMath")
			math_17.name = "Math"
			math_17.operation = 'ADD'
			math_17.use_clamp = False
			#Value_001
			math_17.inputs[1].default_value = -1.0
			...
			store_named_attribute_004_2.location = (300.0, 240.0)
			store_named_attribute_005_2.location = (460.0, 240.0)
			store_named_attribute_006.location = (620.0, 240.0)
			group_001_14.location = (-680.0, -540.0)
			math_17.location = (-520.0, -540.0)
			group_002_9.location = (-680.0, -720.0)
			math_001_10.location = (-520.0, -720.0)
			...
			group_21.width, group_21.height = 140.0, 100.0
			...
			group_001_14.width, group_001_14.height = 140.0, 100.0
			...
			#capture_attribute_002.Geometry -> group_output_65.Geometry
			_mn_topo_calc_sheet.links.new(capture_attribute_002.outputs[0], group_output_65.inputs[0])
			#capture_attribute_002.Value -> group_output_65.Attribute
			_mn_topo_calc_sheet.links.new(capture_attribute_002.outputs[1], group_output_65.inputs[1])
			#group_21.Boolean -> capture_attribute_002.Value
			_mn_topo_calc_sheet.links.new(group_21.outputs[0], capture_attribute_002.inputs[1])
			#group_input_63.Geometry -> group_006_5.Input
			_mn_topo_calc_sheet.links.new(group_input_63.outputs[0], group_006_5.inputs[0])
			...
			#group_input_63.Geometry -> capture_attribute_2.Geometry
			_mn_topo_calc_sheet.links.new(group_input_63.outputs[0], capture_attribute_2.inputs[0])
			#group_006_5.Closest Index -> capture_attribute_2.Value
			_mn_topo_calc_sheet.links.new(group_006_5.outputs[0], capture_attribute_2.inputs[1])
			#capture_attribute_2.Value -> group_008_6.j
			_mn_topo_calc_sheet.links.new(capture_attribute_2.outputs[1], group_008_6.inputs[1])
			#group_008_6.Boolean -> boolean_math_16.Boolean
			_mn_topo_calc_sheet.links.new(group_008_6.outputs[0], boolean_math_16.inputs[0])
			#group_003_7.Boolean -> group_21.Boolean
			_mn_topo_calc_sheet.links.new(group_003_7.outputs[0], group_21.inputs[0])
			#boolean_math_16.Boolean -> boolean_math_001_12.Boolean
			_mn_topo_calc_sheet.links.new(boolean_math_16.outputs[0], boolean_math_001_12.inputs[0])
			#group_input_63.Geometry -> group_011_7.Input
			_mn_topo_calc_sheet.links.new(group_input_63.outputs[0], group_011_7.inputs[0])
			#capture_attribute_2.Closest Index -> group_009_6.j
			_mn_topo_calc_sheet.links.new(capture_attribute_2.outputs[2], group_009_6.inputs[1])
			#group_012_4.O -> vector_math_12.Vector
			_mn_topo_calc_sheet.links.new(group_012_4.outputs[0], vector_math_12.inputs[1])
			#group_012_4.CA -> vector_math_001_5.Vector
			_mn_topo_calc_sheet.links.new(group_012_4.outputs[2], vector_math_001_5.inputs[0])
			#vector_math_12.Vector -> vector_math_002_4.Vector
			_mn_topo_calc_sheet.links.new(vector_math_12.outputs[0], vector_math_002_4.inputs[0])
			...
			#group_012_4.C -> vector_math_12.Vector
			_mn_topo_calc_sheet.links.new(group_012_4.outputs[1], vector_math_12.inputs[0])
			#group_input_63.Geometry -> group_013_2.Input
			_mn_topo_calc_sheet.links.new(group_input_63.outputs[0], group_013_2.inputs[0])
			#capture_attribute_2.Closest Index.001 -> group_010_6.j
			_mn_topo_calc_sheet.links.new(capture_attribute_2.outputs[3], group_010_6.inputs[1])
			...
			#group_010_6.Boolean -> boolean_math_001_12.Boolean
			_mn_topo_calc_sheet.links.new(group_010_6.outputs[0], boolean_math_001_12.inputs[1])
			#group_009_6.Boolean -> boolean_math_16.Boolean
			_mn_topo_calc_sheet.links.new(group_009_6.outputs[0], boolean_math_16.inputs[1])
			#group_input_63.Geometry -> group_014_2.Input
			_mn_topo_calc_sheet.links.new(group_input_63.outputs[0], group_014_2.inputs[0])
			#group_012_4.CA -> group_014_2.Target Position
			_mn_topo_calc_sheet.links.new(group_012_4.outputs[2], group_014_2.inputs[1])
			...
			#vector_math_003_4.Vector -> group_014_2.Self Position
			_mn_topo_calc_sheet.links.new(vector_math_003_4.outputs[0], group_014_2.inputs[2])
			#capture_attribute_2.Closest Index.002 -> group_015_1.j
			_mn_topo_calc_sheet.links.new(capture_attribute_2.outputs[4], group_015_1.inputs[1])
			#boolean_math_001_12.Boolean -> boolean_math_002_9.Boolean
			_mn_topo_calc_sheet.links.new(boolean_math_001_12.outputs[0], boolean_math_002_9.inputs[0])
			#group_015_1.Boolean -> boolean_math_002_9.Boolean
			_mn_topo_calc_sheet.links.new(group_015_1.outputs[0], boolean_math_002_9.inputs[1])
			#boolean_math_002_9.Boolean -> boolean_math_003_10.Boolean
			_mn_topo_calc_sheet.links.new(boolean_math_002_9.outputs[0], boolean_math_003_10.inputs[0])
			#group_016_1.Boolean -> boolean_math_003_10.Boolean
			_mn_topo_calc_sheet.links.new(group_016_1.outputs[0], boolean_math_003_10.inputs[1])
			#capture_attribute_2.Value -> reroute_16.Input
			_mn_topo_calc_sheet.links.new(capture_attribute_2.outputs[1], reroute_16.inputs[0])
			#boolean_math_003_10.Boolean -> boolean_math_004_7.Boolean
			_mn_topo_calc_sheet.links.new(boolean_math_003_10.outputs[0], boolean_math_004_7.inputs[0])
			#group_017_2.Boolean -> boolean_math_004_7.Boolean
			_mn_topo_calc_sheet.links.new(group_017_2.outputs[0], boolean_math_004_7.inputs[1])
			#boolean_math_004_7.Boolean -> group_003_7.Boolean
			_mn_topo_calc_sheet.links.new(boolean_math_004_7.outputs[0], group_003_7.inputs[0])
			#store_named_attribute_002_2.Geometry -> store_named_attribute_4.Geometry
			_mn_topo_calc_sheet.links.new(store_named_attribute_002_2.outputs[0], store_named_attribute_4.inputs[0])
			#group_008_6.j -> store_named_attribute_4.Value
			_mn_topo_calc_sheet.links.new(group_008_6.outputs[1], store_named_attribute_4.inputs[3])
			#group_008_6.Boolean -> store_named_attribute_4.Selection
			_mn_topo_calc_sheet.links.new(group_008_6.outputs[0], store_named_attribute_4.inputs[1])
			#store_named_attribute_4.Geometry -> store_named_attribute_001_2.Geometry
			_mn_topo_calc_sheet.links.new(store_named_attribute_4.outputs[0], store_named_attribute_001_2.inputs[0])
			...
			#capture_attribute_2.Geometry -> store_named_attribute_002_2.Geometry
			_mn_topo_calc_sheet.links.new(capture_attribute_2.outputs[0], store_named_attribute_002_2.inputs[0])
			...
			#group_010_6.Boolean -> store_named_attribute_003_1.Selection
			_mn_topo_calc_sheet.links.new(group_010_6.outputs[0], store_named_attribute_003_1.inputs[1])
			#group_010_6.j -> store_named_attribute_003_1.Value
			_mn_topo_calc_sheet.links.new(group_010_6.outputs[1], store_named_attribute_003_1.inputs[3])
			#store_named_attribute_003_1.Geometry -> store_named_attribute_004_2.Geometry
			_mn_topo_calc_sheet.links.new(store_named_attribute_003_1.outputs[0], store_named_attribute_004_2.inputs[0])
			#group_015_1.Boolean -> store_named_attribute_004_2.Selection
			_mn_topo_calc_sheet.links.new(group_015_1.outputs[0], store_named_attribute_004_2.inputs[1])
			#group_015_1.j -> store_named_attribute_004_2.Value
			_mn_topo_calc_sheet.links.new(group_015_1.outputs[1], store_named_attribute_004_2.inputs[3])
			#store_named_attribute_004_2.Geometry -> store_named_attribute_005_2.Geometry
			_mn_topo_calc_sheet.links.new(store_named_attribute_004_2.outputs[0], store_named_attribute_005_2.inputs[0])
			#group_016_1.Boolean -> store_named_attribute_005_2.Selection
			_mn_topo_calc_sheet.links.new(group_016_1.outputs[0], store_named_attribute_005_2.inputs[1])
			#group_016_1.j -> store_named_attribute_005_2.Value
			_mn_topo_calc_sheet.links.new(group_016_1.outputs[1], store_named_attribute_005_2.inputs[3])
			#store_named_attribute_005_2.Geometry -> store_named_attribute_006.Geometry
			_mn_topo_calc_sheet.links.new(store_named_attribute_005_2.outputs[0], store_named_attribute_006.inputs[0])
			#group_017_2.Boolean -> store_named_attribute_006.Selection
			_mn_topo_calc_sheet.links.new(group_017_2.outputs[0], store_named_attribute_006.inputs[1])
			#group_017_2.j -> store_named_attribute_006.Value
			_mn_topo_calc_sheet.links.new(group_017_2.outputs[1], store_named_attribute_006.inputs[3])
			#group_001_14.Value -> math_17.Value
			_mn_topo_calc_sheet.links.new(group_001_14.outputs[0], math_17.inputs[0])
			#reroute_16.Output -> group_001_14.Value
			_mn_topo_calc_sheet.links.new(reroute_16.outputs[0], group_001_14.inputs[1])
			#math_17.Value -> group_016_1.j
			_mn_topo_calc_sheet.links.new(math_17.outputs[0], group_016_1.inputs[1])
			#group_002_9.Value -> math_001_10.Value
			_mn_topo_calc_sheet.links.new(group_002_9.outputs[0], math_001_10.inputs[0])
			#reroute_16.Output -> group_002_9.Value
			_mn_topo_calc_sheet.links.new(reroute_16.outputs[0], group_002_9.inputs[1])
			#math_001_10.Value -> group_017_2.j
			_mn_topo_calc_sheet.links.new(math_001_10.outputs[0], group_017_2.inputs[1])
			#group_013_2.Closest Index -> capture_attribute_2.Closest Index
			_mn_topo_calc_sheet.links.new(group_013_2.outputs[0], capture_attribute_2.inputs[2])
			#group_011_7.Closest Index -> capture_attribute_2.Closest Index.001
			_mn_topo_calc_sheet.links.new(group_011_7.outputs[0], capture_attribute_2.inputs[3])
			#group_014_2.Closest Index -> capture_attribute_2.Closest Index.002
			_mn_topo_calc_sheet.links.new(group_014_2.outputs[0], capture_attribute_2.inputs[4])
		...
		def topology_dssp_node_group():
			...
			#Socket Atoms
			atoms_socket_4 = topology_dssp.interface.new_socket(name = "Atoms", in_out='OUTPUT', socket_type = 'NodeSocketGeometry')
			atoms_socket_4.attribute_domain = 'POINT'
			
			#Socket Atoms
			atoms_socket_5 = topology_dssp.interface.new_socket(name = "Atoms", in_out='INPUT', socket_type = 'NodeSocketGeometry')
			atoms_socket_5.attribute_domain = 'POINT'
			
			#Socket Selection
			selection_socket_8 = topology_dssp.interface.new_socket(name = "Selection", in_out='INPUT', socket_type = 'NodeSocketBool')
			selection_socket_8.default_value = True
			...
			#node Group Output
			group_output_66 = topology_dssp.nodes.new("NodeGroupOutput")
			group_output_66.name = "Group Output"
			group_output_66.is_active_output = True
			
			#node Group Input
			group_input_64 = topology_dssp.nodes.new("NodeGroupInput")
			...
			#node Sample Index
			sample_index_1 = topology_dssp.nodes.new("GeometryNodeSampleIndex")
			sample_index_1.name = "Sample Index"
			sample_index_1.clamp = False
			sample_index_1.data_type = 'BOOLEAN'
			...
			#node Sample Index.001
			sample_index_001_1 = topology_dssp.nodes.new("GeometryNodeSampleIndex")
			...
			#node Switch
			switch_14 = topology_dssp.nodes.new("GeometryNodeSwitch")
			switch_14.name = "Switch"
			switch_14.input_type = 'INT'
			#False
			switch_14.inputs[1].default_value = 3
			#True
			switch_14.inputs[2].default_value = 2
			
			#node Switch.001
			switch_001_4 = topology_dssp.nodes.new("GeometryNodeSwitch")
			switch_001_4.name = "Switch.001"
			switch_001_4.input_type = 'INT'
			#True
			switch_001_4.inputs[2].default_value = 1
			
			#node Reroute.003
			reroute_003_5 = topology_dssp.nodes.new("NodeReroute")
			...
			#node Frame
			frame_12 = topology_dssp.nodes.new("NodeFrame")
			frame_12.label = "Compute Helix"
			frame_12.name = "Frame"
			frame_12.label_size = 20
			frame_12.shrink = True
			
			#node Frame.001
			frame_001_7 = topology_dssp.nodes.new("NodeFrame")
			frame_001_7.label = "Compute Sheet"
			...
			#Set parents
			group_002_10.parent = frame_12
			sample_index_1.parent = frame_12
			group_005_7.parent = frame_001_7
			sample_index_001_1.parent = frame_001_7
			
			#Set locations
			group_output_66.location = (676.5311889648438, 311.6835632324219)
			group_input_64.location = (-1820.0, 380.0)
			group_002_10.location = (-1140.0, -80.0)
			store_named_attribute_003_2.location = (-520.0, 480.0)
			sample_index_1.location = (-740.0, -60.0)
			group_005_7.location = (-1140.0, -380.0)
			sample_index_001_1.location = (-740.0, -380.0)
			sample_index_002.location = (-720.0, 120.0)
			index_6.location = (-920.0, 120.0)
			switch_14.location = (-520.0, -120.0)
			switch_001_4.location = (-520.0, 40.0)
			reroute_003_5.location = (-1300.0, -120.0)
			sample_index_003.location = (-520.0, 280.0)
			index_002_1.location = (-940.0, -200.0)
			mn_topo_compute_backbone_001.location = (-1560.0, 300.0)
			frame_12.location = (-10.0, 80.0)
			frame_001_7.location = (-10.0, 80.0)
			...
			frame_12.width, frame_12.height = 600.0, 264.0
			frame_001_7.width, frame_001_7.height = 600.0, 264.0
			
			#initialize topology_dssp links
			#group_input_64.Atoms -> store_named_attribute_003_2.Geometry
			topology_dssp.links.new(group_input_64.outputs[0], store_named_attribute_003_2.inputs[0])
			#reroute_003_5.Output -> sample_index_1.Geometry
			topology_dssp.links.new(reroute_003_5.outputs[0], sample_index_1.inputs[0])
			#store_named_attribute_003_2.Geometry -> group_output_66.Atoms
			topology_dssp.links.new(store_named_attribute_003_2.outputs[0], group_output_66.inputs[0])
			#reroute_003_5.Output -> group_005_7.Geometry
			topology_dssp.links.new(reroute_003_5.outputs[0], group_005_7.inputs[0])
			...
			#index_6.Index -> sample_index_002.Index
			topology_dssp.links.new(index_6.outputs[0], sample_index_002.inputs[2])
			#group_005_7.Geometry -> sample_index_001_1.Geometry
			topology_dssp.links.new(group_005_7.outputs[0], sample_index_001_1.inputs[0])
			#sample_index_001_1.Value -> switch_14.Switch
			topology_dssp.links.new(sample_index_001_1.outputs[0], switch_14.inputs[0])
			#switch_14.Output -> switch_001_4.False
			topology_dssp.links.new(switch_14.outputs[0], switch_001_4.inputs[1])
			#sample_index_1.Value -> switch_001_4.Switch
			topology_dssp.links.new(sample_index_1.outputs[0], switch_001_4.inputs[0])
			#mn_topo_compute_backbone_001.CA Atoms -> reroute_003_5.Input
			topology_dssp.links.new(mn_topo_compute_backbone_001.outputs[2], reroute_003_5.inputs[0])
			#group_002_10.Is Helix -> sample_index_1.Value
			topology_dssp.links.new(group_002_10.outputs[0], sample_index_1.inputs[1])
			#group_005_7.Attribute -> sample_index_001_1.Value
			topology_dssp.links.new(group_005_7.outputs[1], sample_index_001_1.inputs[1])
			...
			#switch_001_4.Output -> sample_index_003.Value
			topology_dssp.links.new(switch_001_4.outputs[0], sample_index_003.inputs[1])
			...
			#index_002_1.Index -> sample_index_1.Index
			topology_dssp.links.new(index_002_1.outputs[0], sample_index_1.inputs[2])
			#group_input_64.Selection -> store_named_attribute_003_2.Selection
			topology_dssp.links.new(group_input_64.outputs[1], store_named_attribute_003_2.inputs[1])
			#group_input_64.Atoms -> mn_topo_compute_backbone_001.Atoms
			topology_dssp.links.new(group_input_64.outputs[0], mn_topo_compute_backbone_001.inputs[0])
			#index_002_1.Index -> sample_index_001_1.Index
			topology_dssp.links.new(index_002_1.outputs[0], sample_index_001_1.inputs[2])
		...
		def _mn_constants_atom_name_nucleic_node_group():
			...
			#node Group Output
			group_output_67 = _mn_constants_atom_name_nucleic.nodes.new("NodeGroupOutput")
			group_output_67.name = "Group Output"
			group_output_67.is_active_output = True
			
			#node Group Input
			group_input_65 = _mn_constants_atom_name_nucleic.nodes.new("NodeGroupInput")
			group_input_65.name = "Group Input"
			
			#node Integer
			integer_4 = _mn_constants_atom_name_nucleic.nodes.new("FunctionNodeInputInt")
			integer_4.name = "Integer"
			integer_4.integer = 61
			...
			#Set locations
			group_output_67.location = (190.0, 0.0)
			group_input_65.location = (-200.0, 0.0)
			integer_4.location = (0.0, -100.0)
			...
			#integer_4.Integer -> group_output_67.Side Chain Lower
			_mn_constants_atom_name_nucleic.links.new(integer_4.outputs[0], group_output_67.inputs[2])
			#integer_001_1.Integer -> group_output_67.Side Chain Upper
			_mn_constants_atom_name_nucleic.links.new(integer_001_1.outputs[0], group_output_67.inputs[3])
			#integer_002_1.Integer -> group_output_67.Backbone Lower
			_mn_constants_atom_name_nucleic.links.new(integer_002_1.outputs[0], group_output_67.inputs[0])
			#integer_003_1.Integer -> group_output_67.Backbone Upper
			_mn_constants_atom_name_nucleic.links.new(integer_003_1.outputs[0], group_output_67.inputs[1])
			#integer_004_1.Integer -> group_output_67.Side Chain Joint Carbon
			_mn_constants_atom_name_nucleic.links.new(integer_004_1.outputs[0], group_output_67.inputs[4])
		...
		def _mn_select_nucleic_node_group():
			...
			#node Group Input
			group_input_66 = _mn_select_nucleic.nodes.new("NodeGroupInput")
			group_input_66.name = "Group Input"
			
			#node Compare
			compare_13 = _mn_select_nucleic.nodes.new("FunctionNodeCompare")
			compare_13.name = "Compare"
			compare_13.data_type = 'INT'
			compare_13.mode = 'ELEMENT'
			compare_13.operation = 'GREATER_EQUAL'
			
			#node Compare.001
			compare_001_9 = _mn_select_nucleic.nodes.new("FunctionNodeCompare")
			compare_001_9.name = "Compare.001"
			compare_001_9.data_type = 'INT'
			compare_001_9.mode = 'ELEMENT'
			compare_001_9.operation = 'LESS_EQUAL'
			...
			#node Group Output
			group_output_68 = _mn_select_nucleic.nodes.new("NodeGroupOutput")
			group_output_68.name = "Group Output"
			group_output_68.is_active_output = True
			
			#node Compare.002
			compare_002_3 = _mn_select_nucleic.nodes.new("FunctionNodeCompare")
			compare_002_3.name = "Compare.002"
			compare_002_3.data_type = 'INT'
			compare_002_3.mode = 'ELEMENT'
			compare_002_3.operation = 'GREATER_EQUAL'
			...
			#node Boolean Math.002
			boolean_math_002_10 = _mn_select_nucleic.nodes.new("FunctionNodeBooleanMath")
			...
			#node Boolean Math.003
			boolean_math_003_11 = _mn_select_nucleic.nodes.new("FunctionNodeBooleanMath")
			...
			#node Group
			group_22 = _mn_select_nucleic.nodes.new("GeometryNodeGroup")
			group_22.name = "Group"
			group_22.node_tree = _mn_constants_atom_name_nucleic
			
			
			
			
			#Set locations
			group_input_66.location = (-460.0, 0.0)
			compare_13.location = (80.0, 80.0)
			compare_001_9.location = (80.0, -80.0)
			boolean_math_001_13.location = (260.0, 80.0)
			group_output_68.location = (580.0, 60.0)
			compare_002_3.location = (80.0, -260.0)
			compare_003_2.location = (80.0, -420.0)
			boolean_math_002_10.location = (260.0, -260.0)
			compare_004_1.location = (80.0, -580.0)
			compare_005_1.location = (80.0, -740.0)
			boolean_math_003_11.location = (260.0, -580.0)
			named_attribute_8.location = (-260.0, -280.0)
			group_22.location = (-480.0, -100.0)
			...
			group_22.width, group_22.height = 365.8858337402344, 100.0
			
			#initialize _mn_select_nucleic links
			#compare_001_9.Result -> boolean_math_001_13.Boolean
			_mn_select_nucleic.links.new(compare_001_9.outputs[0], boolean_math_001_13.inputs[1])
			#named_attribute_8.Attribute -> compare_13.A
			_mn_select_nucleic.links.new(named_attribute_8.outputs[0], compare_13.inputs[2])
			#compare_13.Result -> boolean_math_001_13.Boolean
			_mn_select_nucleic.links.new(compare_13.outputs[0], boolean_math_001_13.inputs[0])
			#named_attribute_8.Attribute -> compare_001_9.A
			_mn_select_nucleic.links.new(named_attribute_8.outputs[0], compare_001_9.inputs[2])
			#boolean_math_001_13.Boolean -> group_output_68.Is Backbone
			_mn_select_nucleic.links.new(boolean_math_001_13.outputs[0], group_output_68.inputs[0])
			#group_22.Backbone Lower -> compare_13.B
			_mn_select_nucleic.links.new(group_22.outputs[0], compare_13.inputs[3])
			#group_22.Backbone Upper -> compare_001_9.B
			_mn_select_nucleic.links.new(group_22.outputs[1], compare_001_9.inputs[3])
			#compare_003_2.Result -> boolean_math_002_10.Boolean
			_mn_select_nucleic.links.new(compare_003_2.outputs[0], boolean_math_002_10.inputs[1])
			#compare_002_3.Result -> boolean_math_002_10.Boolean
			_mn_select_nucleic.links.new(compare_002_3.outputs[0], boolean_math_002_10.inputs[0])
			#group_22.Side Chain Lower -> compare_002_3.B
			_mn_select_nucleic.links.new(group_22.outputs[2], compare_002_3.inputs[3])
			#group_22.Side Chain Upper -> compare_003_2.B
			_mn_select_nucleic.links.new(group_22.outputs[3], compare_003_2.inputs[3])
			#boolean_math_002_10.Boolean -> group_output_68.Is Side Chain
			_mn_select_nucleic.links.new(boolean_math_002_10.outputs[0], group_output_68.inputs[1])
			#named_attribute_8.Attribute -> compare_002_3.A
			_mn_select_nucleic.links.new(named_attribute_8.outputs[0], compare_002_3.inputs[2])
			#named_attribute_8.Attribute -> compare_003_2.A
			_mn_select_nucleic.links.new(named_attribute_8.outputs[0], compare_003_2.inputs[2])
			#compare_005_1.Result -> boolean_math_003_11.Boolean
			_mn_select_nucleic.links.new(compare_005_1.outputs[0], boolean_math_003_11.inputs[1])
			#compare_004_1.Result -> boolean_math_003_11.Boolean
			_mn_select_nucleic.links.new(compare_004_1.outputs[0], boolean_math_003_11.inputs[0])
			#group_22.Backbone Lower -> compare_004_1.B
			_mn_select_nucleic.links.new(group_22.outputs[0], compare_004_1.inputs[3])
			...
			#group_22.Side Chain Upper -> compare_005_1.B
			_mn_select_nucleic.links.new(group_22.outputs[3], compare_005_1.inputs[3])
			...
			#boolean_math_003_11.Boolean -> group_output_68.Is Nucleic
			_mn_select_nucleic.links.new(boolean_math_003_11.outputs[0], group_output_68.inputs[2])
		...
		def is_nucleic_node_group():
			...
			#Socket Selection
			selection_socket_9 = is_nucleic.interface.new_socket(name = "Selection", in_out='OUTPUT', socket_type = 'NodeSocketBool')
			selection_socket_9.default_value = False
			selection_socket_9.attribute_domain = 'POINT'
			selection_socket_9.description = "True if atoms are part of a nucleic acid"
			
			#Socket Inverted
			inverted_socket_6 = is_nucleic.interface.new_socket(name = "Inverted", in_out='OUTPUT', socket_type = 'NodeSocketBool')
			inverted_socket_6.default_value = False
			inverted_socket_6.attribute_domain = 'POINT'
			
			#Socket And
			and_socket_7 = is_nucleic.interface.new_socket(name = "And", in_out='INPUT', socket_type = 'NodeSocketBool')
			and_socket_7.default_value = True
			and_socket_7.attribute_domain = 'POINT'
			and_socket_7.hide_value = True
			
			#Socket Or
			or_socket_6 = is_nucleic.interface.new_socket(name = "Or", in_out='INPUT', socket_type = 'NodeSocketBool')
			...
			#node Group Input
			group_input_67 = is_nucleic.nodes.new("NodeGroupInput")
			group_input_67.name = "Group Input"
			
			#node Boolean Math.001
			boolean_math_001_14 = is_nucleic.nodes.new("FunctionNodeBooleanMath")
			boolean_math_001_14.name = "Boolean Math.001"
			boolean_math_001_14.operation = 'AND'
			
			#node Group Output
			group_output_69 = is_nucleic.nodes.new("NodeGroupOutput")
			group_output_69.name = "Group Output"
			group_output_69.is_active_output = True
			
			#node Group
			group_23 = is_nucleic.nodes.new("GeometryNodeGroup")
			group_23.name = "Group"
			group_23.node_tree = _mn_select_nucleic
			
			#node Group.001
			group_001_15 = is_nucleic.nodes.new("GeometryNodeGroup")
			group_001_15.name = "Group.001"
			group_001_15.node_tree = fallback_boolean
			#Socket_2
			group_001_15.inputs[0].default_value = "is_nucleic"
			
			#node Boolean Math.002
			boolean_math_002_11 = is_nucleic.nodes.new("FunctionNodeBooleanMath")
			boolean_math_002_11.name = "Boolean Math.002"
			boolean_math_002_11.operation = 'OR'
			
			#node Boolean Math
			boolean_math_17 = is_nucleic.nodes.new("FunctionNodeBooleanMath")
			...
			#Set locations
			group_input_67.location = (-280.0, -40.0)
			boolean_math_001_14.location = (-40.0, 0.0)
			group_output_69.location = (320.0000305175781, 0.0)
			group_23.location = (-620.0, -160.0)
			group_001_15.location = (-340.0, -160.0)
			boolean_math_002_11.location = (140.0, 0.0)
			boolean_math_17.location = (140.0, -140.0)
			...
			group_23.width, group_23.height = 247.90924072265625, 100.0
			group_001_15.width, group_001_15.height = 232.0133056640625, 100.0
			...
			#boolean_math_002_11.Boolean -> group_output_69.Selection
			is_nucleic.links.new(boolean_math_002_11.outputs[0], group_output_69.inputs[0])
			#group_input_67.And -> boolean_math_001_14.Boolean
			is_nucleic.links.new(group_input_67.outputs[0], boolean_math_001_14.inputs[0])
			#group_23.Is Nucleic -> group_001_15.Fallback
			is_nucleic.links.new(group_23.outputs[2], group_001_15.inputs[1])
			#group_001_15.Boolean -> boolean_math_001_14.Boolean
			is_nucleic.links.new(group_001_15.outputs[0], boolean_math_001_14.inputs[1])
			#boolean_math_001_14.Boolean -> boolean_math_002_11.Boolean
			is_nucleic.links.new(boolean_math_001_14.outputs[0], boolean_math_002_11.inputs[0])
			#group_input_67.Or -> boolean_math_002_11.Boolean
			is_nucleic.links.new(group_input_67.outputs[1], boolean_math_002_11.inputs[1])
			#boolean_math_002_11.Boolean -> boolean_math_17.Boolean
			is_nucleic.links.new(boolean_math_002_11.outputs[0], boolean_math_17.inputs[0])
			#boolean_math_17.Boolean -> group_output_69.Inverted
			is_nucleic.links.new(boolean_math_17.outputs[0], group_output_69.inputs[1])
			return is_nucleic
		...
		def separate_polymers_node_group():
			...
			#Socket Atoms
			atoms_socket_6 = separate_polymers.interface.new_socket(name = "Atoms", in_out='INPUT', socket_type = 'NodeSocketGeometry')
			...
			#node Group Input
			group_input_68 = separate_polymers.nodes.new("NodeGroupInput")
			group_input_68.name = "Group Input"
			
			#node Group Output
			group_output_70 = separate_polymers.nodes.new("NodeGroupOutput")
			...
			#node Separate Geometry.001
			separate_geometry_001_1 = separate_polymers.nodes.new("GeometryNodeSeparateGeometry")
			separate_geometry_001_1.name = "Separate Geometry.001"
			separate_geometry_001_1.domain = 'POINT'
			
			#node Group
			group_24 = separate_polymers.nodes.new("GeometryNodeGroup")
			group_24.name = "Group"
			group_24.node_tree = is_peptide
			#Socket_1
			group_24.inputs[0].default_value = True
			#Socket_3
			group_24.inputs[1].default_value = False
			
			#node Group.001
			group_001_16 = separate_polymers.nodes.new("GeometryNodeGroup")
			group_001_16.name = "Group.001"
			group_001_16.node_tree = is_nucleic
			#Socket_1
			group_001_16.inputs[0].default_value = True
			#Socket_3
			group_001_16.inputs[1].default_value = False
			
			
			
			
			#Set locations
			group_input_68.location = (-360.0, 220.0)
			group_output_70.location = (260.0, 80.0)
			separate_geometry_2.location = (-200.0, 100.0)
			separate_geometry_001_1.location = (0.0, -40.0)
			group_24.location = (-200.0, -60.0)
			group_001_16.location = (0.0, -200.0)
			...
			#group_input_68.Atoms -> separate_geometry_2.Geometry
			separate_polymers.links.new(group_input_68.outputs[0], separate_geometry_2.inputs[0])
			#separate_geometry_2.Inverted -> separate_geometry_001_1.Geometry
			separate_polymers.links.new(separate_geometry_2.outputs[1], separate_geometry_001_1.inputs[0])
			#separate_geometry_2.Selection -> group_output_70.Peptide
			separate_polymers.links.new(separate_geometry_2.outputs[0], group_output_70.inputs[0])
			#separate_geometry_001_1.Selection -> group_output_70.Nucleic
			separate_polymers.links.new(separate_geometry_001_1.outputs[0], group_output_70.inputs[1])
			#separate_geometry_001_1.Inverted -> group_output_70.Other
			separate_polymers.links.new(separate_geometry_001_1.outputs[1], group_output_70.inputs[2])
			#group_24.Selection -> separate_geometry_2.Selection
			separate_polymers.links.new(group_24.outputs[0], separate_geometry_2.inputs[1])
			#group_001_16.Selection -> separate_geometry_001_1.Selection
			separate_polymers.links.new(group_001_16.outputs[0], separate_geometry_001_1.inputs[1])
		...
		def _sampleatomvalue_node_group():
			...
			#Socket Atoms
			atoms_socket_7 = _sampleatomvalue.interface.new_socket(name = "Atoms", in_out='OUTPUT', socket_type = 'NodeSocketGeometry')
			atoms_socket_7.attribute_domain = 'POINT'
			
			#Socket Value
			value_socket_13 = _sampleatomvalue.interface.new_socket(name = "Value", in_out='OUTPUT', socket_type = 'NodeSocketVector')
			...
			#Socket Value
			value_socket_14 = _sampleatomvalue.interface.new_socket(name = "Value", in_out='OUTPUT', socket_type = 'NodeSocketColor')
			value_socket_14.default_value = (0.0, 0.0, 0.0, 0.0)
			value_socket_14.attribute_domain = 'POINT'
			
			#Socket Geometry
			geometry_socket_10 = _sampleatomvalue.interface.new_socket(name = "Geometry", in_out='INPUT', socket_type = 'NodeSocketGeometry')
			...
			#node Group Output
			group_output_71 = _sampleatomvalue.nodes.new("NodeGroupOutput")
			...
			#node Group Input
			group_input_69 = _sampleatomvalue.nodes.new("NodeGroupInput")
			...
			#node Named Attribute
			named_attribute_9 = _sampleatomvalue.nodes.new("GeometryNodeInputNamedAttribute")
			...
			#Set locations
			group_output_71.location = (390.0, 0.0)
			...
			group_input_69.location = (-170.3642578125, -265.140380859375)
			sample_index_009.location = (200.0, 112.47119140625)
			named_attribute_9.location = (40.0, -380.0)
			...
			#compare_003_3.Result -> separate_geometry_002.Selection
			_sampleatomvalue.links.new(compare_003_3.outputs[0], separate_geometry_002.inputs[1])
			...
			#position_002_1.Position -> sample_index_009.Value
			_sampleatomvalue.links.new(position_002_1.outputs[0], sample_index_009.inputs[1])
			#group_input_69.Geometry -> separate_geometry_002.Geometry
			_sampleatomvalue.links.new(group_input_69.outputs[0], separate_geometry_002.inputs[0])
			#group_input_69.B -> compare_003_3.B
			_sampleatomvalue.links.new(group_input_69.outputs[1], compare_003_3.inputs[3])
			#sample_index_009.Value -> group_output_71.Value
			_sampleatomvalue.links.new(sample_index_009.outputs[0], group_output_71.inputs[1])
			...
			#named_attribute_9.Attribute -> sample_index_010.Value
			_sampleatomvalue.links.new(named_attribute_9.outputs[0], sample_index_010.inputs[1])
			#sample_index_010.Value -> group_output_71.Value
			_sampleatomvalue.links.new(sample_index_010.outputs[0], group_output_71.inputs[2])
			#separate_geometry_002.Selection -> group_output_71.Atoms
			_sampleatomvalue.links.new(separate_geometry_002.outputs[0], group_output_71.inputs[0])
		...
		def mn_select_nucleic_type_node_group():
			...
			#node Group Input
			group_input_70 = mn_select_nucleic_type.nodes.new("NodeGroupInput")
			...
			#node Group Output
			group_output_72 = mn_select_nucleic_type.nodes.new("NodeGroupOutput")
			...
			#Set locations
			group_input_70.location = (-570.0, 0.0)
			...
			group_output_72.location = (580.0, 240.0)
			...
			#boolean_math_007_2.Boolean -> group_output_72.is_pyrimidine
			mn_select_nucleic_type.links.new(boolean_math_007_2.outputs[0], group_output_72.inputs[1])
			...
			#reroute_015.Output -> compare_010_1.A
			mn_select_nucleic_type.links.new(reroute_015.outputs[0], compare_010_1.inputs[2])
			...
			#reroute_015.Output -> compare_009_1.A
			mn_select_nucleic_type.links.new(reroute_015.outputs[0], compare_009_1.inputs[2])
			...
			#boolean_math_008_2.Boolean -> group_output_72.is_purine
			mn_select_nucleic_type.links.new(boolean_math_008_2.outputs[0], group_output_72.inputs[0])
		...
		def _base_align_node_group():
			...
			#node Group Input
			group_input_71 = _base_align.nodes.new("NodeGroupInput")
			group_input_71.name = "Group Input"
			
			#node Group.009
			group_009_7 = _base_align.nodes.new("GeometryNodeGroup")
			group_009_7.name = "Group.009"
			group_009_7.node_tree = _sampleatomvalue
			...
			#node Group Output
			group_output_73 = _base_align.nodes.new("NodeGroupOutput")
			...
			group_input_71.location = (-400.0, 120.0)
			group_009_7.location = (160.0, -200.0)
			...
			group_output_73.location = (700.0, 140.0)
			...
			#reroute_018.Output -> group_010_7.Geometry
			_base_align.links.new(reroute_018.outputs[0], group_010_7.inputs[0])
			#group_009_7.Value -> vector_math_002_5.Vector
			_base_align.links.new(group_009_7.outputs[1], vector_math_002_5.inputs[1])
			...
			#reroute_018.Output -> group_009_7.Geometry
			_base_align.links.new(reroute_018.outputs[0], group_009_7.inputs[0])
			#reroute_020.Output -> reroute_018.Input
			_base_align.links.new(reroute_020.outputs[0], reroute_018.inputs[0])
			#switch_009.Output -> group_009_7.B
			_base_align.links.new(switch_009.outputs[0], group_009_7.inputs[1])
			...
			#group_009_7.Value -> vector_math_004_4.Vector
			_base_align.links.new(group_009_7.outputs[1], vector_math_004_4.inputs[0])
			#group_010_7.Value -> vector_math_002_5.Vector
			_base_align.links.new(group_010_7.outputs[1], vector_math_002_5.inputs[0])
			#group_input_71.Input -> reroute_020.Input
			_base_align.links.new(group_input_71.outputs[0], reroute_020.inputs[0])
			#group_009_7.Value -> group_output_73.Base Interface
			_base_align.links.new(group_009_7.outputs[1], group_output_73.inputs[0])
			#group_008_7.Value -> group_output_73.Base Pivot
			_base_align.links.new(group_008_7.outputs[1], group_output_73.inputs[1])
			#vector_math_004_4.Vector -> group_output_73.Align Vertical
			_base_align.links.new(vector_math_004_4.outputs[0], group_output_73.inputs[2])
			#vector_math_002_5.Vector -> group_output_73.Align Horizontal
			_base_align.links.new(vector_math_002_5.outputs[0], group_output_73.inputs[3])
			return _base_align
		...
		def _mn_utils_style_ribbon_nucleic_node_group():
			...
			#Socket Atoms
			atoms_socket_8 = _mn_utils_style_ribbon_nucleic.interface.new_socket(name = "Atoms", in_out='INPUT', socket_type = 'NodeSocketGeometry')
			atoms_socket_8.attribute_domain = 'POINT'
			atoms_socket_8.description = "Atomic geometry that contains vertices and edges"
			
			#Socket Selection
			selection_socket_10 = _mn_utils_style_ribbon_nucleic.interface.new_socket(name = "Selection", in_out='INPUT', socket_type = 'NodeSocketBool')
			selection_socket_10.default_value = True
			...
			#Socket Material
			material_socket_1 = _mn_utils_style_ribbon_nucleic.interface.new_socket(name = "Material", in_out='INPUT', socket_type = 'NodeSocketMaterial')
			...
			#node Frame
			frame_13 = _mn_utils_style_ribbon_nucleic.nodes.new("NodeFrame")
			frame_13.label = "Delete between chains and distance too large"
			frame_13.name = "Frame"
			frame_13.label_size = 20
			frame_13.shrink = True
			
			#node Frame.001
			frame_001_8 = _mn_utils_style_ribbon_nucleic.nodes.new("NodeFrame")
			frame_001_8.label = "Create New mesh line through all CA"
			...
			#node Sample Index
			sample_index_2 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeSampleIndex")
			...
			#node Named Attribute.002
			named_attribute_002_4 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeInputNamedAttribute")
			named_attribute_002_4.label = "chain_id"
			named_attribute_002_4.name = "Named Attribute.002"
			named_attribute_002_4.hide = True
			named_attribute_002_4.data_type = 'INT'
			#Name
			named_attribute_002_4.inputs[0].default_value = "chain_id"
			...
			#node Named Attribute.004
			named_attribute_004_2 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeInputNamedAttribute")
			named_attribute_004_2.label = "res_id"
			named_attribute_004_2.name = "Named Attribute.004"
			named_attribute_004_2.hide = True
			named_attribute_004_2.data_type = 'INT'
			#Name
			named_attribute_004_2.inputs[0].default_value = "res_id"
			...
			#node Named Attribute
			named_attribute_10 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeInputNamedAttribute")
			named_attribute_10.label = "Color"
			named_attribute_10.name = "Named Attribute"
			named_attribute_10.hide = True
			named_attribute_10.data_type = 'FLOAT_COLOR'
			#Name
			named_attribute_10.inputs[0].default_value = "Color"
			
			#node Reroute.003
			reroute_003_6 = _mn_utils_style_ribbon_nucleic.nodes.new("NodeReroute")
			...
			named_attribute_003_2.label = "res_name"
			named_attribute_003_2.name = "Named Attribute.003"
			named_attribute_003_2.hide = True
			named_attribute_003_2.data_type = 'INT'
			#Name
			named_attribute_003_2.inputs[0].default_value = "res_name"
			...
			#node Reroute.001
			reroute_001_12 = _mn_utils_style_ribbon_nucleic.nodes.new("NodeReroute")
			reroute_001_12.name = "Reroute.001"
			#node Reroute.010
			reroute_010_2 = _mn_utils_style_ribbon_nucleic.nodes.new("NodeReroute")
			...
			#node Reroute.002
			reroute_002_9 = _mn_utils_style_ribbon_nucleic.nodes.new("NodeReroute")
			...
			#node Vector Math
			vector_math_13 = _mn_utils_style_ribbon_nucleic.nodes.new("ShaderNodeVectorMath")
			vector_math_13.name = "Vector Math"
			vector_math_13.operation = 'DISTANCE'
			
			#node Compare.001
			compare_001_10 = _mn_utils_style_ribbon_nucleic.nodes.new("FunctionNodeCompare")
			compare_001_10.name = "Compare.001"
			compare_001_10.data_type = 'FLOAT'
			compare_001_10.mode = 'ELEMENT'
			compare_001_10.operation = 'GREATER_THAN'
			#B
			compare_001_10.inputs[1].default_value = 0.10000000149011612
			
			#node Compare
			compare_14 = _mn_utils_style_ribbon_nucleic.nodes.new("FunctionNodeCompare")
			compare_14.name = "Compare"
			compare_14.data_type = 'INT'
			compare_14.mode = 'ELEMENT'
			compare_14.operation = 'NOT_EQUAL'
			
			#node Boolean Math
			boolean_math_18 = _mn_utils_style_ribbon_nucleic.nodes.new("FunctionNodeBooleanMath")
			boolean_math_18.name = "Boolean Math"
			boolean_math_18.operation = 'OR'
			
			#node Reroute.009
			reroute_009_2 = _mn_utils_style_ribbon_nucleic.nodes.new("NodeReroute")
			...
			#node Set Position
			set_position_4 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeSetPosition")
			...
			#node Group Output
			group_output_74 = _mn_utils_style_ribbon_nucleic.nodes.new("NodeGroupOutput")
			...
			#node Switch
			switch_15 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeSwitch")
			switch_15.name = "Switch"
			switch_15.input_type = 'INT'
			#False
			switch_15.inputs[1].default_value = -1
			#True
			switch_15.inputs[2].default_value = 1
			...
			#Name
			store_named_attribute_001_3.inputs[2].default_value = "chain_id"
			...
			#Name
			store_named_attribute_002_3.inputs[2].default_value = "res_id"
			...
			#Name
			store_named_attribute_003_3.inputs[2].default_value = "res_name"
			
			#node Store Named Attribute.004
			store_named_attribute_004_3 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeStoreNamedAttribute")
			store_named_attribute_004_3.name = "Store Named Attribute.004"
			store_named_attribute_004_3.data_type = 'FLOAT'
			store_named_attribute_004_3.domain = 'POINT'
			#Selection
			store_named_attribute_004_3.inputs[1].default_value = True
			#Name
			store_named_attribute_004_3.inputs[2].default_value = "b_factor"
			
			#node Capture Attribute
			capture_attribute_3 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeCaptureAttribute")
			...
			#node Mesh to Curve
			mesh_to_curve_2 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeMeshToCurve")
			...
			#node Store Named Attribute
			store_named_attribute_5 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeStoreNamedAttribute")
			...
			#node Math
			math_18 = _mn_utils_style_ribbon_nucleic.nodes.new("ShaderNodeMath")
			math_18.name = "Math"
			math_18.operation = 'DIVIDE'
			math_18.use_clamp = False
			#Value_001
			math_18.inputs[1].default_value = 2.0
			...
			#node Position.001
			position_001_5 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeInputPosition")
			position_001_5.name = "Position.001"
			
			#node Store Named Attribute.005
			store_named_attribute_005_3 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeStoreNamedAttribute")
			...
			#node Separate Geometry
			separate_geometry_3 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeSeparateGeometry")
			separate_geometry_3.name = "Separate Geometry"
			separate_geometry_3.domain = 'POINT'
			
			#node Group Input
			group_input_72 = _mn_utils_style_ribbon_nucleic.nodes.new("NodeGroupInput")
			group_input_72.name = "Group Input"
			group_input_72.outputs[3].hide = True
			...
			#node Instance on Points
			instance_on_points_1 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeInstanceOnPoints")
			...
			#node Reroute.007
			reroute_007_2 = _mn_utils_style_ribbon_nucleic.nodes.new("NodeReroute")
			reroute_007_2.name = "Reroute.007"
			#node Curve Circle
			curve_circle_2 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeCurvePrimitiveCircle")
			curve_circle_2.name = "Curve Circle"
			curve_circle_2.hide = True
			...
			#node Curve to Mesh
			curve_to_mesh_3 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeCurveToMesh")
			curve_to_mesh_3.name = "Curve to Mesh"
			#Fill Caps
			curve_to_mesh_3.inputs[2].default_value = True
			
			#node Set Curve Radius
			set_curve_radius_2 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeSetCurveRadius")
			set_curve_radius_2.name = "Set Curve Radius"
			#Selection
			set_curve_radius_2.inputs[1].default_value = True
			
			#node Group Input.002
			group_input_002_2 = _mn_utils_style_ribbon_nucleic.nodes.new("NodeGroupInput")
			...
			#node Join Geometry.001
			join_geometry_001_3 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeJoinGeometry")
			...
			#node Switch.001
			switch_001_5 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeSwitch")
			switch_001_5.name = "Switch.001"
			switch_001_5.input_type = 'GEOMETRY'
			
			#node Group Input.001
			group_input_001_6 = _mn_utils_style_ribbon_nucleic.nodes.new("NodeGroupInput")
			...
			#node Group
			group_25 = _mn_utils_style_ribbon_nucleic.nodes.new("GeometryNodeGroup")
			group_25.name = "Group"
			group_25.node_tree = residue_mask
			#Socket_1
			group_25.inputs[0].default_value = 1
			#Socket_5
			group_25.inputs[1].default_value = True
			#Socket_4
			group_25.inputs[2].default_value = 0
			...
			#node Reroute
			reroute_17 = _mn_utils_style_ribbon_nucleic.nodes.new("NodeReroute")
			...
			#Set parents
			sample_index_2.parent = frame_002_2
			named_attribute_002_4.parent = frame_002_2
			sample_index_004.parent = frame_002_2
			named_attribute_004_2.parent = frame_002_2
			sample_index_001_2.parent = frame_002_2
			named_attribute_10.parent = frame_002_2
			reroute_003_6.parent = frame_002_2
			sample_index_003_1.parent = frame_002_2
			named_attribute_003_2.parent = frame_002_2
			index_003_1.parent = frame_002_2
			named_attribute_005_1.parent = frame_002_2
			sample_index_005.parent = frame_002_2
			reroute_001_12.parent = frame_002_2
			sample_index_008.parent = frame_13
			named_attribute_006.parent = frame_13
			index_004.parent = frame_13
			reroute_002_9.parent = frame_13
			edge_vertices_1.parent = frame_13
			field_at_index.parent = frame_13
			field_at_index_001.parent = frame_13
			vector_math_13.parent = frame_13
			compare_001_10.parent = frame_13
			compare_14.parent = frame_13
			boolean_math_18.parent = frame_13
			mesh_line.parent = frame_001_8
			set_position_4.parent = frame_001_8
			domain_size_2.parent = frame_001_8
			delete_geometry_2.parent = frame_13
			offset_point_in_curve.parent = frame_006_2
			evaluate_at_index_9.parent = frame_006_2
			position_002_2.parent = frame_006_2
			vector_math_002_6.parent = frame_006_2
			vector_math_004_5.parent = frame_006_2
			endpoint_selection_2.parent = frame_006_2
			switch_15.parent = frame_006_2
			endpoint_selection_001_3.parent = frame_006_2
			set_position_001_1.parent = frame_006_2
			set_handle_type_1.parent = frame_004_1
			set_spline_type_1.parent = frame_004_1
			group_input_004_1.parent = frame_004_1
			mesh_to_curve_2.parent = frame_004_1
			set_spline_resolution_2.parent = frame_004_1
			combine_xyz_2.parent = frame_005_1
			math_18.parent = frame_005_1
			...
			position_001_5.parent = frame_007_2
			transform.parent = frame_005_1
			instance_on_points_1.parent = frame_005_1
			...
			named_attribute_007.parent = frame_007_2
			named_attribute_008.parent = frame_007_2
			reroute_004_1.parent = frame_003_2
			set_shade_smooth.parent = frame_003_2
			reroute_007_2.parent = frame_003_2
			...
			group_input_002_2.parent = frame_003_2
			join_geometry_001_3.parent = frame_003_2
			reroute_013_1.parent = frame_003_2
			
			#Set locations
			frame_002_2.location = (1158.6292724609375, -29.90658187866211)
			frame_13.location = (-740.1123657226562, 293.3905944824219)
			frame_001_8.location = (-721.0, 75.0)
			...
			sample_index_2.location = (-660.0, 820.0)
			named_attribute_002_4.location = (-660.0, 780.0)
			sample_index_004.location = (-660.0, 880.0)
			named_attribute_004_2.location = (-660.0, 920.0)
			sample_index_001_2.location = (-664.6292724609375, 689.9065551757812)
			named_attribute_10.location = (-664.6292724609375, 729.9065551757812)
			reroute_003_6.location = (-784.6292724609375, 869.9065551757812)
			sample_index_003_1.location = (-660.0, 980.0)
			named_attribute_003_2.location = (-660.0, 1020.0)
			...
			reroute_001_12.location = (-804.6292724609375, 969.9065551757812)
			reroute_010_2.location = (-6.0, 640.0)
			...
			reroute_002_9.location = (-100.0, -140.0)
			edge_vertices_1.location = (-220.0, -220.0)
			field_at_index.location = (0.0, 0.0)
			field_at_index_001.location = (0.0, -160.0)
			vector_math_13.location = (0.0, -320.0)
			compare_001_10.location = (160.0, -160.0)
			compare_14.location = (160.0, 0.0)
			boolean_math_18.location = (320.0, 0.0)
			reroute_009_2.location = (-1531.0, 160.0)
			reroute_012_1.location = (-1691.0, 640.0)
			mesh_line.location = (-690.0, 385.0)
			set_position_4.location = (-690.0, 345.0)
			...
			group_output_74.location = (4000.0, 540.0)
			...
			switch_15.location = (1580.0, 1060.0)
			endpoint_selection_001_3.location = (1420.0, 1060.0)
			set_position_001_1.location = (2240.0, 1060.0)
			store_named_attribute_001_3.location = (1280.0, 620.0)
			store_named_attribute_002_3.location = (1440.0, 620.0)
			store_named_attribute_003_3.location = (1600.0, 620.0)
			store_named_attribute_004_3.location = (1760.0, 620.0)
			capture_attribute_3.location = (1940.0, 620.0)
			set_handle_type_1.location = (840.0, 260.0)
			set_spline_type_1.location = (670.0, 260.0)
			group_input_004_1.location = (1010.0, 120.0)
			mesh_to_curve_2.location = (510.0, 260.0)
			set_spline_resolution_2.location = (1010.0, 260.0)
			store_named_attribute_5.location = (1120.0, 620.0)
			...
			math_18.location = (114.9571533203125, -1457.4541015625)
			...
			position_001_5.location = (-1639.0, -1617.0)
			store_named_attribute_005_3.location = (540.0, 40.0)
			separate_geometry_3.location = (-2960.0, 0.0)
			group_input_72.location = (-3360.0, -60.0)
			...
			reroute_007_2.location = (2846.0, 400.0)
			curve_circle_2.location = (2546.0, 500.0)
			group_input_003_2.location = (2546.0, 460.0)
			set_material_1.location = (3380.0, 660.0)
			reroute_005_2.location = (3462.0, 231.0)
			reroute_008_1.location = (2862.0, 231.0)
			curve_to_mesh_3.location = (2722.0, 591.0)
			set_curve_radius_2.location = (2162.0, 631.0)
			group_input_002_2.location = (3322.0, 531.0)
			join_geometry_001_3.location = (3122.0, 551.0)
			...
			switch_001_5.location = (3100.0, 860.0)
			group_input_001_6.location = (3100.0, 940.0)
			group_25.location = (-2840.0, 520.0)
			is_nucleic_1.location = (-3180.0, -120.0)
			group_005_8.location = (-2100.0, 480.0)
			reroute_17.location = (-2180.0, 540.0)
			mix_1.location = (-1827.638427734375, 608.8980102539062)
			
			#Set dimensions
			frame_002_2.width, frame_002_2.height = 504.5, 520.0000610351562
			frame_13.width, frame_13.height = 960.0, 734.0
			frame_001_8.width, frame_001_8.height = 200.0, 180.0
			...
			#mesh_line.Mesh -> set_position_4.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(mesh_line.outputs[0], set_position_4.inputs[0])
			...
			#domain_size_2.Point Count -> mesh_line.Count
			_mn_utils_style_ribbon_nucleic.links.new(domain_size_2.outputs[0], mesh_line.inputs[0])
			#set_position_4.Geometry -> delete_geometry_2.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(set_position_4.outputs[0], delete_geometry_2.inputs[0])
			#named_attribute_002_4.Attribute -> sample_index_2.Value
			_mn_utils_style_ribbon_nucleic.links.new(named_attribute_002_4.outputs[0], sample_index_2.inputs[1])
			...
			#reroute_002_9.Output -> field_at_index.Value
			_mn_utils_style_ribbon_nucleic.links.new(reroute_002_9.outputs[0], field_at_index.inputs[1])
			#reroute_002_9.Output -> field_at_index_001.Value
			_mn_utils_style_ribbon_nucleic.links.new(reroute_002_9.outputs[0], field_at_index_001.inputs[1])
			...
			#field_at_index.Value -> compare_14.A
			_mn_utils_style_ribbon_nucleic.links.new(field_at_index.outputs[0], compare_14.inputs[2])
			#field_at_index_001.Value -> compare_14.B
			_mn_utils_style_ribbon_nucleic.links.new(field_at_index_001.outputs[0], compare_14.inputs[3])
			#edge_vertices_1.Position 1 -> vector_math_13.Vector
			_mn_utils_style_ribbon_nucleic.links.new(edge_vertices_1.outputs[2], vector_math_13.inputs[0])
			#edge_vertices_1.Position 2 -> vector_math_13.Vector
			_mn_utils_style_ribbon_nucleic.links.new(edge_vertices_1.outputs[3], vector_math_13.inputs[1])
			#compare_14.Result -> boolean_math_18.Boolean
			_mn_utils_style_ribbon_nucleic.links.new(compare_14.outputs[0], boolean_math_18.inputs[0])
			#boolean_math_18.Boolean -> delete_geometry_2.Selection
			_mn_utils_style_ribbon_nucleic.links.new(boolean_math_18.outputs[0], delete_geometry_2.inputs[1])
			#vector_math_13.Value -> compare_001_10.A
			_mn_utils_style_ribbon_nucleic.links.new(vector_math_13.outputs[1], compare_001_10.inputs[0])
			#compare_001_10.Result -> boolean_math_18.Boolean
			_mn_utils_style_ribbon_nucleic.links.new(compare_001_10.outputs[0], boolean_math_18.inputs[1])
			#store_named_attribute_007.Geometry -> mesh_to_curve_2.Mesh
			_mn_utils_style_ribbon_nucleic.links.new(store_named_attribute_007.outputs[0], mesh_to_curve_2.inputs[0])
			#mesh_to_curve_2.Curve -> set_spline_type_1.Curve
			_mn_utils_style_ribbon_nucleic.links.new(mesh_to_curve_2.outputs[0], set_spline_type_1.inputs[0])
			...
			#curve_circle_2.Curve -> curve_to_mesh_3.Profile Curve
			_mn_utils_style_ribbon_nucleic.links.new(curve_circle_2.outputs[0], curve_to_mesh_3.inputs[1])
			#reroute_001_12.Output -> sample_index_001_2.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(reroute_001_12.outputs[0], sample_index_001_2.inputs[0])
			#named_attribute_10.Attribute -> sample_index_001_2.Value
			_mn_utils_style_ribbon_nucleic.links.new(named_attribute_10.outputs[0], sample_index_001_2.inputs[1])
			#join_geometry_001_3.Geometry -> set_material_1.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(join_geometry_001_3.outputs[0], set_material_1.inputs[0])
			#group_input_002_2.Material -> set_material_1.Material
			_mn_utils_style_ribbon_nucleic.links.new(group_input_002_2.outputs[2], set_material_1.inputs[2])
			...
			#reroute_003_6.Output -> sample_index_001_2.Index
			_mn_utils_style_ribbon_nucleic.links.new(reroute_003_6.outputs[0], sample_index_001_2.inputs[2])
			#set_spline_resolution_2.Geometry -> store_named_attribute_5.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(set_spline_resolution_2.outputs[0], store_named_attribute_5.inputs[0])
			#sample_index_001_2.Value -> store_named_attribute_5.Value
			_mn_utils_style_ribbon_nucleic.links.new(sample_index_001_2.outputs[0], store_named_attribute_5.inputs[3])
			#store_named_attribute_5.Geometry -> store_named_attribute_001_3.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(store_named_attribute_5.outputs[0], store_named_attribute_001_3.inputs[0])
			#store_named_attribute_001_3.Geometry -> store_named_attribute_002_3.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(store_named_attribute_001_3.outputs[0], store_named_attribute_002_3.inputs[0])
			#store_named_attribute_002_3.Geometry -> store_named_attribute_003_3.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(store_named_attribute_002_3.outputs[0], store_named_attribute_003_3.inputs[0])
			#sample_index_2.Value -> store_named_attribute_001_3.Value
			_mn_utils_style_ribbon_nucleic.links.new(sample_index_2.outputs[0], store_named_attribute_001_3.inputs[3])
			#reroute_001_12.Output -> sample_index_003_1.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(reroute_001_12.outputs[0], sample_index_003_1.inputs[0])
			#named_attribute_003_2.Attribute -> sample_index_003_1.Value
			_mn_utils_style_ribbon_nucleic.links.new(named_attribute_003_2.outputs[0], sample_index_003_1.inputs[1])
			#reroute_003_6.Output -> sample_index_003_1.Index
			_mn_utils_style_ribbon_nucleic.links.new(reroute_003_6.outputs[0], sample_index_003_1.inputs[2])
			#sample_index_003_1.Value -> store_named_attribute_003_3.Value
			_mn_utils_style_ribbon_nucleic.links.new(sample_index_003_1.outputs[0], store_named_attribute_003_3.inputs[3])
			#reroute_001_12.Output -> sample_index_004.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(reroute_001_12.outputs[0], sample_index_004.inputs[0])
			#named_attribute_004_2.Attribute -> sample_index_004.Value
			_mn_utils_style_ribbon_nucleic.links.new(named_attribute_004_2.outputs[0], sample_index_004.inputs[1])
			#reroute_003_6.Output -> sample_index_004.Index
			_mn_utils_style_ribbon_nucleic.links.new(reroute_003_6.outputs[0], sample_index_004.inputs[2])
			#sample_index_004.Value -> store_named_attribute_002_3.Value
			_mn_utils_style_ribbon_nucleic.links.new(sample_index_004.outputs[0], store_named_attribute_002_3.inputs[3])
			#reroute_010_2.Output -> reroute_001_12.Input
			_mn_utils_style_ribbon_nucleic.links.new(reroute_010_2.outputs[0], reroute_001_12.inputs[0])
			#index_003_1.Index -> reroute_003_6.Input
			_mn_utils_style_ribbon_nucleic.links.new(index_003_1.outputs[0], reroute_003_6.inputs[0])
			#reroute_003_6.Output -> sample_index_2.Index
			_mn_utils_style_ribbon_nucleic.links.new(reroute_003_6.outputs[0], sample_index_2.inputs[2])
			#store_named_attribute_003_3.Geometry -> store_named_attribute_004_3.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(store_named_attribute_003_3.outputs[0], store_named_attribute_004_3.inputs[0])
			#reroute_001_12.Output -> sample_index_005.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(reroute_001_12.outputs[0], sample_index_005.inputs[0])
			#reroute_003_6.Output -> sample_index_005.Index
			_mn_utils_style_ribbon_nucleic.links.new(reroute_003_6.outputs[0], sample_index_005.inputs[2])
			#named_attribute_005_1.Attribute -> sample_index_005.Value
			_mn_utils_style_ribbon_nucleic.links.new(named_attribute_005_1.outputs[0], sample_index_005.inputs[1])
			#sample_index_005.Value -> store_named_attribute_004_3.Value
			_mn_utils_style_ribbon_nucleic.links.new(sample_index_005.outputs[0], store_named_attribute_004_3.inputs[3])
			#store_named_attribute_004_3.Geometry -> capture_attribute_3.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(store_named_attribute_004_3.outputs[0], capture_attribute_3.inputs[0])
			#capture_attribute_3.Geometry -> set_curve_radius_2.Curve
			_mn_utils_style_ribbon_nucleic.links.new(capture_attribute_3.outputs[0], set_curve_radius_2.inputs[0])
			#reroute_007_2.Output -> set_shade_smooth.Shade Smooth
			_mn_utils_style_ribbon_nucleic.links.new(reroute_007_2.outputs[0], set_shade_smooth.inputs[2])
			#capture_attribute_3.Value -> reroute_004_1.Input
			_mn_utils_style_ribbon_nucleic.links.new(capture_attribute_3.outputs[1], reroute_004_1.inputs[0])
			#reroute_004_1.Output -> reroute_007_2.Input
			_mn_utils_style_ribbon_nucleic.links.new(reroute_004_1.outputs[0], reroute_007_2.inputs[0])
			#reroute_001_12.Output -> sample_index_2.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(reroute_001_12.outputs[0], sample_index_2.inputs[0])
			...
			#reroute_009_2.Output -> sample_index_008.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(reroute_009_2.outputs[0], sample_index_008.inputs[0])
			...
			#sample_index_008.Value -> reroute_002_9.Input
			_mn_utils_style_ribbon_nucleic.links.new(sample_index_008.outputs[0], reroute_002_9.inputs[0])
			#reroute_012_1.Output -> reroute_009_2.Input
			_mn_utils_style_ribbon_nucleic.links.new(reroute_012_1.outputs[0], reroute_009_2.inputs[0])
			#reroute_012_1.Output -> reroute_010_2.Input
			_mn_utils_style_ribbon_nucleic.links.new(reroute_012_1.outputs[0], reroute_010_2.inputs[0])
			#curve_to_mesh_3.Mesh -> set_shade_smooth.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(curve_to_mesh_3.outputs[0], set_shade_smooth.inputs[0])
			#group_003_8.Atoms -> reroute_012_1.Input
			_mn_utils_style_ribbon_nucleic.links.new(group_003_8.outputs[0], reroute_012_1.inputs[0])
			...
			#value_1.Value -> math_18.Value
			_mn_utils_style_ribbon_nucleic.links.new(value_1.outputs[0], math_18.inputs[0])
			#value_1.Value -> cylinder.Depth
			_mn_utils_style_ribbon_nucleic.links.new(value_1.outputs[0], cylinder.inputs[4])
			#math_18.Value -> combine_xyz_2.Z
			_mn_utils_style_ribbon_nucleic.links.new(math_18.outputs[0], combine_xyz_2.inputs[2])
			#align_euler_to_vector_001_1.Rotation -> instance_on_points_1.Rotation
			_mn_utils_style_ribbon_nucleic.links.new(align_euler_to_vector_001_1.outputs[0], instance_on_points_1.inputs[5])
			#combine_xyz_001_2.Vector -> instance_on_points_1.Scale
			_mn_utils_style_ribbon_nucleic.links.new(combine_xyz_001_2.outputs[0], instance_on_points_1.inputs[6])
			#set_material_1.Geometry -> group_output_74.Ribbon + Bases
			_mn_utils_style_ribbon_nucleic.links.new(set_material_1.outputs[0], group_output_74.inputs[0])
			#store_named_attribute_005_3.Geometry -> instance_on_points_1.Points
			_mn_utils_style_ribbon_nucleic.links.new(store_named_attribute_005_3.outputs[0], instance_on_points_1.inputs[0])
			#reroute_013_1.Output -> join_geometry_001_3.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(reroute_013_1.outputs[0], join_geometry_001_3.inputs[0])
			...
			#reroute_005_2.Output -> group_output_74.Ribbon Curve
			_mn_utils_style_ribbon_nucleic.links.new(reroute_005_2.outputs[0], group_output_74.inputs[1])
			#transform.Geometry -> instance_on_points_1.Instance
			_mn_utils_style_ribbon_nucleic.links.new(transform.outputs[0], instance_on_points_1.inputs[2])
			...
			#group_input_72.Atoms -> separate_geometry_3.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(group_input_72.outputs[0], separate_geometry_3.inputs[0])
			#reroute_17.Output -> group_003_8.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(reroute_17.outputs[0], group_003_8.inputs[0])
			#group_004_6.Value -> store_named_attribute_005_3.Value
			_mn_utils_style_ribbon_nucleic.links.new(group_004_6.outputs[2], store_named_attribute_005_3.inputs[3])
			#group_input_003_2.Backbone Resolution -> curve_circle_2.Resolution
			_mn_utils_style_ribbon_nucleic.links.new(group_input_003_2.outputs[5], curve_circle_2.inputs[0])
			#position_001_5.Position -> vector_math_001_6.Vector
			_mn_utils_style_ribbon_nucleic.links.new(position_001_5.outputs[0], vector_math_001_6.inputs[1])
			#set_curve_radius_2.Curve -> set_position_001_1.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(set_curve_radius_2.outputs[0], set_position_001_1.inputs[0])
			#position_002_2.Position -> evaluate_at_index_9.Value
			_mn_utils_style_ribbon_nucleic.links.new(position_002_2.outputs[0], evaluate_at_index_9.inputs[1])
			...
			#position_002_2.Position -> vector_math_002_6.Vector
			_mn_utils_style_ribbon_nucleic.links.new(position_002_2.outputs[0], vector_math_002_6.inputs[1])
			...
			#endpoint_selection_001_3.Selection -> switch_15.Switch
			_mn_utils_style_ribbon_nucleic.links.new(endpoint_selection_001_3.outputs[0], switch_15.inputs[0])
			#switch_15.Output -> offset_point_in_curve.Offset
			_mn_utils_style_ribbon_nucleic.links.new(switch_15.outputs[0], offset_point_in_curve.inputs[1])
			#store_named_attribute_007.Geometry -> store_named_attribute_005_3.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(store_named_attribute_007.outputs[0], store_named_attribute_005_3.inputs[0])
			#group_input_004_1.Backbone Subdivisions -> set_spline_resolution_2.Resolution
			_mn_utils_style_ribbon_nucleic.links.new(group_input_004_1.outputs[4], set_spline_resolution_2.inputs[2])
			#reroute_001_12.Output -> sample_index_009_1.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(reroute_001_12.outputs[0], sample_index_009_1.inputs[0])
			#reroute_003_6.Output -> sample_index_009_1.Index
			_mn_utils_style_ribbon_nucleic.links.new(reroute_003_6.outputs[0], sample_index_009_1.inputs[2])
			#group_input_006_1.Backbone Shade Smooth -> sample_index_009_1.Value
			_mn_utils_style_ribbon_nucleic.links.new(group_input_006_1.outputs[7], sample_index_009_1.inputs[1])
			#sample_index_009_1.Value -> capture_attribute_3.Value
			_mn_utils_style_ribbon_nucleic.links.new(sample_index_009_1.outputs[0], capture_attribute_3.inputs[1])
			#group_input_006_1.Backbone Radius -> sample_index_007.Value
			_mn_utils_style_ribbon_nucleic.links.new(group_input_006_1.outputs[6], sample_index_007.inputs[1])
			#reroute_003_6.Output -> sample_index_007.Index
			_mn_utils_style_ribbon_nucleic.links.new(reroute_003_6.outputs[0], sample_index_007.inputs[2])
			#reroute_001_12.Output -> sample_index_007.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(reroute_001_12.outputs[0], sample_index_007.inputs[0])
			#sample_index_007.Value -> set_curve_radius_2.Radius
			_mn_utils_style_ribbon_nucleic.links.new(sample_index_007.outputs[0], set_curve_radius_2.inputs[2])
			...
			#set_curve_radius_2.Curve -> reroute_008_1.Input
			_mn_utils_style_ribbon_nucleic.links.new(set_curve_radius_2.outputs[0], reroute_008_1.inputs[0])
			...
			#reroute_006_1.Output -> group_006_6.Input
			_mn_utils_style_ribbon_nucleic.links.new(reroute_006_1.outputs[0], group_006_6.inputs[0])
			...
			#named_attribute_008.Attribute -> vector_math_001_6.Vector
			_mn_utils_style_ribbon_nucleic.links.new(named_attribute_008.outputs[0], vector_math_001_6.inputs[0])
			#separate_geometry_3.Selection -> reroute_006_1.Input
			_mn_utils_style_ribbon_nucleic.links.new(separate_geometry_3.outputs[0], reroute_006_1.inputs[0])
			#reroute_011_1.Output -> group_004_6.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(reroute_011_1.outputs[0], group_004_6.inputs[0])
			...
			#named_attribute_007.Attribute -> align_euler_to_vector_001_1.Vector
			_mn_utils_style_ribbon_nucleic.links.new(named_attribute_007.outputs[0], align_euler_to_vector_001_1.inputs[2])
			#set_position_001_1.Geometry -> capture_attribute_001.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(set_position_001_1.outputs[0], capture_attribute_001.inputs[0])
			#index_7.Index -> capture_attribute_001.Value
			_mn_utils_style_ribbon_nucleic.links.new(index_7.outputs[0], capture_attribute_001.inputs[1])
			#capture_attribute_001.Geometry -> curve_to_mesh_3.Curve
			_mn_utils_style_ribbon_nucleic.links.new(capture_attribute_001.outputs[0], curve_to_mesh_3.inputs[0])
			...
			#capture_attribute_001.Value -> sample_index_002_1.Index
			_mn_utils_style_ribbon_nucleic.links.new(capture_attribute_001.outputs[1], sample_index_002_1.inputs[2])
			#capture_attribute_001.Geometry -> sample_index_002_1.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(capture_attribute_001.outputs[0], sample_index_002_1.inputs[0])
			...
			#store_named_attribute_011.Geometry -> switch_001_5.False
			_mn_utils_style_ribbon_nucleic.links.new(store_named_attribute_011.outputs[0], switch_001_5.inputs[1])
			#set_shade_smooth.Geometry -> switch_001_5.True
			_mn_utils_style_ribbon_nucleic.links.new(set_shade_smooth.outputs[0], switch_001_5.inputs[2])
			#switch_001_5.Output -> reroute_013_1.Input
			_mn_utils_style_ribbon_nucleic.links.new(switch_001_5.outputs[0], reroute_013_1.inputs[0])
			#group_input_001_6.Intepolate Color -> switch_001_5.Switch
			_mn_utils_style_ribbon_nucleic.links.new(group_input_001_6.outputs[3], switch_001_5.inputs[0])
			#group_input_72.Selection -> is_nucleic_1.And
			_mn_utils_style_ribbon_nucleic.links.new(group_input_72.outputs[1], is_nucleic_1.inputs[0])
			#is_nucleic_1.Selection -> separate_geometry_3.Selection
			_mn_utils_style_ribbon_nucleic.links.new(is_nucleic_1.outputs[0], separate_geometry_3.inputs[1])
			#reroute_17.Output -> group_005_8.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(reroute_17.outputs[0], group_005_8.inputs[0])
			#separate_geometry_3.Selection -> reroute_17.Input
			_mn_utils_style_ribbon_nucleic.links.new(separate_geometry_3.outputs[0], reroute_17.inputs[0])
			...
			#mix_1.Result -> set_position_4.Position
			_mn_utils_style_ribbon_nucleic.links.new(mix_1.outputs[1], set_position_4.inputs[2])
			#instance_on_points_1.Instances -> join_geometry_001_3.Geometry
			_mn_utils_style_ribbon_nucleic.links.new(instance_on_points_1.outputs[0], join_geometry_001_3.inputs[0])
		...
		def style_cartoon_node_group():
			...
			#Socket Geometry
			geometry_socket_11 = style_cartoon.interface.new_socket(name = "Geometry", in_out='OUTPUT', socket_type = 'NodeSocketGeometry')
			geometry_socket_11.attribute_domain = 'POINT'
			geometry_socket_11.description = "The resulting cartoon geometry, calculated from the given atoms, selection and parameters"
			
			#Socket Atoms
			atoms_socket_9 = style_cartoon.interface.new_socket(name = "Atoms", in_out='INPUT', socket_type = 'NodeSocketGeometry')
			atoms_socket_9.attribute_domain = 'POINT'
			atoms_socket_9.description = "Atomic geometry that contains vertices and edges"
			
			#Socket Selection
			selection_socket_11 = style_cartoon.interface.new_socket(name = "Selection", in_out='INPUT', socket_type = 'NodeSocketBool')
			selection_socket_11.default_value = True
			selection_socket_11.attribute_domain = 'POINT'
			selection_socket_11.hide_value = True
			selection_socket_11.description = "Selection of atoms to apply this style to"
			...
			color_blur_socket.default_value = True
			...
			#Socket Shade Smooth
			shade_smooth_socket_1 = style_cartoon.interface.new_socket(name = "Shade Smooth", in_out='INPUT', socket_type = 'NodeSocketBool', parent = material_panel)
			...
			#Socket Material
			material_socket_2 = style_cartoon.interface.new_socket(name = "Material", in_out='INPUT', socket_type = 'NodeSocketMaterial', parent = material_panel)
			...
			#node Group Output
			group_output_75 = style_cartoon.nodes.new("NodeGroupOutput")
			group_output_75.name = "Group Output"
			group_output_75.is_active_output = True
			
			#node Group Input
			group_input_73 = style_cartoon.nodes.new("NodeGroupInput")
			group_input_73.name = "Group Input"
			group_input_73.outputs[3].hide = True
			...
			#node Math
			math_19 = style_cartoon.nodes.new("ShaderNodeMath")
			math_19.name = "Math"
			math_19.operation = 'MULTIPLY'
			math_19.use_clamp = False
			#Value_001
			math_19.inputs[1].default_value = 3.0
			
			#node Math.002
			math_002_7 = style_cartoon.nodes.new("ShaderNodeMath")
			math_002_7.name = "Math.002"
			math_002_7.operation = 'MULTIPLY'
			math_002_7.use_clamp = False
			#Value_001
			math_002_7.inputs[1].default_value = 3.0
			
			#node Switch
			switch_16 = style_cartoon.nodes.new("GeometryNodeSwitch")
			switch_16.name = "Switch"
			switch_16.input_type = 'INT'
			#False
			switch_16.inputs[1].default_value = 4
			...
			#node Reroute
			reroute_18 = style_cartoon.nodes.new("NodeReroute")
			reroute_18.name = "Reroute"
			#node Store Named Attribute
			store_named_attribute_6 = style_cartoon.nodes.new("GeometryNodeStoreNamedAttribute")
			...
			#node Named Attribute
			named_attribute_11 = style_cartoon.nodes.new("GeometryNodeInputNamedAttribute")
			...
			#node Group
			group_26 = style_cartoon.nodes.new("GeometryNodeGroup")
			group_26.name = "Group"
			group_26.node_tree = topology_dssp
			#Socket_6
			group_26.inputs[1].default_value = True
			
			#node Switch.001
			switch_001_6 = style_cartoon.nodes.new("GeometryNodeSwitch")
			switch_001_6.name = "Switch.001"
			switch_001_6.input_type = 'GEOMETRY'
			
			#node Group Input.001
			group_input_001_7 = style_cartoon.nodes.new("NodeGroupInput")
			...
			#node Frame
			frame_14 = style_cartoon.nodes.new("NodeFrame")
			frame_14.label = "If no sec_struct, assign ribbon to peptide"
			frame_14.name = "Frame"
			frame_14.label_size = 20
			frame_14.shrink = True
			
			#node Frame.001
			frame_001_9 = style_cartoon.nodes.new("NodeFrame")
			frame_001_9.label = "Manually compute sec_struct"
			frame_001_9.name = "Frame.001"
			frame_001_9.label_size = 20
			frame_001_9.shrink = True
			
			#node Reroute.001
			reroute_001_13 = style_cartoon.nodes.new("NodeReroute")
			reroute_001_13.name = "Reroute.001"
			#node Reroute.002
			reroute_002_10 = style_cartoon.nodes.new("NodeReroute")
			...
			#Input_28
			group_068.inputs[8].default_value = 0.1599999964237213
			#Input_29
			group_068.inputs[9].default_value = 4
			
			#node Group Input.002
			group_input_002_3 = style_cartoon.nodes.new("NodeGroupInput")
			...
			#node Reroute.003
			reroute_003_7 = style_cartoon.nodes.new("NodeReroute")
			reroute_003_7.name = "Reroute.003"
			#node Domain Size
			domain_size_3 = style_cartoon.nodes.new("GeometryNodeAttributeDomainSize")
			...
			domain_size_3.outputs[6].hide = True
			
			#node Compare
			compare_15 = style_cartoon.nodes.new("FunctionNodeCompare")
			compare_15.name = "Compare"
			compare_15.data_type = 'INT'
			compare_15.mode = 'ELEMENT'
			compare_15.operation = 'EQUAL'
			#B_INT
			compare_15.inputs[3].default_value = 0
			...
			#node Realize Instances
			realize_instances_2 = style_cartoon.nodes.new("GeometryNodeRealizeInstances")
			...
			#Set parents
			store_named_attribute_6.parent = frame_14
			named_attribute_11.parent = frame_14
			string.parent = frame_14
			boolean_math_19.parent = frame_14
			select_peptide.parent = frame_14
			switch_002_4.parent = frame_14
			group_26.parent = frame_001_9
			switch_001_6.parent = frame_001_9
			group_input_001_7.parent = frame_001_9
			
			#Set locations
			group_output_75.location = (1060.0, 0.0)
			group_input_73.location = (-875.976806640625, 240.0)
			group_067.location = (500.0, 420.0)
			math_19.location = (20.0, -360.0)
			math_002_7.location = (20.0, -20.0)
			switch_16.location = (300.0, 140.0)
			math_001_11.location = (20.0, -200.0)
			reroute_18.location = (-76.95475006103516, -391.92510986328125)
			store_named_attribute_6.location = (-60.0, 640.0)
			named_attribute_11.location = (-380.0, 640.0)
			...
			group_26.location = (240.0, 480.0)
			switch_001_6.location = (240.0, 640.0)
			group_input_001_7.location = (240.0, 720.0)
			frame_14.location = (30.0, 140.0)
			frame_001_9.location = (10.0, 60.0)
			reroute_001_13.location = (-320.0, 380.0)
			reroute_002_10.location = (140.0, 380.0)
			group_001_17.location = (-595.976806640625, 380.0)
			group_068.location = (404.02313232421875, -620.0)
			group_input_002_3.location = (-201.03932189941406, -671.3316650390625)
			join_geometry_1.location = (841.2210693359375, -40.0)
			math_003_6.location = (184.02313232421875, -700.0)
			math_004_2.location = (184.02313232421875, -1020.0)
			math_005_2.location = (184.02313232421875, -860.0)
			reroute_003_7.location = (124.02312469482422, -800.0)
			domain_size_3.location = (580.0, 560.0)
			compare_15.location = (740.0, 560.0)
			switch_003_1.location = (819.6062622070312, 366.8473815917969)
			realize_instances_2.location = (660.0, -620.0)
			
			#Set dimensions
			group_output_75.width, group_output_75.height = 140.0, 100.0
			group_input_73.width, group_input_73.height = 131.2183837890625, 100.0
			...
			group_26.width, group_26.height = 140.0, 100.0
			switch_001_6.width, switch_001_6.height = 140.0, 100.0
			group_input_001_7.width, group_input_001_7.height = 140.0, 100.0
			frame_14.width, frame_14.height = 720.0, 374.0
			frame_001_9.width, frame_001_9.height = 200.0, 430.0
			...
			group_input_002_3.width, group_input_002_3.height = 131.2183837890625, 100.0
			...
			#group_input_73.Selection -> group_067.Selection
			style_cartoon.links.new(group_input_73.outputs[1], group_067.inputs[1])
			#group_input_73.Shade Smooth -> group_067.Shade Smooth
			style_cartoon.links.new(group_input_73.outputs[12], group_067.inputs[2])
			#group_input_73.Color Blur -> group_067.Interpolate Color
			style_cartoon.links.new(group_input_73.outputs[11], group_067.inputs[3])
			#group_input_73.Material -> group_067.Material
			style_cartoon.links.new(group_input_73.outputs[13], group_067.inputs[4])
			#group_input_73.Thickness -> group_067.Sheet Thickness
			style_cartoon.links.new(group_input_73.outputs[7], group_067.inputs[13])
			#group_input_73.Width -> group_067.Sheet Width
			style_cartoon.links.new(group_input_73.outputs[8], group_067.inputs[14])
			#group_input_73.Smoothing -> group_067.Sheet Smoothing
			style_cartoon.links.new(group_input_73.outputs[10], group_067.inputs[15])
			#group_input_73.Loop Radius -> group_067.Loop Radius
			style_cartoon.links.new(group_input_73.outputs[9], group_067.inputs[28])
			#group_input_73.Rounded -> group_067.Arrows Sharp
			style_cartoon.links.new(group_input_73.outputs[6], group_067.inputs[6])
			#group_input_73.Cylinders -> group_067.As Cylinders
			style_cartoon.links.new(group_input_73.outputs[4], group_067.inputs[17])
			#reroute_18.Output -> math_19.Value
			style_cartoon.links.new(reroute_18.outputs[0], math_19.inputs[0])
			#math_19.Value -> group_067.Cylinder Subdivisions
			style_cartoon.links.new(math_19.outputs[0], group_067.inputs[21])
			#math_19.Value -> group_067.Loop Subdivisions
			style_cartoon.links.new(math_19.outputs[0], group_067.inputs[27])
			#math_19.Value -> group_067.Sheet Subdivision
			style_cartoon.links.new(math_19.outputs[0], group_067.inputs[16])
			#math_19.Value -> group_067.Helix Subdivisions
			style_cartoon.links.new(math_19.outputs[0], group_067.inputs[25])
			#group_input_73.Arrows -> group_067.As Arrows
			style_cartoon.links.new(group_input_73.outputs[5], group_067.inputs[5])
			#group_input_73.Quality -> math_002_7.Value
			style_cartoon.links.new(group_input_73.outputs[2], math_002_7.inputs[0])
			#group_input_73.Rounded -> switch_16.Switch
			style_cartoon.links.new(group_input_73.outputs[6], switch_16.inputs[0])
			#math_002_7.Value -> switch_16.True
			style_cartoon.links.new(math_002_7.outputs[0], switch_16.inputs[2])
			#switch_16.Output -> group_067.Profile Resolution
			style_cartoon.links.new(switch_16.outputs[0], group_067.inputs[11])
			#group_input_73.Width -> group_067.Helix Width
			style_cartoon.links.new(group_input_73.outputs[8], group_067.inputs[24])
			#group_input_73.Thickness -> group_067.Helix Thickness
			style_cartoon.links.new(group_input_73.outputs[7], group_067.inputs[23])
			#math_002_7.Value -> group_067.Loop Resolution
			style_cartoon.links.new(math_002_7.outputs[0], group_067.inputs[29])
			#group_input_73.Width -> group_067.Cylinder Radius
			style_cartoon.links.new(group_input_73.outputs[8], group_067.inputs[19])
			#reroute_18.Output -> math_001_11.Value
			style_cartoon.links.new(reroute_18.outputs[0], math_001_11.inputs[0])
			#group_input_73.Quality -> reroute_18.Input
			style_cartoon.links.new(group_input_73.outputs[2], reroute_18.inputs[0])
			#math_001_11.Value -> group_067.Cylinder Resolution
			style_cartoon.links.new(math_001_11.outputs[0], group_067.inputs[20])
			#reroute_001_13.Output -> store_named_attribute_6.Geometry
			style_cartoon.links.new(reroute_001_13.outputs[0], store_named_attribute_6.inputs[0])
			#string.String -> named_attribute_11.Name
			style_cartoon.links.new(string.outputs[0], named_attribute_11.inputs[0])
			#string.String -> store_named_attribute_6.Name
			style_cartoon.links.new(string.outputs[0], store_named_attribute_6.inputs[2])
			#named_attribute_11.Exists -> boolean_math_19.Boolean
			style_cartoon.links.new(named_attribute_11.outputs[1], boolean_math_19.inputs[0])
			#boolean_math_19.Boolean -> store_named_attribute_6.Selection
			style_cartoon.links.new(boolean_math_19.outputs[0], store_named_attribute_6.inputs[1])
			#select_peptide.Selection -> switch_002_4.Switch
			style_cartoon.links.new(select_peptide.outputs[0], switch_002_4.inputs[0])
			#switch_002_4.Output -> store_named_attribute_6.Value
			style_cartoon.links.new(switch_002_4.outputs[0], store_named_attribute_6.inputs[3])
			#reroute_002_10.Output -> group_26.Atoms
			style_cartoon.links.new(reroute_002_10.outputs[0], group_26.inputs[0])
			#group_26.Atoms -> switch_001_6.True
			style_cartoon.links.new(group_26.outputs[0], switch_001_6.inputs[2])
			#store_named_attribute_6.Geometry -> switch_001_6.False
			style_cartoon.links.new(store_named_attribute_6.outputs[0], switch_001_6.inputs[1])
			#switch_001_6.Output -> group_067.Atoms
			style_cartoon.links.new(switch_001_6.outputs[0], group_067.inputs[0])
			#group_input_001_7.DSSP -> switch_001_6.Switch
			style_cartoon.links.new(group_input_001_7.outputs[3], switch_001_6.inputs[0])
			#group_001_17.Peptide -> reroute_001_13.Input
			style_cartoon.links.new(group_001_17.outputs[0], reroute_001_13.inputs[0])
			#reroute_001_13.Output -> reroute_002_10.Input
			style_cartoon.links.new(reroute_001_13.outputs[0], reroute_002_10.inputs[0])
			#group_input_73.Atoms -> group_001_17.Atoms
			style_cartoon.links.new(group_input_73.outputs[0], group_001_17.inputs[0])
			#realize_instances_2.Geometry -> join_geometry_1.Geometry
			style_cartoon.links.new(realize_instances_2.outputs[0], join_geometry_1.inputs[0])
			#join_geometry_1.Geometry -> group_output_75.Geometry
			style_cartoon.links.new(join_geometry_1.outputs[0], group_output_75.inputs[0])
			#group_001_17.Nucleic -> group_068.Atoms
			style_cartoon.links.new(group_001_17.outputs[1], group_068.inputs[0])
			#group_input_002_3.Material -> group_068.Material
			style_cartoon.links.new(group_input_002_3.outputs[13], group_068.inputs[2])
			#group_input_002_3.Color Blur -> group_068.Intepolate Color
			style_cartoon.links.new(group_input_002_3.outputs[11], group_068.inputs[3])
			#reroute_003_7.Output -> math_003_6.Value
			style_cartoon.links.new(reroute_003_7.outputs[0], math_003_6.inputs[0])
			#math_003_6.Value -> group_068.Backbone Subdivisions
			style_cartoon.links.new(math_003_6.outputs[0], group_068.inputs[4])
			#reroute_003_7.Output -> math_004_2.Value
			style_cartoon.links.new(reroute_003_7.outputs[0], math_004_2.inputs[0])
			#math_004_2.Value -> group_068.Backbone Resolution
			style_cartoon.links.new(math_004_2.outputs[0], group_068.inputs[5])
			#group_input_002_3.Shade Smooth -> group_068.Backbone Shade Smooth
			style_cartoon.links.new(group_input_002_3.outputs[12], group_068.inputs[7])
			#group_input_002_3.Selection -> group_068.Selection
			style_cartoon.links.new(group_input_002_3.outputs[1], group_068.inputs[1])
			#group_input_002_3.Loop Radius -> math_005_2.Value
			style_cartoon.links.new(group_input_002_3.outputs[9], math_005_2.inputs[0])
			#math_005_2.Value -> group_068.Backbone Radius
			style_cartoon.links.new(math_005_2.outputs[0], group_068.inputs[6])
			#group_input_002_3.Quality -> reroute_003_7.Input
			style_cartoon.links.new(group_input_002_3.outputs[2], reroute_003_7.inputs[0])
			#domain_size_3.Point Count -> compare_15.A
			style_cartoon.links.new(domain_size_3.outputs[0], compare_15.inputs[2])
			#group_067.Cartoon Mesh -> switch_003_1.False
			style_cartoon.links.new(group_067.outputs[0], switch_003_1.inputs[1])
			#compare_15.Result -> switch_003_1.Switch
			style_cartoon.links.new(compare_15.outputs[0], switch_003_1.inputs[0])
			#switch_001_6.Output -> domain_size_3.Geometry
			style_cartoon.links.new(switch_001_6.outputs[0], domain_size_3.inputs[0])
			#group_068.Ribbon + Bases -> realize_instances_2.Geometry
			style_cartoon.links.new(group_068.outputs[0], realize_instances_2.inputs[0])
		...
		mod = obj.modifiers.new(name = "Style Cartoon", type = 'NODES')
		mod.node_group = style_cartoon
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(Style_Cartoon.bl_idname)
