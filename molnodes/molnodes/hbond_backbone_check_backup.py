bl_info = {
	"name" : "HBond Backbone Check_backup",
...
class HBond_Backbone_Check_backup(bpy.types.Operator):
	bl_idname = "node.hbond_backbone_check_backup"
	bl_label = "HBond Backbone Check_backup"
	...
	def execute(self, context):
		...
		def hbond_backbone_check_backup_node_group():
			...
			#Socket Is Bonded
			is_bonded_socket_1 = hbond_backbone_check_backup.interface.new_socket(name = "Is Bonded", in_out='OUTPUT', socket_type = 'NodeSocketBool')
			is_bonded_socket_1.attribute_domain = 'POINT'
			
			#Socket Bond Energy
			bond_energy_socket_1 = hbond_backbone_check_backup.interface.new_socket(name = "Bond Energy", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
			...
			#Socket H->O
			h__o_socket = hbond_backbone_check_backup.interface.new_socket(name = "H->O", in_out='OUTPUT', socket_type = 'NodeSocketVector')
			...
			#Panel CO
			co_panel = hbond_backbone_check_backup.interface.new_panel("CO")
			#Socket CO Index
			co_index_socket = hbond_backbone_check_backup.interface.new_socket(name = "CO Index", in_out='INPUT', socket_type = 'NodeSocketInt', parent = co_panel)
			...
			#Socket CO Offset
			co_offset_socket = hbond_backbone_check_backup.interface.new_socket(name = "CO Offset", in_out='INPUT', socket_type = 'NodeSocketInt', parent = co_panel)
			...
			#Panel NH
			nh_panel = hbond_backbone_check_backup.interface.new_panel("NH")
			#Socket NH Index
			nh_index_socket = hbond_backbone_check_backup.interface.new_socket(name = "NH Index", in_out='INPUT', socket_type = 'NodeSocketInt', parent = nh_panel)
			...
			#Socket NH Offset
			nh_offset_socket = hbond_backbone_check_backup.interface.new_socket(name = "NH Offset", in_out='INPUT', socket_type = 'NodeSocketInt', parent = nh_panel)
			...
			#node Group Output
			group_output_8 = hbond_backbone_check_backup.nodes.new("NodeGroupOutput")
			group_output_8.name = "Group Output"
			group_output_8.is_active_output = True
			
			#node Group Input
			group_input_8 = hbond_backbone_check_backup.nodes.new("NodeGroupInput")
			group_input_8.name = "Group Input"
			
			#node Group.008
			group_008_1 = hbond_backbone_check_backup.nodes.new("GeometryNodeGroup")
			group_008_1.name = "Group.008"
			group_008_1.node_tree = hbond_energy
			
			#node Group.009
			group_009_1 = hbond_backbone_check_backup.nodes.new("GeometryNodeGroup")
			...
			#node Evaluate at Index
			evaluate_at_index_2 = hbond_backbone_check_backup.nodes.new("GeometryNodeFieldAtIndex")
			evaluate_at_index_2.name = "Evaluate at Index"
			evaluate_at_index_2.data_type = 'FLOAT_VECTOR'
			evaluate_at_index_2.domain = 'POINT'
			
			#node Evaluate at Index.001
			evaluate_at_index_001_1 = hbond_backbone_check_backup.nodes.new("GeometryNodeFieldAtIndex")
			...
			#node Evaluate at Index.002
			evaluate_at_index_002_1 = hbond_backbone_check_backup.nodes.new("GeometryNodeFieldAtIndex")
			...
			#node Evaluate at Index.003
			evaluate_at_index_003_1 = hbond_backbone_check_backup.nodes.new("GeometryNodeFieldAtIndex")
			...
			#node Math
			math_4 = hbond_backbone_check_backup.nodes.new("ShaderNodeMath")
			math_4.name = "Math"
			math_4.operation = 'ADD'
			math_4.use_clamp = False
			
			#node Math.001
			math_001_1 = hbond_backbone_check_backup.nodes.new("ShaderNodeMath")
			math_001_1.name = "Math.001"
			math_001_1.operation = 'ADD'
			math_001_1.use_clamp = False
			
			#node Math.002
			math_002_2 = hbond_backbone_check_backup.nodes.new("ShaderNodeMath")
			math_002_2.name = "Math.002"
			math_002_2.operation = 'SUBTRACT'
			math_002_2.use_clamp = False
			
			#node Math.003
			math_003_1 = hbond_backbone_check_backup.nodes.new("ShaderNodeMath")
			math_003_1.name = "Math.003"
			math_003_1.operation = 'ABSOLUTE'
			math_003_1.use_clamp = False
			
			#node Compare
			compare_1 = hbond_backbone_check_backup.nodes.new("FunctionNodeCompare")
			...
			#node Integer
			integer = hbond_backbone_check_backup.nodes.new("FunctionNodeInputInt")
			integer.name = "Integer"
			integer.integer = 1
			
			#node Frame
			frame = hbond_backbone_check_backup.nodes.new("NodeFrame")
			...
			#node Switch
			switch_1 = hbond_backbone_check_backup.nodes.new("GeometryNodeSwitch")
			...
			#node Compare.001
			compare_001 = hbond_backbone_check_backup.nodes.new("FunctionNodeCompare")
			...
			#node Vector Math
			vector_math_2 = hbond_backbone_check_backup.nodes.new("ShaderNodeVectorMath")
			vector_math_2.name = "Vector Math"
			vector_math_2.operation = 'LENGTH'
			
			#node Group
			group_3 = hbond_backbone_check_backup.nodes.new("GeometryNodeGroup")
			group_3.name = "Group"
			...
			frame.width, frame.height = 550.0, 285.0
			...
			hbond_backbone_check_backup.links.new(evaluate_at_index_001_1.outputs[0], group_008_1.inputs[3])
			#evaluate_at_index_2.Value -> group_008_1.N
			hbond_backbone_check_backup.links.new(evaluate_at_index_2.outputs[0], group_008_1.inputs[2])
			#evaluate_at_index_002_1.Value -> group_008_1.O
			hbond_backbone_check_backup.links.new(evaluate_at_index_002_1.outputs[0], group_008_1.inputs[0])
			#math_001_1.Value -> evaluate_at_index_001_1.Index
			hbond_backbone_check_backup.links.new(math_001_1.outputs[0], evaluate_at_index_001_1.inputs[0])
			#math_001_1.Value -> evaluate_at_index_2.Index
			hbond_backbone_check_backup.links.new(math_001_1.outputs[0], evaluate_at_index_2.inputs[0])
			#evaluate_at_index_003_1.Value -> group_008_1.C
			hbond_backbone_check_backup.links.new(evaluate_at_index_003_1.outputs[0], group_008_1.inputs[1])
			#group_009_1.NH -> evaluate_at_index_001_1.Value
			hbond_backbone_check_backup.links.new(group_009_1.outputs[4], evaluate_at_index_001_1.inputs[1])
			#group_009_1.N -> evaluate_at_index_2.Value
			hbond_backbone_check_backup.links.new(group_009_1.outputs[3], evaluate_at_index_2.inputs[1])
			#group_008_1.Bond Energy -> group_output_8.Bond Energy
			hbond_backbone_check_backup.links.new(group_008_1.outputs[1], group_output_8.inputs[1])
			#group_008_1.Bond Vector -> group_output_8.H->O
			hbond_backbone_check_backup.links.new(group_008_1.outputs[2], group_output_8.inputs[2])
			#group_009_1.O -> evaluate_at_index_002_1.Value
			hbond_backbone_check_backup.links.new(group_009_1.outputs[0], evaluate_at_index_002_1.inputs[1])
			#group_009_1.C -> evaluate_at_index_003_1.Value
			hbond_backbone_check_backup.links.new(group_009_1.outputs[1], evaluate_at_index_003_1.inputs[1])
			#math_4.Value -> evaluate_at_index_002_1.Index
			hbond_backbone_check_backup.links.new(math_4.outputs[0], evaluate_at_index_002_1.inputs[0])
			#math_4.Value -> evaluate_at_index_003_1.Index
			hbond_backbone_check_backup.links.new(math_4.outputs[0], evaluate_at_index_003_1.inputs[0])
			#group_input_8.CO Index -> math_4.Value
			hbond_backbone_check_backup.links.new(group_input_8.outputs[0], math_4.inputs[0])
			#group_input_8.CO Offset -> math_4.Value
			hbond_backbone_check_backup.links.new(group_input_8.outputs[1], math_4.inputs[1])
			#group_input_8.NH Index -> math_001_1.Value
			hbond_backbone_check_backup.links.new(group_input_8.outputs[2], math_001_1.inputs[0])
			#group_input_8.NH Offset -> math_001_1.Value
			hbond_backbone_check_backup.links.new(group_input_8.outputs[3], math_001_1.inputs[1])
			#math_4.Value -> math_002_2.Value
			hbond_backbone_check_backup.links.new(math_4.outputs[0], math_002_2.inputs[0])
			#math_001_1.Value -> math_002_2.Value
			hbond_backbone_check_backup.links.new(math_001_1.outputs[0], math_002_2.inputs[1])
			#math_002_2.Value -> math_003_1.Value
			hbond_backbone_check_backup.links.new(math_002_2.outputs[0], math_003_1.inputs[0])
			#math_003_1.Value -> compare_1.A
			hbond_backbone_check_backup.links.new(math_003_1.outputs[0], compare_1.inputs[0])
			#integer.Integer -> compare_1.B
			hbond_backbone_check_backup.links.new(integer.outputs[0], compare_1.inputs[1])
			#compare_1.Result -> switch_1.Switch
			hbond_backbone_check_backup.links.new(compare_1.outputs[0], switch_1.inputs[0])
			#group_008_1.Bond Vector -> vector_math_2.Vector
			hbond_backbone_check_backup.links.new(group_008_1.outputs[2], vector_math_2.inputs[0])
			#vector_math_2.Value -> compare_001.A
			hbond_backbone_check_backup.links.new(vector_math_2.outputs[1], compare_001.inputs[0])
			#group_3.Angstrom -> compare_001.B
			hbond_backbone_check_backup.links.new(group_3.outputs[0], compare_001.inputs[1])
			#switch_1.Output -> group_output_8.Is Bonded
			hbond_backbone_check_backup.links.new(switch_1.outputs[0], group_output_8.inputs[0])
			#group_008_1.Is Bonded -> switch_1.True
			hbond_backbone_check_backup.links.new(group_008_1.outputs[0], switch_1.inputs[2])
		...
		mod = obj.modifiers.new(name = "HBond Backbone Check_backup", type = 'NODES')
		mod.node_group = hbond_backbone_check_backup
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(HBond_Backbone_Check_backup.bl_idname)
