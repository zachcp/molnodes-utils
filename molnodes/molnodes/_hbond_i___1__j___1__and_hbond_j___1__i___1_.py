...
class _HBond_i___1__j___1__and_HBond_j___1__i___1_(bpy.types.Operator):
	bl_idname = "node._hbond_i___1__j___1__and_hbond_j___1__i___1_"
	bl_label = ".HBond(i - 1, j + 1) and HBond(j - 1, i + 1)"
	...
	def execute(self, context):
		...
		def _hbond_i___1__j___1__and_hbond_j___1__i___1__node_group():
			...
			#Socket Boolean
			boolean_socket = _hbond_i___1__j___1__and_hbond_j___1__i___1_.interface.new_socket(name = "Boolean", in_out='OUTPUT', socket_type = 'NodeSocketBool')
			boolean_socket.attribute_domain = 'POINT'
			
			#Socket i
			i_socket = _hbond_i___1__j___1__and_hbond_j___1__i___1_.interface.new_socket(name = "i", in_out='INPUT', socket_type = 'NodeSocketInt')
			...
			#Socket j
			j_socket = _hbond_i___1__j___1__and_hbond_j___1__i___1_.interface.new_socket(name = "j", in_out='INPUT', socket_type = 'NodeSocketInt')
			...
			#node Group Output
			group_output_9 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.nodes.new("NodeGroupOutput")
			group_output_9.name = "Group Output"
			group_output_9.is_active_output = True
			
			#node Group Input
			group_input_9 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.nodes.new("NodeGroupInput")
			group_input_9.name = "Group Input"
			
			#node Group.010
			group_010_1 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.nodes.new("GeometryNodeGroup")
			group_010_1.name = "Group.010"
			group_010_1.node_tree = hbond_backbone_check
			#Socket_5
			group_010_1.inputs[1].default_value = -1
			#Socket_6
			group_010_1.inputs[3].default_value = 1
			
			#node Group.011
			group_011 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.nodes.new("GeometryNodeGroup")
			group_011.name = "Group.011"
			group_011.node_tree = hbond_backbone_check
			#Socket_5
			group_011.inputs[1].default_value = -1
			#Socket_6
			group_011.inputs[3].default_value = 1
			
			#node Frame
			frame_1 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.nodes.new("NodeFrame")
			frame_1.label = "Check Backbone O is bonded to an NH"
			frame_1.name = "Frame"
			frame_1.label_size = 20
			frame_1.shrink = True
			
			#node Frame.001
			frame_001 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.nodes.new("NodeFrame")
			...
			boolean_math_003 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.nodes.new("FunctionNodeBooleanMath")
			...
			#Set locations
			group_output_9.location = (625.0, 0.0)
			group_input_9.location = (-394.84100341796875, -236.38262939453125)
			group_010_1.location = (-655.0, 40.0)
			group_011.location = (-640.0, -220.0)
			frame_1.location = (635.0, 20.0)
			frame_001.location = (655.0, 120.0)
			...
			frame_1.width, frame_1.height = 327.0645751953125, 309.0
			...
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_010_1.outputs[0], boolean_math_003.inputs[0])
			#group_011.Is Bonded -> boolean_math_003.Boolean
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_011.outputs[0], boolean_math_003.inputs[1])
			#boolean_math_003.Boolean -> group_output_9.Boolean
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(boolean_math_003.outputs[0], group_output_9.inputs[0])
			#group_input_9.j -> group_010_1.NH Index
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_input_9.outputs[1], group_010_1.inputs[2])
			#group_input_9.j -> group_011.CO Index
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_input_9.outputs[1], group_011.inputs[0])
			#group_input_9.i -> group_010_1.CO Index
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_input_9.outputs[0], group_010_1.inputs[0])
			#group_input_9.i -> group_011.NH Index
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_input_9.outputs[0], group_011.inputs[2])
		...
		mod = obj.modifiers.new(name = ".HBond(i - 1, j + 1) and HBond(j - 1, i + 1)", type = 'NODES')
		mod.node_group = _hbond_i___1__j___1__and_hbond_j___1__i___1_
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(_HBond_i___1__j___1__and_HBond_j___1__i___1_.bl_idname)
