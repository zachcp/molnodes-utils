bl_info = {
	"name" : ".MN_utils_style_ribbon_peptide",
...
class _MN_utils_style_ribbon_peptide(bpy.types.Operator):
	bl_idname = "node._mn_utils_style_ribbon_peptide"
	bl_label = ".MN_utils_style_ribbon_peptide"
	...
	def execute(self, context):
		...
		def _mn_utils_style_ribbon_peptide_node_group():
			...
			#Socket Geometry
			geometry_socket_2 = _mn_utils_style_ribbon_peptide.interface.new_socket(name = "Geometry", in_out='OUTPUT', socket_type = 'NodeSocketGeometry')
			...
			#Socket Atoms
			atoms_socket_3 = _mn_utils_style_ribbon_peptide.interface.new_socket(name = "Atoms", in_out='INPUT', socket_type = 'NodeSocketGeometry')
			atoms_socket_3.attribute_domain = 'POINT'
			atoms_socket_3.description = "Atomic geometry that contains vertices and edges"
			
			#Socket Selection
			selection_socket_6 = _mn_utils_style_ribbon_peptide.interface.new_socket(name = "Selection", in_out='INPUT', socket_type = 'NodeSocketBool')
			...
			#Socket Material
			material_socket = _mn_utils_style_ribbon_peptide.interface.new_socket(name = "Material", in_out='INPUT', socket_type = 'NodeSocketMaterial')
			...
			#node Frame.003
			frame_003 = _mn_utils_style_ribbon_peptide.nodes.new("NodeFrame")
			...
			#node Frame
			frame_3 = _mn_utils_style_ribbon_peptide.nodes.new("NodeFrame")
			frame_3.label = "Calculate UVs"
			frame_3.name = "Frame"
			frame_3.label_size = 20
			frame_3.shrink = True
			
			#node Boolean Math.001
			boolean_math_001_6 = _mn_utils_style_ribbon_peptide.nodes.new("FunctionNodeBooleanMath")
			...
			#node Group Input.001
			group_input_001_1 = _mn_utils_style_ribbon_peptide.nodes.new("NodeGroupInput")
			...
			#node Set Material
			set_material = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeSetMaterial")
			set_material.name = "Set Material"
			#Selection
			set_material.inputs[1].default_value = True
			
			#node Group Input.002
			group_input_002 = _mn_utils_style_ribbon_peptide.nodes.new("NodeGroupInput")
			...
			sample_index_007 = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeSampleIndex")
			sample_index_007.name = "Sample Index.007"
			sample_index_007.clamp = True
			sample_index_007.data_type = 'BOOLEAN'
			sample_index_007.domain = 'POINT'
			
			#node Reroute
			reroute_3 = _mn_utils_style_ribbon_peptide.nodes.new("NodeReroute")
			reroute_3.name = "Reroute"
			#node Group Output
			group_output_23 = _mn_utils_style_ribbon_peptide.nodes.new("NodeGroupOutput")
			group_output_23.name = "Group Output"
			group_output_23.is_active_output = True
			
			#node Group Input
			group_input_23 = _mn_utils_style_ribbon_peptide.nodes.new("NodeGroupInput")
			group_input_23.name = "Group Input"
			group_input_23.outputs[2].hide = True
			group_input_23.outputs[3].hide = True
			group_input_23.outputs[5].hide = True
			group_input_23.outputs[6].hide = True
			group_input_23.outputs[7].hide = True
			group_input_23.outputs[8].hide = True
			
			#node Separate Geometry
			separate_geometry_1 = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeSeparateGeometry")
			separate_geometry_1.name = "Separate Geometry"
			separate_geometry_1.domain = 'POINT'
			
			#node Capture Attribute
			capture_attribute_1 = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeCaptureAttribute")
			...
			#node Reroute.005
			reroute_005_1 = _mn_utils_style_ribbon_peptide.nodes.new("NodeReroute")
			...
			#node Curve Circle
			curve_circle = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeCurvePrimitiveCircle")
			...
			capture_attribute_001 = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeCaptureAttribute")
			...
			#node Reroute.003
			reroute_003_2 = _mn_utils_style_ribbon_peptide.nodes.new("NodeReroute")
			...
			#node Reroute.004
			reroute_004 = _mn_utils_style_ribbon_peptide.nodes.new("NodeReroute")
			reroute_004.name = "Reroute.004"
			#node Index.004
			index_004 = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeInputIndex")
			index_004.name = "Index.004"
			
			#node Reroute.001
			reroute_001_4 = _mn_utils_style_ribbon_peptide.nodes.new("NodeReroute")
			...
			set_shade_smooth = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeSetShadeSmooth")
			...
			#node Math
			math_3 = _mn_utils_style_ribbon_peptide.nodes.new("ShaderNodeMath")
			math_3.name = "Math"
			math_3.operation = 'WRAP'
			math_3.use_clamp = False
			#Value_001
			math_3.inputs[1].default_value = 1.0
			#Value_002
			math_3.inputs[2].default_value = 0.0
			
			#node Combine XYZ
			combine_xyz = _mn_utils_style_ribbon_peptide.nodes.new("ShaderNodeCombineXYZ")
			combine_xyz.name = "Combine XYZ"
			#Z
			combine_xyz.inputs[2].default_value = 0.0
			
			#node Switch
			switch_4 = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeSwitch")
			switch_4.name = "Switch"
			switch_4.input_type = 'FLOAT'
			#True
			switch_4.inputs[2].default_value = 1.0
			...
			#node Compare.004
			compare_004_1 = _mn_utils_style_ribbon_peptide.nodes.new("FunctionNodeCompare")
			compare_004_1.label = "x == 0"
			...
			#node Compare.005
			compare_005_1 = _mn_utils_style_ribbon_peptide.nodes.new("FunctionNodeCompare")
			compare_005_1.name = "Compare.005"
			compare_005_1.data_type = 'INT'
			compare_005_1.mode = 'ELEMENT'
			compare_005_1.operation = 'GREATER_THAN'
			#B_INT
			compare_005_1.inputs[3].default_value = 1
			
			#node Reroute.002
			reroute_002_4 = _mn_utils_style_ribbon_peptide.nodes.new("NodeReroute")
			...
			#node Index
			index_3 = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeInputIndex")
			index_3.name = "Index"
			
			#node Group Input.004
			group_input_004 = _mn_utils_style_ribbon_peptide.nodes.new("NodeGroupInput")
			...
			#node Integer
			integer_2 = _mn_utils_style_ribbon_peptide.nodes.new("FunctionNodeInputInt")
			integer_2.name = "Integer"
			integer_2.integer = 2
			
			#node Integer.001
			integer_001_1 = _mn_utils_style_ribbon_peptide.nodes.new("FunctionNodeInputInt")
			integer_001_1.name = "Integer.001"
			integer_001_1.integer = 3
			...
			#node Reroute.006
			reroute_006 = _mn_utils_style_ribbon_peptide.nodes.new("NodeReroute")
			...
			#node Store Named Attribute
			store_named_attribute_1 = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeStoreNamedAttribute")
			...
			set_curve_radius = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeSetCurveRadius")
			...
			named_attribute_003 = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeInputNamedAttribute")
			named_attribute_003.name = "Named Attribute.003"
			named_attribute_003.data_type = 'INT'
			#Name
			named_attribute_003.inputs[0].default_value = "idx"
			
			#node Named Attribute.002
			named_attribute_002_2 = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeInputNamedAttribute")
			named_attribute_002_2.name = "Named Attribute.002"
			named_attribute_002_2.data_type = 'FLOAT_COLOR'
			#Name
			named_attribute_002_2.inputs[0].default_value = "Color"
			
			#node Reroute.007
			reroute_007 = _mn_utils_style_ribbon_peptide.nodes.new("NodeReroute")
			reroute_007.name = "Reroute.007"
			#node Sample Index
			sample_index = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeSampleIndex")
			...
			#node Curve to Mesh
			curve_to_mesh_1 = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeCurveToMesh")
			curve_to_mesh_1.name = "Curve to Mesh"
			#Fill Caps
			curve_to_mesh_1.inputs[2].default_value = True
			
			#node Group Input.003
			group_input_003 = _mn_utils_style_ribbon_peptide.nodes.new("NodeGroupInput")
			...
			#node Switch.001
			switch_001_1 = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeSwitch")
			switch_001_1.name = "Switch.001"
			switch_001_1.input_type = 'GEOMETRY'
			
			#node Group.001
			group_001_5 = _mn_utils_style_ribbon_peptide.nodes.new("GeometryNodeGroup")
			group_001_5.name = "Group.001"
			group_001_5.node_tree = _atoms_to_curves
			
			
			
			#Set parents
			capture_attribute_1.parent = frame_003
			sample_index_006.parent = frame_003
			set_spline_type_002.parent = frame_003
			reroute_005_1.parent = frame_003
			capture_attribute_005.parent = frame_003
			curve_circle.parent = frame_003
			capture_attribute_001.parent = frame_003
			...
			index_004.parent = frame_003
			reroute_001_4.parent = frame_003
			set_handle_type_001.parent = frame_003
			set_spline_resolution_001.parent = frame_003
			set_shade_smooth.parent = frame_003
			math_3.parent = frame_3
			combine_xyz.parent = frame_3
			switch_4.parent = frame_3
			evaluate_on_domain_001.parent = frame_3
			compare_004_1.parent = frame_3
			boolean_math_004_2.parent = frame_3
			evaluate_on_domain_003.parent = frame_3
			evaluate_on_domain.parent = frame_3
			compare_005_1.parent = frame_3
			reroute_002_4.parent = frame_3
			evaluate_on_domain_002.parent = frame_3
			evaluate_on_domain_004.parent = frame_3
			group_input_004.parent = frame_003
			integer_2.parent = frame_003
			integer_001_1.parent = frame_003
			math_002.parent = frame_003
			math_001_3.parent = frame_003
			store_named_attribute_1.parent = frame_003
			set_curve_radius.parent = frame_003
			capture_attribute_002.parent = frame_003
			curve_to_mesh_1.parent = frame_003
			
			#Set locations
			frame_003.location = (-3860.39306640625, -98.4256591796875)
			frame_3.location = (650.0, 56.0)
			boolean_math_001_6.location = (-3202.000244140625, 100.0)
			named_attribute_001_2.location = (-3262.000244140625, -40.0)
			group_input_001_1.location = (-3042.000244140625, 40.0)
			set_material.location = (-420.0, 660.0)
			group_input_002.location = (-420.0, 520.0)
			sample_index_007.location = (-2862.000244140625, 340.0)
			reroute_3.location = (-2920.000244140625, 120.0)
			group_output_23.location = (80.0, 660.0)
			group_input_23.location = (-3540.000244140625, 260.0)
			separate_geometry_1.location = (-3202.000244140625, 260.0)
			capture_attribute_1.location = (1169.39306640625, 637.4256591796875)
			...
			reroute_005_1.location = (2820.39306640625, 818.4256591796875)
			capture_attribute_005.location = (2580.39306640625, 518.4256591796875)
			curve_circle.location = (2400.39306640625, 518.4256591796875)
			capture_attribute_001.location = (2740.39306640625, 518.4256591796875)
			spline_parameter_001.location = (2160.39306640625, 598.4256591796875)
			reroute_003_2.location = (2380.39306640625, 218.4256591796875)
			spline_parameter.location = (2740.39306640625, 318.4256591796875)
			reroute_004.location = (2740.39306640625, -21.5743408203125)
			index_004.location = (2580.39306640625, 318.4256591796875)
			reroute_001_4.location = (3080.39306640625, 578.4256591796875)
			...
			set_shade_smooth.location = (3220.39306640625, 758.4256591796875)
			math_3.location = (-505.4921875, 263.67041015625)
			combine_xyz.location = (-340.0, 260.0)
			switch_4.location = (-500.0, 80.0)
			evaluate_on_domain_001.location = (-680.0, 180.0)
			compare_004_1.location = (-680.0, 20.0)
			boolean_math_004_2.location = (-680.0, -20.0)
			evaluate_on_domain_003.location = (-840.0, -100.0)
			evaluate_on_domain.location = (-680.0, -160.0)
			compare_005_1.location = (-840.0, -240.0)
			reroute_002_4.location = (-700.0, -20.0)
			evaluate_on_domain_002.location = (-1000.0, -240.0)
			evaluate_on_domain_004.location = (-180.0, 260.0)
			index_3.location = (-3040.000244140625, -80.0)
			group_input_004.location = (1532.344970703125, 489.52349853515625)
			integer_2.location = (1540.39306640625, 398.4256591796875)
			integer_001_1.location = (1540.39306640625, 298.4256591796875)
			math_002.location = (1760.39306640625, 438.4256591796875)
			math_001_3.location = (1760.39306640625, 598.4256591796875)
			reroute_006.location = (-280.0, 720.0)
			remove_named_attribute.location = (-240.0, 660.0)
			store_named_attribute_1.location = (3000.39306640625, 775.1707763671875)
			set_curve_radius.location = (2340.39306640625, 818.4256591796875)
			capture_attribute_002.location = (2160.39306640625, 818.4256591796875)
			named_attribute_003.location = (-1120.0, 940.0)
			named_attribute_002_2.location = (-1280.0, 940.0)
			reroute_007.location = (-2720.0, 1020.0)
			sample_index.location = (-1120.0, 1160.0)
			curve_to_mesh_1.location = (2780.392822265625, 758.4256591796875)
			group_input_003.location = (-860.0, 940.0)
			switch_001_1.location = (-860.0, 860.0)
			group_001_5.location = (-3322.000244140625, 580.0)
			
			#Set dimensions
			frame_003.width, frame_003.height = 2251.0, 952.0
			frame_3.width, frame_3.height = 1020.0, 722.0
			...
			group_001_5.width, group_001_5.height = 261.9332275390625, 100.0
			
			#initialize _mn_utils_style_ribbon_peptide links
			#set_curve_radius.Curve -> curve_to_mesh_1.Curve
			_mn_utils_style_ribbon_peptide.links.new(set_curve_radius.outputs[0], curve_to_mesh_1.inputs[0])
			#named_attribute_001_2.Attribute -> boolean_math_001_6.Boolean
			_mn_utils_style_ribbon_peptide.links.new(named_attribute_001_2.outputs[0], boolean_math_001_6.inputs[1])
			#boolean_math_001_6.Boolean -> separate_geometry_1.Selection
			_mn_utils_style_ribbon_peptide.links.new(boolean_math_001_6.outputs[0], separate_geometry_1.inputs[1])
			#group_input_23.Selection -> boolean_math_001_6.Boolean
			_mn_utils_style_ribbon_peptide.links.new(group_input_23.outputs[1], boolean_math_001_6.inputs[0])
			#group_input_002.Material -> set_material.Material
			_mn_utils_style_ribbon_peptide.links.new(group_input_002.outputs[7], set_material.inputs[2])
			#group_input_23.Atoms -> separate_geometry_1.Geometry
			_mn_utils_style_ribbon_peptide.links.new(group_input_23.outputs[0], separate_geometry_1.inputs[0])
			#reroute_005_1.Output -> reroute_006.Input
			_mn_utils_style_ribbon_peptide.links.new(reroute_005_1.outputs[0], reroute_006.inputs[0])
			#set_curve_radius.Curve -> reroute_005_1.Input
			_mn_utils_style_ribbon_peptide.links.new(set_curve_radius.outputs[0], reroute_005_1.inputs[0])
			#reroute_3.Output -> sample_index_006.Geometry
			_mn_utils_style_ribbon_peptide.links.new(reroute_3.outputs[0], sample_index_006.inputs[0])
			#sample_index_006.Value -> set_curve_radius.Radius
			_mn_utils_style_ribbon_peptide.links.new(sample_index_006.outputs[0], set_curve_radius.inputs[2])
			#group_input_001_1.Radius -> sample_index_006.Value
			_mn_utils_style_ribbon_peptide.links.new(group_input_001_1.outputs[3], sample_index_006.inputs[1])
			#index_3.Index -> sample_index_006.Index
			_mn_utils_style_ribbon_peptide.links.new(index_3.outputs[0], sample_index_006.inputs[2])
			#reroute_3.Output -> sample_index_007.Geometry
			_mn_utils_style_ribbon_peptide.links.new(reroute_3.outputs[0], sample_index_007.inputs[0])
			#group_input_001_1.Shade Smooth -> sample_index_007.Value
			_mn_utils_style_ribbon_peptide.links.new(group_input_001_1.outputs[6], sample_index_007.inputs[1])
			#sample_index_007.Value -> capture_attribute_1.Value
			_mn_utils_style_ribbon_peptide.links.new(sample_index_007.outputs[0], capture_attribute_1.inputs[1])
			#reroute_001_4.Output -> set_shade_smooth.Shade Smooth
			_mn_utils_style_ribbon_peptide.links.new(reroute_001_4.outputs[0], set_shade_smooth.inputs[2])
			#group_input_23.Selection -> group_001_5.Selection
			_mn_utils_style_ribbon_peptide.links.new(group_input_23.outputs[1], group_001_5.inputs[1])
			#group_input_23.Atoms -> group_001_5.Atoms
			_mn_utils_style_ribbon_peptide.links.new(group_input_23.outputs[0], group_001_5.inputs[0])
			#group_001_5.CA Splines -> capture_attribute_1.Geometry
			_mn_utils_style_ribbon_peptide.links.new(group_001_5.outputs[1], capture_attribute_1.inputs[0])
			#capture_attribute_002.Geometry -> set_curve_radius.Curve
			_mn_utils_style_ribbon_peptide.links.new(capture_attribute_002.outputs[0], set_curve_radius.inputs[0])
			#capture_attribute_1.Geometry -> set_spline_type_002.Curve
			_mn_utils_style_ribbon_peptide.links.new(capture_attribute_1.outputs[0], set_spline_type_002.inputs[0])
			...
			#index_3.Index -> sample_index_007.Index
			_mn_utils_style_ribbon_peptide.links.new(index_3.outputs[0], sample_index_007.inputs[2])
			#separate_geometry_1.Selection -> reroute_3.Input
			_mn_utils_style_ribbon_peptide.links.new(separate_geometry_1.outputs[0], reroute_3.inputs[0])
			#capture_attribute_1.Value -> reroute_001_4.Input
			_mn_utils_style_ribbon_peptide.links.new(capture_attribute_1.outputs[1], reroute_001_4.inputs[0])
			#spline_parameter.Factor -> capture_attribute_001.Value
			_mn_utils_style_ribbon_peptide.links.new(spline_parameter.outputs[0], capture_attribute_001.inputs[1])
			#math_3.Value -> combine_xyz.X
			_mn_utils_style_ribbon_peptide.links.new(math_3.outputs[0], combine_xyz.inputs[0])
			#capture_attribute_001.Geometry -> curve_to_mesh_1.Profile Curve
			_mn_utils_style_ribbon_peptide.links.new(capture_attribute_001.outputs[0], curve_to_mesh_1.inputs[1])
			#curve_circle.Curve -> capture_attribute_005.Geometry
			_mn_utils_style_ribbon_peptide.links.new(curve_circle.outputs[0], capture_attribute_005.inputs[0])
			#capture_attribute_005.Geometry -> capture_attribute_001.Geometry
			_mn_utils_style_ribbon_peptide.links.new(capture_attribute_005.outputs[0], capture_attribute_001.inputs[0])
			#index_004.Index -> capture_attribute_005.Value
			_mn_utils_style_ribbon_peptide.links.new(index_004.outputs[0], capture_attribute_005.inputs[1])
			#reroute_004.Output -> evaluate_on_domain_002.Value
			_mn_utils_style_ribbon_peptide.links.new(reroute_004.outputs[0], evaluate_on_domain_002.inputs[0])
			#evaluate_on_domain_002.Value -> compare_005_1.A
			_mn_utils_style_ribbon_peptide.links.new(evaluate_on_domain_002.outputs[0], compare_005_1.inputs[2])
			#compare_005_1.Result -> evaluate_on_domain_003.Value
			_mn_utils_style_ribbon_peptide.links.new(compare_005_1.outputs[0], evaluate_on_domain_003.inputs[0])
			#evaluate_on_domain.Value -> switch_4.False
			_mn_utils_style_ribbon_peptide.links.new(evaluate_on_domain.outputs[0], switch_4.inputs[1])
			...
			#reroute_002_4.Output -> evaluate_on_domain_001.Value
			_mn_utils_style_ribbon_peptide.links.new(reroute_002_4.outputs[0], evaluate_on_domain_001.inputs[0])
			#evaluate_on_domain_001.Value -> compare_004_1.A
			_mn_utils_style_ribbon_peptide.links.new(evaluate_on_domain_001.outputs[0], compare_004_1.inputs[0])
			#boolean_math_004_2.Boolean -> switch_4.Switch
			_mn_utils_style_ribbon_peptide.links.new(boolean_math_004_2.outputs[0], switch_4.inputs[0])
			#reroute_002_4.Output -> evaluate_on_domain.Value
			_mn_utils_style_ribbon_peptide.links.new(reroute_002_4.outputs[0], evaluate_on_domain.inputs[0])
			#switch_4.Output -> combine_xyz.Y
			_mn_utils_style_ribbon_peptide.links.new(switch_4.outputs[0], combine_xyz.inputs[1])
			...
			_mn_utils_style_ribbon_peptide.links.new(reroute_003_2.outputs[0], math_3.inputs[0])
			#compare_004_1.Result -> boolean_math_004_2.Boolean
			_mn_utils_style_ribbon_peptide.links.new(compare_004_1.outputs[0], boolean_math_004_2.inputs[0])
			...
			#group_input_23.BS Smoothing -> group_001_5.BS Smoothing
			_mn_utils_style_ribbon_peptide.links.new(group_input_23.outputs[4], group_001_5.inputs[2])
			#combine_xyz.Vector -> evaluate_on_domain_004.Value
			_mn_utils_style_ribbon_peptide.links.new(combine_xyz.outputs[0], evaluate_on_domain_004.inputs[0])
			#evaluate_on_domain_004.Value -> group_output_23.UVs
			_mn_utils_style_ribbon_peptide.links.new(evaluate_on_domain_004.outputs[0], group_output_23.inputs[2])
			#capture_attribute_001.Value -> reroute_002_4.Input
			_mn_utils_style_ribbon_peptide.links.new(capture_attribute_001.outputs[1], reroute_002_4.inputs[0])
			#capture_attribute_002.Value -> reroute_003_2.Input
			_mn_utils_style_ribbon_peptide.links.new(capture_attribute_002.outputs[1], reroute_003_2.inputs[0])
			#capture_attribute_005.Value -> reroute_004.Input
			_mn_utils_style_ribbon_peptide.links.new(capture_attribute_005.outputs[1], reroute_004.inputs[0])
			#set_shade_smooth.Geometry -> set_material.Geometry
			_mn_utils_style_ribbon_peptide.links.new(set_shade_smooth.outputs[0], set_material.inputs[0])
			#group_input_004.Quality -> math_001_3.Value
			_mn_utils_style_ribbon_peptide.links.new(group_input_004.outputs[2], math_001_3.inputs[0])
			#integer_2.Integer -> math_001_3.Value
			_mn_utils_style_ribbon_peptide.links.new(integer_2.outputs[0], math_001_3.inputs[1])
			...
			#integer_001_1.Integer -> math_002.Value
			_mn_utils_style_ribbon_peptide.links.new(integer_001_1.outputs[0], math_002.inputs[1])
			#group_input_004.Quality -> math_002.Value
			_mn_utils_style_ribbon_peptide.links.new(group_input_004.outputs[2], math_002.inputs[0])
			#math_002.Value -> curve_circle.Resolution
			_mn_utils_style_ribbon_peptide.links.new(math_002.outputs[0], curve_circle.inputs[0])
			#reroute_006.Output -> group_output_23.Curve
			_mn_utils_style_ribbon_peptide.links.new(reroute_006.outputs[0], group_output_23.inputs[1])
			#set_material.Geometry -> remove_named_attribute.Geometry
			_mn_utils_style_ribbon_peptide.links.new(set_material.outputs[0], remove_named_attribute.inputs[0])
			#remove_named_attribute.Geometry -> group_output_23.Geometry
			_mn_utils_style_ribbon_peptide.links.new(remove_named_attribute.outputs[0], group_output_23.inputs[0])
			#curve_to_mesh_1.Mesh -> store_named_attribute_1.Geometry
			_mn_utils_style_ribbon_peptide.links.new(curve_to_mesh_1.outputs[0], store_named_attribute_1.inputs[0])
			#reroute_007.Output -> sample_index.Geometry
			_mn_utils_style_ribbon_peptide.links.new(reroute_007.outputs[0], sample_index.inputs[0])
			#named_attribute_002_2.Attribute -> sample_index.Value
			_mn_utils_style_ribbon_peptide.links.new(named_attribute_002_2.outputs[0], sample_index.inputs[1])
			#named_attribute_003.Attribute -> sample_index.Index
			_mn_utils_style_ribbon_peptide.links.new(named_attribute_003.outputs[0], sample_index.inputs[2])
			#sample_index.Value -> store_named_attribute_1.Value
			_mn_utils_style_ribbon_peptide.links.new(sample_index.outputs[0], store_named_attribute_1.inputs[3])
			#group_001_5.CA Mesh Line -> reroute_007.Input
			_mn_utils_style_ribbon_peptide.links.new(group_001_5.outputs[0], reroute_007.inputs[0])
			#store_named_attribute_1.Geometry -> switch_001_1.False
			_mn_utils_style_ribbon_peptide.links.new(store_named_attribute_1.outputs[0], switch_001_1.inputs[1])
			#curve_to_mesh_1.Mesh -> switch_001_1.True
			_mn_utils_style_ribbon_peptide.links.new(curve_to_mesh_1.outputs[0], switch_001_1.inputs[2])
			#switch_001_1.Output -> set_shade_smooth.Geometry
			_mn_utils_style_ribbon_peptide.links.new(switch_001_1.outputs[0], set_shade_smooth.inputs[0])
			#group_input_003.Interpolate Color -> switch_001_1.Switch
			_mn_utils_style_ribbon_peptide.links.new(group_input_003.outputs[5], switch_001_1.inputs[0])
		...
		mod = obj.modifiers.new(name = ".MN_utils_style_ribbon_peptide", type = 'NODES')
		mod.node_group = _mn_utils_style_ribbon_peptide
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(_MN_utils_style_ribbon_peptide.bl_idname)
