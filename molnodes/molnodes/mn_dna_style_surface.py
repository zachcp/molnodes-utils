...
class MN_dna_style_surface(bpy.types.Operator):
	bl_idname = "node.mn_dna_style_surface"
	bl_label = "MN_dna_style_surface"
	...
	def execute(self, context):
		...
		def mn_dna_style_surface_node_group():
			mn_dna_style_surface = bpy.data.node_groups.new(type = 'GeometryNodeTree', name = "MN_dna_style_surface")
			...
			#Socket Bases
			bases_socket = mn_dna_style_surface.interface.new_socket(name = "Bases", in_out='OUTPUT', socket_type = 'NodeSocketGeometry')
			bases_socket.attribute_domain = 'POINT'
			
			#Socket Bases
			bases_socket_1 = mn_dna_style_surface.interface.new_socket(name = "Bases", in_out='INPUT', socket_type = 'NodeSocketGeometry')
			bases_socket_1.attribute_domain = 'POINT'
			
			#Socket Selection
			selection_socket_1 = mn_dna_style_surface.interface.new_socket(name = "Selection", in_out='INPUT', socket_type = 'NodeSocketBool')
			...
			#Socket Resolution
			resolution_socket = mn_dna_style_surface.interface.new_socket(name = "Resolution", in_out='INPUT', socket_type = 'NodeSocketInt')
			resolution_socket.default_value = 8
			resolution_socket.min_value = 1
			resolution_socket.max_value = 15
			resolution_socket.subtype = 'NONE'
			resolution_socket.attribute_domain = 'POINT'
			
			#Socket Radius
			radius_socket = mn_dna_style_surface.interface.new_socket(name = "Radius", in_out='INPUT', socket_type = 'NodeSocketFloat')
			radius_socket.default_value = 1.0
			radius_socket.min_value = 0.0
			radius_socket.max_value = 10.0
			radius_socket.subtype = 'NONE'
			radius_socket.attribute_domain = 'POINT'
			
			#Socket Probe Size
			probe_size_socket_2 = mn_dna_style_surface.interface.new_socket(name = "Probe Size", in_out='INPUT', socket_type = 'NodeSocketFloat')
			...
			subdivision_surface_socket = mn_dna_style_surface.interface.new_socket(name = "Subdivision Surface", in_out='INPUT', socket_type = 'NodeSocketInt')
			...
			#Socket Color by CA
			color_by_ca_socket_1 = mn_dna_style_surface.interface.new_socket(name = "Color by CA", in_out='INPUT', socket_type = 'NodeSocketBool')
			color_by_ca_socket_1.default_value = True
			color_by_ca_socket_1.attribute_domain = 'POINT'
			
			#Socket Interpolate Color
			interpolate_color_socket_1 = mn_dna_style_surface.interface.new_socket(name = "Interpolate Color", in_out='INPUT', socket_type = 'NodeSocketInt')
			interpolate_color_socket_1.default_value = 0
			interpolate_color_socket_1.min_value = -2147483648
			interpolate_color_socket_1.max_value = 2147483647
			interpolate_color_socket_1.subtype = 'NONE'
			interpolate_color_socket_1.attribute_domain = 'POINT'
			
			#Socket Shade Smooth
			shade_smooth_socket_1 = mn_dna_style_surface.interface.new_socket(name = "Shade Smooth", in_out='INPUT', socket_type = 'NodeSocketBool')
			...
			#Socket Material
			material_socket_1 = mn_dna_style_surface.interface.new_socket(name = "Material", in_out='INPUT', socket_type = 'NodeSocketMaterial')
			...
			#node Named Attribute.002
			named_attribute_002_1 = mn_dna_style_surface.nodes.new("GeometryNodeInputNamedAttribute")
			...
			#node Compare.001
			compare_001_1 = mn_dna_style_surface.nodes.new("FunctionNodeCompare")
			compare_001_1.name = "Compare.001"
			compare_001_1.data_type = 'INT'
			compare_001_1.mode = 'ELEMENT'
			compare_001_1.operation = 'EQUAL'
			#B_INT
			compare_001_1.inputs[3].default_value = 30
			
			#node Separate Geometry.001
			separate_geometry_001_1 = mn_dna_style_surface.nodes.new("GeometryNodeSeparateGeometry")
			separate_geometry_001_1.name = "Separate Geometry.001"
			separate_geometry_001_1.domain = 'POINT'
			
			#node Compare.002
			compare_002 = mn_dna_style_surface.nodes.new("FunctionNodeCompare")
			...
			#node Compare.003
			compare_003_1 = mn_dna_style_surface.nodes.new("FunctionNodeCompare")
			...
			#node Compare.004
			compare_004 = mn_dna_style_surface.nodes.new("FunctionNodeCompare")
			...
			realize_instances = mn_dna_style_surface.nodes.new("GeometryNodeRealizeInstances")
			...
			separate_geometry_002 = mn_dna_style_surface.nodes.new("GeometryNodeSeparateGeometry")
			separate_geometry_002.name = "Separate Geometry.002"
			separate_geometry_002.domain = 'POINT'
			
			#node Group Input
			group_input_6 = mn_dna_style_surface.nodes.new("NodeGroupInput")
			group_input_6.name = "Group Input"
			
			#node Separate Geometry.003
			separate_geometry_003 = mn_dna_style_surface.nodes.new("GeometryNodeSeparateGeometry")
			separate_geometry_003.name = "Separate Geometry.003"
			separate_geometry_003.domain = 'POINT'
			
			#node Separate Geometry.004
			separate_geometry_004 = mn_dna_style_surface.nodes.new("GeometryNodeSeparateGeometry")
			separate_geometry_004.name = "Separate Geometry.004"
			separate_geometry_004.domain = 'POINT'
			
			#node Group
			group = mn_dna_style_surface.nodes.new("GeometryNodeGroup")
			group.name = "Group"
			group.node_tree = _mn_utils_style_surface_old
			
			#node Group.001
			group_001_1 = mn_dna_style_surface.nodes.new("GeometryNodeGroup")
			group_001_1.name = "Group.001"
			group_001_1.node_tree = _mn_utils_style_surface_old
			
			#node Group.002
			group_002_1 = mn_dna_style_surface.nodes.new("GeometryNodeGroup")
			group_002_1.name = "Group.002"
			group_002_1.node_tree = _mn_utils_style_surface_old
			
			#node Group.003
			group_003_1 = mn_dna_style_surface.nodes.new("GeometryNodeGroup")
			group_003_1.name = "Group.003"
			group_003_1.node_tree = _mn_utils_style_surface_old
			
			#node Geometry to Instance
			geometry_to_instance = mn_dna_style_surface.nodes.new("GeometryNodeGeometryToInstance")
			geometry_to_instance.name = "Geometry to Instance"
			
			#node Group Output
			group_output_6 = mn_dna_style_surface.nodes.new("NodeGroupOutput")
			...
			#Set locations
			named_attribute_002_1.location = (-271.8153076171875, 270.0)
			compare_001_1.location = (-73.56605529785156, 281.95001220703125)
			separate_geometry_001_1.location = (108.18467712402344, 290.0)
			compare_002.location = (-60.0, -200.0)
			compare_003_1.location = (-60.0, -620.0)
			compare_004.location = (-60.0, -1040.0)
			realize_instances.location = (-280.0, 120.0)
			separate_geometry_002.location = (120.0, -180.0)
			group_input_6.location = (-508.1846923828125, -0.0)
			separate_geometry_003.location = (120.0, -600.0)
			separate_geometry_004.location = (120.0, -1020.0)
			group.location = (440.0, 220.0)
			group_001_1.location = (440.0, -120.0)
			group_002_1.location = (440.0, -460.0)
			group_003_1.location = (440.0, -800.0)
			geometry_to_instance.location = (1000.0, -320.0)
			group_output_6.location = (1240.0, -300.0)
			...
			group.width, group.height = 282.4818115234375, 100.0
			group_001_1.width, group_001_1.height = 282.4818115234375, 100.0
			group_002_1.width, group_002_1.height = 282.4818115234375, 100.0
			group_003_1.width, group_003_1.height = 282.4818115234375, 100.0
			...
			#group_input_6.Bases -> realize_instances.Geometry
			mn_dna_style_surface.links.new(group_input_6.outputs[0], realize_instances.inputs[0])
			#realize_instances.Geometry -> separate_geometry_001_1.Geometry
			mn_dna_style_surface.links.new(realize_instances.outputs[0], separate_geometry_001_1.inputs[0])
			#compare_001_1.Result -> separate_geometry_001_1.Selection
			mn_dna_style_surface.links.new(compare_001_1.outputs[0], separate_geometry_001_1.inputs[1])
			#named_attribute_002_1.Attribute -> compare_001_1.A
			mn_dna_style_surface.links.new(named_attribute_002_1.outputs[0], compare_001_1.inputs[2])
			#realize_instances.Geometry -> separate_geometry_002.Geometry
			mn_dna_style_surface.links.new(realize_instances.outputs[0], separate_geometry_002.inputs[0])
			#compare_002.Result -> separate_geometry_002.Selection
			mn_dna_style_surface.links.new(compare_002.outputs[0], separate_geometry_002.inputs[1])
			#named_attribute_002_1.Attribute -> compare_002.A
			mn_dna_style_surface.links.new(named_attribute_002_1.outputs[0], compare_002.inputs[2])
			#realize_instances.Geometry -> separate_geometry_003.Geometry
			mn_dna_style_surface.links.new(realize_instances.outputs[0], separate_geometry_003.inputs[0])
			#compare_003_1.Result -> separate_geometry_003.Selection
			mn_dna_style_surface.links.new(compare_003_1.outputs[0], separate_geometry_003.inputs[1])
			#named_attribute_002_1.Attribute -> compare_003_1.A
			mn_dna_style_surface.links.new(named_attribute_002_1.outputs[0], compare_003_1.inputs[2])
			#realize_instances.Geometry -> separate_geometry_004.Geometry
			mn_dna_style_surface.links.new(realize_instances.outputs[0], separate_geometry_004.inputs[0])
			#compare_004.Result -> separate_geometry_004.Selection
			mn_dna_style_surface.links.new(compare_004.outputs[0], separate_geometry_004.inputs[1])
			#named_attribute_002_1.Attribute -> compare_004.A
			mn_dna_style_surface.links.new(named_attribute_002_1.outputs[0], compare_004.inputs[2])
			#geometry_to_instance.Instances -> group_output_6.Bases
			mn_dna_style_surface.links.new(geometry_to_instance.outputs[0], group_output_6.inputs[0])
			#separate_geometry_001_1.Selection -> group.Atoms
			mn_dna_style_surface.links.new(separate_geometry_001_1.outputs[0], group.inputs[0])
			#group_input_6.Selection -> group.Selection
			mn_dna_style_surface.links.new(group_input_6.outputs[1], group.inputs[1])
			#group_input_6.Resolution -> group.Quality
			mn_dna_style_surface.links.new(group_input_6.outputs[2], group.inputs[2])
			#group_input_6.Radius -> group.Scale Radii
			mn_dna_style_surface.links.new(group_input_6.outputs[3], group.inputs[3])
			#group_input_6.Subdivision Surface -> group.Surface Smoothing
			mn_dna_style_surface.links.new(group_input_6.outputs[5], group.inputs[5])
			#group_input_6.Shade Smooth -> group.Shade Smooth
			mn_dna_style_surface.links.new(group_input_6.outputs[8], group.inputs[8])
			#group_input_6.Color by CA -> group.Color by CA
			mn_dna_style_surface.links.new(group_input_6.outputs[6], group.inputs[6])
			#group_input_6.Material -> group.Material
			mn_dna_style_surface.links.new(group_input_6.outputs[9], group.inputs[9])
			#group_003_1.Geometry -> geometry_to_instance.Geometry
			mn_dna_style_surface.links.new(group_003_1.outputs[0], geometry_to_instance.inputs[0])
			#group_input_6.Interpolate Color -> group.Interpolate Color
			mn_dna_style_surface.links.new(group_input_6.outputs[7], group.inputs[7])
			#group_input_6.Probe Size -> group.Probe Size
			mn_dna_style_surface.links.new(group_input_6.outputs[4], group.inputs[4])
			#group_input_6.Selection -> group_001_1.Selection
			mn_dna_style_surface.links.new(group_input_6.outputs[1], group_001_1.inputs[1])
			#group_input_6.Resolution -> group_001_1.Quality
			mn_dna_style_surface.links.new(group_input_6.outputs[2], group_001_1.inputs[2])
			#group_input_6.Radius -> group_001_1.Scale Radii
			mn_dna_style_surface.links.new(group_input_6.outputs[3], group_001_1.inputs[3])
			#group_input_6.Subdivision Surface -> group_001_1.Surface Smoothing
			mn_dna_style_surface.links.new(group_input_6.outputs[5], group_001_1.inputs[5])
			#group_input_6.Shade Smooth -> group_001_1.Shade Smooth
			mn_dna_style_surface.links.new(group_input_6.outputs[8], group_001_1.inputs[8])
			#group_input_6.Color by CA -> group_001_1.Color by CA
			mn_dna_style_surface.links.new(group_input_6.outputs[6], group_001_1.inputs[6])
			#group_input_6.Material -> group_001_1.Material
			mn_dna_style_surface.links.new(group_input_6.outputs[9], group_001_1.inputs[9])
			#group_input_6.Interpolate Color -> group_001_1.Interpolate Color
			mn_dna_style_surface.links.new(group_input_6.outputs[7], group_001_1.inputs[7])
			#group_input_6.Probe Size -> group_001_1.Probe Size
			mn_dna_style_surface.links.new(group_input_6.outputs[4], group_001_1.inputs[4])
			#separate_geometry_002.Selection -> group_001_1.Atoms
			mn_dna_style_surface.links.new(separate_geometry_002.outputs[0], group_001_1.inputs[0])
			#group_input_6.Selection -> group_002_1.Selection
			mn_dna_style_surface.links.new(group_input_6.outputs[1], group_002_1.inputs[1])
			#group_input_6.Resolution -> group_002_1.Quality
			mn_dna_style_surface.links.new(group_input_6.outputs[2], group_002_1.inputs[2])
			#group_input_6.Radius -> group_002_1.Scale Radii
			mn_dna_style_surface.links.new(group_input_6.outputs[3], group_002_1.inputs[3])
			#group_input_6.Subdivision Surface -> group_002_1.Surface Smoothing
			mn_dna_style_surface.links.new(group_input_6.outputs[5], group_002_1.inputs[5])
			#group_input_6.Shade Smooth -> group_002_1.Shade Smooth
			mn_dna_style_surface.links.new(group_input_6.outputs[8], group_002_1.inputs[8])
			#group_input_6.Color by CA -> group_002_1.Color by CA
			mn_dna_style_surface.links.new(group_input_6.outputs[6], group_002_1.inputs[6])
			#group_input_6.Material -> group_002_1.Material
			mn_dna_style_surface.links.new(group_input_6.outputs[9], group_002_1.inputs[9])
			#group_input_6.Interpolate Color -> group_002_1.Interpolate Color
			mn_dna_style_surface.links.new(group_input_6.outputs[7], group_002_1.inputs[7])
			#group_input_6.Probe Size -> group_002_1.Probe Size
			mn_dna_style_surface.links.new(group_input_6.outputs[4], group_002_1.inputs[4])
			#separate_geometry_003.Selection -> group_002_1.Atoms
			mn_dna_style_surface.links.new(separate_geometry_003.outputs[0], group_002_1.inputs[0])
			#group_input_6.Selection -> group_003_1.Selection
			mn_dna_style_surface.links.new(group_input_6.outputs[1], group_003_1.inputs[1])
			#group_input_6.Resolution -> group_003_1.Quality
			mn_dna_style_surface.links.new(group_input_6.outputs[2], group_003_1.inputs[2])
			#group_input_6.Radius -> group_003_1.Scale Radii
			mn_dna_style_surface.links.new(group_input_6.outputs[3], group_003_1.inputs[3])
			#group_input_6.Subdivision Surface -> group_003_1.Surface Smoothing
			mn_dna_style_surface.links.new(group_input_6.outputs[5], group_003_1.inputs[5])
			#group_input_6.Shade Smooth -> group_003_1.Shade Smooth
			mn_dna_style_surface.links.new(group_input_6.outputs[8], group_003_1.inputs[8])
			#group_input_6.Color by CA -> group_003_1.Color by CA
			mn_dna_style_surface.links.new(group_input_6.outputs[6], group_003_1.inputs[6])
			#group_input_6.Material -> group_003_1.Material
			mn_dna_style_surface.links.new(group_input_6.outputs[9], group_003_1.inputs[9])
			#group_input_6.Interpolate Color -> group_003_1.Interpolate Color
			mn_dna_style_surface.links.new(group_input_6.outputs[7], group_003_1.inputs[7])
			#group_input_6.Probe Size -> group_003_1.Probe Size
			mn_dna_style_surface.links.new(group_input_6.outputs[4], group_003_1.inputs[4])
			#separate_geometry_004.Selection -> group_003_1.Atoms
			mn_dna_style_surface.links.new(separate_geometry_004.outputs[0], group_003_1.inputs[0])
			#group_002_1.Geometry -> geometry_to_instance.Geometry
			mn_dna_style_surface.links.new(group_002_1.outputs[0], geometry_to_instance.inputs[0])
			#group_001_1.Geometry -> geometry_to_instance.Geometry
			mn_dna_style_surface.links.new(group_001_1.outputs[0], geometry_to_instance.inputs[0])
			#group.Geometry -> geometry_to_instance.Geometry
			mn_dna_style_surface.links.new(group.outputs[0], geometry_to_instance.inputs[0])
		...
		mod = obj.modifiers.new(name = "MN_dna_style_surface", type = 'NODES')
		mod.node_group = mn_dna_style_surface
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(MN_dna_style_surface.bl_idname)
