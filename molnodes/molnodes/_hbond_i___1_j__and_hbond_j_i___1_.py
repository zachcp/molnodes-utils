bl_info = {
	"name" : ".Hbond(i - 1,j) and Hbond(j,i + 1)",
...
class _Hbond_i___1_j__and_Hbond_j_i___1_(bpy.types.Operator):
	bl_idname = "node._hbond_i___1_j__and_hbond_j_i___1_"
	bl_label = ".Hbond(i - 1,j) and Hbond(j,i + 1)"
	...
	def execute(self, context):
		...
		def _hbond_i___1_j__and_hbond_j_i___1__node_group():
			...
			#Socket Boolean
			boolean_socket = _hbond_i___1_j__and_hbond_j_i___1_.interface.new_socket(name = "Boolean", in_out='OUTPUT', socket_type = 'NodeSocketBool')
			boolean_socket.attribute_domain = 'POINT'
			
			#Socket i
			i_socket = _hbond_i___1_j__and_hbond_j_i___1_.interface.new_socket(name = "i", in_out='INPUT', socket_type = 'NodeSocketInt')
			...
			#Socket j
			j_socket = _hbond_i___1_j__and_hbond_j_i___1_.interface.new_socket(name = "j", in_out='INPUT', socket_type = 'NodeSocketInt')
			...
			#node Group Output
			group_output_9 = _hbond_i___1_j__and_hbond_j_i___1_.nodes.new("NodeGroupOutput")
			group_output_9.name = "Group Output"
			group_output_9.is_active_output = True
			
			#node Group Input
			group_input_9 = _hbond_i___1_j__and_hbond_j_i___1_.nodes.new("NodeGroupInput")
			group_input_9.name = "Group Input"
			
			#node Group.010
			group_010_1 = _hbond_i___1_j__and_hbond_j_i___1_.nodes.new("GeometryNodeGroup")
			...
			#node Group.011
			group_011 = _hbond_i___1_j__and_hbond_j_i___1_.nodes.new("GeometryNodeGroup")
			...
			#node Frame
			frame_1 = _hbond_i___1_j__and_hbond_j_i___1_.nodes.new("NodeFrame")
			...
			#node Frame.001
			frame_001 = _hbond_i___1_j__and_hbond_j_i___1_.nodes.new("NodeFrame")
			...
			boolean_math_003 = _hbond_i___1_j__and_hbond_j_i___1_.nodes.new("FunctionNodeBooleanMath")
			...
			group_input_9.location = (-373.2626953125, 13.94732666015625)
			...
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_010_1.outputs[0], boolean_math_003.inputs[0])
			#group_011.Is Bonded -> boolean_math_003.Boolean
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_011.outputs[0], boolean_math_003.inputs[1])
			#boolean_math_003.Boolean -> group_output_9.Boolean
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(boolean_math_003.outputs[0], group_output_9.inputs[0])
			#group_input_9.j -> group_010_1.NH Index
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_input_9.outputs[1], group_010_1.inputs[2])
			#group_input_9.j -> group_011.CO Index
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_input_9.outputs[1], group_011.inputs[0])
			#group_input_9.i -> group_010_1.CO Index
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_input_9.outputs[0], group_010_1.inputs[0])
			#group_input_9.i -> group_011.NH Index
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_input_9.outputs[0], group_011.inputs[2])
		...
		mod = obj.modifiers.new(name = ".Hbond(i - 1,j) and Hbond(j,i + 1)", type = 'NODES')
		mod.node_group = _hbond_i___1_j__and_hbond_j_i___1_
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(_Hbond_i___1_j__and_Hbond_j_i___1_.bl_idname)
