...
class Style_Preset_4(bpy.types.Operator):
	bl_idname = "node.style_preset_4"
	bl_label = "Style Preset 4"
	...
	def execute(self, context):
		...
		def is_loop_node_group():
			...
			selection_socket_5.default_value = False
		...
		def _expand_selection_node_group():
			...
			input_socket_1.default_value = False
		...
		def _mn_utils_style_ribbon_peptide_node_group():
			...
			selection_socket_9.default_value = True
		...
		def _mn_world_scale_node_group():
			...
			#node Group Input
			group_input_33 = _mn_world_scale.nodes.new("NodeGroupInput")
			...
			#node Group Output
			group_output_34 = _mn_world_scale.nodes.new("NodeGroupOutput")
			...
			group_output_34.location = (190.0, 0.0)
			...
			#value_1.Value -> group_output_34.world_scale
			_mn_world_scale.links.new(value_1.outputs[0], group_output_34.inputs[0])
		...
		def mn_units_node_group():
			...
			#Socket Value
			value_socket_7 = mn_units.interface.new_socket(name = "Value", in_out='INPUT', socket_type = 'NodeSocketFloat')
			value_socket_7.default_value = 3.0
			...
			value_socket_7.description = "A value which will be scaled appropriately for the world"
			
			
			#initialize mn_units nodes
			#node Group Output
			group_output_35 = mn_units.nodes.new("NodeGroupOutput")
			group_output_35.name = "Group Output"
			group_output_35.is_active_output = True
			
			#node Group Input
			group_input_34 = mn_units.nodes.new("NodeGroupInput")
			...
			#node Math.001
			math_001_5 = mn_units.nodes.new("ShaderNodeMath")
			math_001_5.name = "Math.001"
			math_001_5.operation = 'MULTIPLY'
			math_001_5.use_clamp = False
			#Value_001
			math_001_5.inputs[1].default_value = 10.0
			
			#node Group
			group_14 = mn_units.nodes.new("GeometryNodeGroup")
			group_14.name = "Group"
			group_14.node_tree = _mn_world_scale
			
			
			
			
			#Set locations
			group_output_35.location = (190.0, 0.0)
			group_input_34.location = (-240.0, 0.0)
			math_6.location = (-60.0, 0.0)
			math_001_5.location = (-60.0, -160.0)
			group_14.location = (-304.00421142578125, -104.114013671875)
			...
			group_14.width, group_14.height = 197.58424377441406, 100.0
			
			#initialize mn_units links
			#math_6.Value -> group_output_35.Angstrom
			mn_units.links.new(math_6.outputs[0], group_output_35.inputs[0])
			#group_input_34.Value -> math_6.Value
			mn_units.links.new(group_input_34.outputs[0], math_6.inputs[0])
			#group_14.world_scale -> math_6.Value
			mn_units.links.new(group_14.outputs[0], math_6.inputs[1])
			#math_6.Value -> math_001_5.Value
			mn_units.links.new(math_6.outputs[0], math_001_5.inputs[0])
			#math_001_5.Value -> group_output_35.Nanometre
			mn_units.links.new(math_001_5.outputs[0], group_output_35.inputs[1])
			return mn_units
		...
		def _mn_utils_style_spheres_points_node_group():
			...
			#Socket Atoms
			atoms_socket_8 = _mn_utils_style_spheres_points.interface.new_socket(name = "Atoms", in_out='INPUT', socket_type = 'NodeSocketGeometry')
			atoms_socket_8.attribute_domain = 'POINT'
			atoms_socket_8.description = "Atomic geometry that contains vertices and edges"
			
			#Socket Selection
			selection_socket_11 = _mn_utils_style_spheres_points.interface.new_socket(name = "Selection", in_out='INPUT', socket_type = 'NodeSocketBool')
			selection_socket_11.default_value = True
			selection_socket_11.attribute_domain = 'POINT'
			selection_socket_11.hide_value = True
			selection_socket_11.description = "Selection of atoms to apply this node to"
			...
			#Socket Material
			material_socket_3 = _mn_utils_style_spheres_points.interface.new_socket(name = "Material", in_out='INPUT', socket_type = 'NodeSocketMaterial')
			...
			#node Group Input
			group_input_35 = _mn_utils_style_spheres_points.nodes.new("NodeGroupInput")
			...
			#node Switch
			switch_7 = _mn_utils_style_spheres_points.nodes.new("GeometryNodeSwitch")
			switch_7.name = "Switch"
			switch_7.input_type = 'FLOAT'
			
			#node Named Attribute
			named_attribute_6 = _mn_utils_style_spheres_points.nodes.new("GeometryNodeInputNamedAttribute")
			...
			#node Group
			group_15 = _mn_utils_style_spheres_points.nodes.new("GeometryNodeGroup")
			group_15.name = "Group"
			group_15.node_tree = mn_units
			#Input_1
			group_15.inputs[0].default_value = 0.800000011920929
			
			#node Math
			math_7 = _mn_utils_style_spheres_points.nodes.new("ShaderNodeMath")
			math_7.name = "Math"
			math_7.operation = 'MULTIPLY'
			math_7.use_clamp = False
			
			#node Group Output
			group_output_36 = _mn_utils_style_spheres_points.nodes.new("NodeGroupOutput")
			...
			#Set locations
			group_input_35.location = (-1060.0, 60.0)
			mesh_to_points_1.location = (-540.0, 220.0)
			switch_7.location = (-900.0, -100.0)
			named_attribute_6.location = (-1080.0, -100.0)
			group_15.location = (-1080.0, -240.0)
			math_7.location = (-720.0, 40.0)
			group_output_36.location = (-220.0, 220.0)
			...
			#set_material_2.Geometry -> group_output_36.Point Cloud
			_mn_utils_style_spheres_points.links.new(set_material_2.outputs[0], group_output_36.inputs[0])
			#group_input_35.Selection -> mesh_to_points_1.Selection
			_mn_utils_style_spheres_points.links.new(group_input_35.outputs[1], mesh_to_points_1.inputs[1])
			#group_input_35.Radii -> math_7.Value
			_mn_utils_style_spheres_points.links.new(group_input_35.outputs[2], math_7.inputs[0])
			#math_7.Value -> mesh_to_points_1.Radius
			_mn_utils_style_spheres_points.links.new(math_7.outputs[0], mesh_to_points_1.inputs[3])
			#group_input_35.Material -> set_material_2.Material
			_mn_utils_style_spheres_points.links.new(group_input_35.outputs[3], set_material_2.inputs[2])
			#named_attribute_6.Attribute -> switch_7.Switch
			_mn_utils_style_spheres_points.links.new(named_attribute_6.outputs[0], switch_7.inputs[0])
			#named_attribute_6.Attribute -> switch_7.True
			_mn_utils_style_spheres_points.links.new(named_attribute_6.outputs[0], switch_7.inputs[2])
			#switch_7.Output -> math_7.Value
			_mn_utils_style_spheres_points.links.new(switch_7.outputs[0], math_7.inputs[1])
			#group_input_35.Atoms -> mesh_to_points_1.Mesh
			_mn_utils_style_spheres_points.links.new(group_input_35.outputs[0], mesh_to_points_1.inputs[0])
			...
			#group_15.Angstrom -> switch_7.False
			_mn_utils_style_spheres_points.links.new(group_15.outputs[0], switch_7.inputs[1])
		...
		def _mn_utils_style_spheres_icosphere_node_group():
			...
			#Socket Atoms
			atoms_socket_9 = _mn_utils_style_spheres_icosphere.interface.new_socket(name = "Atoms", in_out='INPUT', socket_type = 'NodeSocketGeometry')
			atoms_socket_9.attribute_domain = 'POINT'
			atoms_socket_9.description = "Atomic geometry that contains vertices and edges"
			
			#Socket Selection
			selection_socket_12 = _mn_utils_style_spheres_icosphere.interface.new_socket(name = "Selection", in_out='INPUT', socket_type = 'NodeSocketBool')
			...
			#Socket Material
			material_socket_4 = _mn_utils_style_spheres_icosphere.interface.new_socket(name = "Material", in_out='INPUT', socket_type = 'NodeSocketMaterial')
			...
			#node Frame
			frame_5 = _mn_utils_style_spheres_icosphere.nodes.new("NodeFrame")
			frame_5.label = "Different Levels of Detail."
			frame_5.name = "Frame"
			frame_5.label_size = 20
			frame_5.shrink = True
			
			#node Reroute
			reroute_5 = _mn_utils_style_spheres_icosphere.nodes.new("NodeReroute")
			reroute_5.name = "Reroute"
			#node Math.001
			math_001_6 = _mn_utils_style_spheres_icosphere.nodes.new("ShaderNodeMath")
			math_001_6.name = "Math.001"
			math_001_6.operation = 'MINIMUM'
			math_001_6.use_clamp = False
			
			#node Group Output
			group_output_37 = _mn_utils_style_spheres_icosphere.nodes.new("NodeGroupOutput")
			...
			#node Set Shade Smooth
			set_shade_smooth_2 = _mn_utils_style_spheres_icosphere.nodes.new("GeometryNodeSetShadeSmooth")
			...
			#node Group Input
			group_input_36 = _mn_utils_style_spheres_icosphere.nodes.new("NodeGroupInput")
			group_input_36.name = "Group Input"
			group_input_36.outputs[2].hide = True
			group_input_36.outputs[3].hide = True
			group_input_36.outputs[4].hide = True
			group_input_36.outputs[5].hide = True
			group_input_36.outputs[6].hide = True
			
			#node Reroute.001
			reroute_001_6 = _mn_utils_style_spheres_icosphere.nodes.new("NodeReroute")
			reroute_001_6.name = "Reroute.001"
			#node Group Input.001
			group_input_001_4 = _mn_utils_style_spheres_icosphere.nodes.new("NodeGroupInput")
			...
			#node Reroute.002
			reroute_002_6 = _mn_utils_style_spheres_icosphere.nodes.new("NodeReroute")
			...
			#node Named Attribute
			named_attribute_7 = _mn_utils_style_spheres_icosphere.nodes.new("GeometryNodeInputNamedAttribute")
			named_attribute_7.name = "Named Attribute"
			named_attribute_7.data_type = 'FLOAT'
			#Name
			named_attribute_7.inputs[0].default_value = "vdw_radii"
			...
			#node Math
			math_8 = _mn_utils_style_spheres_icosphere.nodes.new("ShaderNodeMath")
			math_8.name = "Math"
			math_8.operation = 'MAXIMUM'
			...
			#node Group Input.003
			group_input_003_2 = _mn_utils_style_spheres_icosphere.nodes.new("NodeGroupInput")
			...
			#node Math.002
			math_002_1 = _mn_utils_style_spheres_icosphere.nodes.new("ShaderNodeMath")
			math_002_1.name = "Math.002"
			math_002_1.operation = 'ADD'
			math_002_1.use_clamp = False
			
			#node Integer
			integer_4 = _mn_utils_style_spheres_icosphere.nodes.new("FunctionNodeInputInt")
			...
			#Set parents
			ico_sphere_001.parent = frame_5
			ico_sphere_002.parent = frame_5
			ico_sphere_003.parent = frame_5
			geometry_to_instance.parent = frame_5
			ico_sphere_004.parent = frame_5
			ico_sphere_005.parent = frame_5
			reroute_002_6.parent = frame_5
			transform_geometry.parent = frame_5
			cube.parent = frame_5
			
			#Set locations
			frame_5.location = (0.0, 0.0)
			reroute_5.location = (-560.0, -40.0)
			math_001_6.location = (-140.0, 60.0)
			group_output_37.location = (835.407470703125, 359.5566711425781)
			group_input_002_2.location = (320.0, 260.0)
			set_shade_smooth_2.location = (500.0, 340.0)
			set_material_3.location = (660.0, 340.0)
			group_input_36.location = (-160.0, 240.0)
			reroute_001_6.location = (-480.0, 120.0)
			group_input_001_4.location = (-300.0, 60.0)
			...
			reroute_002_6.location = (-1040.0, 160.0)
			transform_geometry.location = (-1360.0, 200.0)
			cube.location = (-1520.0, 200.0)
			named_attribute_7.location = (-240.0, -340.0)
			radius.location = (-240.0, -480.0)
			math_8.location = (-60.0, -340.0)
			math_003.location = (100.0, -340.0)
			group_input_003_2.location = (-60.0, -520.0)
			math_002_1.location = (-140.0, -100.0)
			integer_4.location = (-320.0, -220.0)
			domain_size_2.location = (-320.0, -100.0)
			instance_on_points_1.location = (91.33897399902344, 216.86837768554688)
			
			#Set dimensions
			frame_5.width, frame_5.height = 800.0, 829.0
			...
			#set_material_3.Geometry -> group_output_37.Instances
			_mn_utils_style_spheres_icosphere.links.new(set_material_3.outputs[0], group_output_37.inputs[0])
			#set_shade_smooth_2.Geometry -> set_material_3.Geometry
			_mn_utils_style_spheres_icosphere.links.new(set_shade_smooth_2.outputs[0], set_material_3.inputs[0])
			#group_input_36.Atoms -> instance_on_points_1.Points
			_mn_utils_style_spheres_icosphere.links.new(group_input_36.outputs[0], instance_on_points_1.inputs[0])
			#reroute_001_6.Output -> instance_on_points_1.Instance
			_mn_utils_style_spheres_icosphere.links.new(reroute_001_6.outputs[0], instance_on_points_1.inputs[2])
			...
			#math_001_6.Value -> instance_on_points_1.Instance Index
			_mn_utils_style_spheres_icosphere.links.new(math_001_6.outputs[0], instance_on_points_1.inputs[4])
			#group_input_001_4.Subdivisions -> math_001_6.Value
			_mn_utils_style_spheres_icosphere.links.new(group_input_001_4.outputs[3], math_001_6.inputs[0])
			#reroute_5.Output -> domain_size_2.Geometry
			_mn_utils_style_spheres_icosphere.links.new(reroute_5.outputs[0], domain_size_2.inputs[0])
			#geometry_to_instance.Instances -> reroute_5.Input
			_mn_utils_style_spheres_icosphere.links.new(geometry_to_instance.outputs[0], reroute_5.inputs[0])
			#named_attribute_7.Attribute -> math_8.Value
			_mn_utils_style_spheres_icosphere.links.new(named_attribute_7.outputs[0], math_8.inputs[0])
			#radius.Radius -> math_8.Value
			_mn_utils_style_spheres_icosphere.links.new(radius.outputs[0], math_8.inputs[1])
			#group_input_002_2.Material -> set_material_3.Material
			_mn_utils_style_spheres_icosphere.links.new(group_input_002_2.outputs[5], set_material_3.inputs[2])
			#instance_on_points_1.Instances -> set_shade_smooth_2.Geometry
			_mn_utils_style_spheres_icosphere.links.new(instance_on_points_1.outputs[0], set_shade_smooth_2.inputs[0])
			#group_input_002_2.Shade Smooth -> set_shade_smooth_2.Shade Smooth
			_mn_utils_style_spheres_icosphere.links.new(group_input_002_2.outputs[4], set_shade_smooth_2.inputs[2])
			#group_input_36.Selection -> instance_on_points_1.Selection
			_mn_utils_style_spheres_icosphere.links.new(group_input_36.outputs[1], instance_on_points_1.inputs[1])
			#math_8.Value -> math_003.Value
			_mn_utils_style_spheres_icosphere.links.new(math_8.outputs[0], math_003.inputs[0])
			#group_input_003_2.Radii -> math_003.Value
			_mn_utils_style_spheres_icosphere.links.new(group_input_003_2.outputs[2], math_003.inputs[1])
			#reroute_5.Output -> reroute_001_6.Input
			_mn_utils_style_spheres_icosphere.links.new(reroute_5.outputs[0], reroute_001_6.inputs[0])
			...
			#transform_geometry.Geometry -> reroute_002_6.Input
			_mn_utils_style_spheres_icosphere.links.new(transform_geometry.outputs[0], reroute_002_6.inputs[0])
			#domain_size_2.Instance Count -> math_002_1.Value
			_mn_utils_style_spheres_icosphere.links.new(domain_size_2.outputs[5], math_002_1.inputs[0])
			#integer_4.Integer -> math_002_1.Value
			_mn_utils_style_spheres_icosphere.links.new(integer_4.outputs[0], math_002_1.inputs[1])
			#math_002_1.Value -> math_001_6.Value
			_mn_utils_style_spheres_icosphere.links.new(math_002_1.outputs[0], math_001_6.inputs[1])
			...
			#reroute_002_6.Output -> geometry_to_instance.Geometry
			_mn_utils_style_spheres_icosphere.links.new(reroute_002_6.outputs[0], geometry_to_instance.inputs[0])
		...
		def style_spheres_node_group():
			...
			#Socket Atoms
			atoms_socket_10 = style_spheres.interface.new_socket(name = "Atoms", in_out='INPUT', socket_type = 'NodeSocketGeometry')
			atoms_socket_10.attribute_domain = 'POINT'
			atoms_socket_10.description = "Atomic geometry that contains vertices and edges"
			
			#Socket Selection
			selection_socket_13 = style_spheres.interface.new_socket(name = "Selection", in_out='INPUT', socket_type = 'NodeSocketBool')
			selection_socket_13.default_value = True
			selection_socket_13.attribute_domain = 'POINT'
			selection_socket_13.hide_value = True
			selection_socket_13.description = "Selection of atoms to apply this style to"
			...
			#Socket Material
			material_socket_5 = style_spheres.interface.new_socket(name = "Material", in_out='INPUT', socket_type = 'NodeSocketMaterial', parent = material_panel_1)
			...
			#node Group Input
			group_input_37 = style_spheres.nodes.new("NodeGroupInput")
			group_input_37.name = "Group Input"
			
			#node Group Output
			group_output_38 = style_spheres.nodes.new("NodeGroupOutput")
			...
			#node Separate Geometry
			separate_geometry_4 = style_spheres.nodes.new("GeometryNodeSeparateGeometry")
			separate_geometry_4.name = "Separate Geometry"
			separate_geometry_4.domain = 'POINT'
			
			#node Group.014
			group_014_1 = style_spheres.nodes.new("GeometryNodeGroup")
			group_014_1.name = "Group.014"
			group_014_1.node_tree = _mn_utils_style_spheres_points
			...
			#Set locations
			group_input_37.location = (-679.2061157226562, -54.561466217041016)
			group_output_38.location = (480.0, 40.0)
			join_geometry_1.location = (320.0, 40.0)
			separate_geometry_4.location = (-420.0, 80.0)
			group_014_1.location = (-200.0, -200.0)
			...
			group_014_1.width, group_014_1.height = 277.9979248046875, 100.0
			group_026.width, group_026.height = 278.0207824707031, 100.0
			realize_instances.width, realize_instances.height = 140.0, 100.0
			
			#initialize style_spheres links
			#group_input_37.Atoms -> separate_geometry_4.Geometry
			style_spheres.links.new(group_input_37.outputs[0], separate_geometry_4.inputs[0])
			#group_input_37.Selection -> group_014_1.Selection
			style_spheres.links.new(group_input_37.outputs[1], group_014_1.inputs[1])
			#group_input_37.Selection -> group_026.Selection
			style_spheres.links.new(group_input_37.outputs[1], group_026.inputs[1])
			#group_input_37.Sphere As Mesh -> separate_geometry_4.Selection
			style_spheres.links.new(group_input_37.outputs[2], separate_geometry_4.inputs[1])
			#group_input_37.Sphere Radii -> group_014_1.Radii
			style_spheres.links.new(group_input_37.outputs[3], group_014_1.inputs[2])
			#group_input_37.Sphere Radii -> group_026.Radii
			style_spheres.links.new(group_input_37.outputs[3], group_026.inputs[2])
			#group_input_37.Sphere Subdivisions -> group_026.Subdivisions
			style_spheres.links.new(group_input_37.outputs[4], group_026.inputs[3])
			#group_input_37.Shade Smooth -> group_026.Shade Smooth
			style_spheres.links.new(group_input_37.outputs[5], group_026.inputs[4])
			#group_input_37.Material -> group_014_1.Material
			style_spheres.links.new(group_input_37.outputs[6], group_014_1.inputs[3])
			#group_input_37.Material -> group_026.Material
			style_spheres.links.new(group_input_37.outputs[6], group_026.inputs[5])
			#join_geometry_1.Geometry -> group_output_38.Geometry
			style_spheres.links.new(join_geometry_1.outputs[0], group_output_38.inputs[0])
			...
			#separate_geometry_4.Inverted -> group_014_1.Atoms
			style_spheres.links.new(separate_geometry_4.outputs[1], group_014_1.inputs[0])
			#separate_geometry_4.Selection -> group_026.Atoms
			style_spheres.links.new(separate_geometry_4.outputs[0], group_026.inputs[0])
			#group_014_1.Point Cloud -> join_geometry_1.Geometry
			style_spheres.links.new(group_014_1.outputs[0], join_geometry_1.inputs[0])
		...
		def attribute_map_node_group():
			...
			#Socket Value
			value_socket_8 = attribute_map.interface.new_socket(name = "Value", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
			...
			#node Group Output
			group_output_39 = attribute_map.nodes.new("NodeGroupOutput")
			group_output_39.name = "Group Output"
			group_output_39.is_active_output = True
			
			#node Group Input
			group_input_38 = attribute_map.nodes.new("NodeGroupInput")
			...
			#node Named Attribute.004
			named_attribute_004_1 = attribute_map.nodes.new("GeometryNodeInputNamedAttribute")
			named_attribute_004_1.name = "Named Attribute.004"
			named_attribute_004_1.data_type = 'FLOAT'
			...
			#Set locations
			group_output_39.location = (270.0, 0.0)
			group_input_38.location = (-280.0, 0.0)
			map_range.location = (80.0, 70.0)
			named_attribute_004_1.location = (-80.0, 70.0)
			...
			#named_attribute_004_1.Attribute -> attribute_statistic.Attribute
			attribute_map.links.new(named_attribute_004_1.outputs[0], attribute_statistic.inputs[2])
			#attribute_statistic.Min -> map_range.From Min
			attribute_map.links.new(attribute_statistic.outputs[3], map_range.inputs[1])
			#named_attribute_004_1.Attribute -> map_range.Value
			attribute_map.links.new(named_attribute_004_1.outputs[0], map_range.inputs[0])
			#group_input_38.Sample Atoms -> attribute_statistic.Geometry
			attribute_map.links.new(group_input_38.outputs[0], attribute_statistic.inputs[0])
			#map_range.Result -> group_output_39.Value
			attribute_map.links.new(map_range.outputs[0], group_output_39.inputs[0])
			#group_input_38.Attribute -> named_attribute_004_1.Name
			attribute_map.links.new(group_input_38.outputs[1], named_attribute_004_1.inputs[0])
			#group_input_38.Value Min -> map_range.To Min
			attribute_map.links.new(group_input_38.outputs[2], map_range.inputs[3])
			#group_input_38.Value Max -> map_range.To Max
			attribute_map.links.new(group_input_38.outputs[3], map_range.inputs[4])
		...
		def style_preset_4_node_group():
			style_preset_4 = bpy.data.node_groups.new(type = 'GeometryNodeTree', name = "Style Preset 4")
			...
			#Socket Geometry
			geometry_socket_6 = style_preset_4.interface.new_socket(name = "Geometry", in_out='OUTPUT', socket_type = 'NodeSocketGeometry')
			geometry_socket_6.attribute_domain = 'POINT'
			
			#Socket Atoms
			atoms_socket_11 = style_preset_4.interface.new_socket(name = "Atoms", in_out='INPUT', socket_type = 'NodeSocketGeometry')
			atoms_socket_11.attribute_domain = 'POINT'
			
			#Socket Selection
			selection_socket_14 = style_preset_4.interface.new_socket(name = "Selection", in_out='INPUT', socket_type = 'NodeSocketBool')
			selection_socket_14.default_value = True
			selection_socket_14.attribute_domain = 'POINT'
			selection_socket_14.hide_value = True
			
			#Socket Quality
			quality_socket_2 = style_preset_4.interface.new_socket(name = "Quality", in_out='INPUT', socket_type = 'NodeSocketInt')
			...
			#Socket Color Blur
			color_blur_socket_1 = style_preset_4.interface.new_socket(name = "Color Blur", in_out='INPUT', socket_type = 'NodeSocketBool')
			color_blur_socket_1.default_value = True
			color_blur_socket_1.attribute_domain = 'POINT'
			
			#Socket Shade Smooth
			shade_smooth_socket_4 = style_preset_4.interface.new_socket(name = "Shade Smooth", in_out='INPUT', socket_type = 'NodeSocketBool')
			shade_smooth_socket_4.default_value = True
			shade_smooth_socket_4.attribute_domain = 'POINT'
			
			#Socket Material
			material_socket_6 = style_preset_4.interface.new_socket(name = "Material", in_out='INPUT', socket_type = 'NodeSocketMaterial')
			material_socket_6.attribute_domain = 'POINT'
			
			
			#initialize style_preset_4 nodes
			#node Group Output
			group_output_40 = style_preset_4.nodes.new("NodeGroupOutput")
			group_output_40.name = "Group Output"
			group_output_40.is_active_output = True
			
			#node Group Input
			group_input_39 = style_preset_4.nodes.new("NodeGroupInput")
			group_input_39.name = "Group Input"
			
			#node Frame.003
			frame_003_2 = style_preset_4.nodes.new("NodeFrame")
			frame_003_2.label = "Preset 4"
			...
			#node Separate Geometry.006
			separate_geometry_006_1 = style_preset_4.nodes.new("GeometryNodeSeparateGeometry")
			separate_geometry_006_1.name = "Separate Geometry.006"
			separate_geometry_006_1.domain = 'POINT'
			
			#node Group.005
			group_005_2 = style_preset_4.nodes.new("GeometryNodeGroup")
			group_005_2.label = "Ribbon Protein"
			group_005_2.name = "Group.005"
			group_005_2.node_tree = style_ribbon
			#Socket_7
			group_005_2.inputs[4].default_value = 0.5
			
			#node Group.011
			group_011_1 = style_preset_4.nodes.new("GeometryNodeGroup")
			group_011_1.label = "Style Spheres"
			group_011_1.name = "Group.011"
			group_011_1.node_tree = style_spheres
			#Input_2
			group_011_1.inputs[2].default_value = False
			#Input_3
			group_011_1.inputs[3].default_value = 0.800000011920929
			
			#node Reroute.002
			reroute_002_7 = style_preset_4.nodes.new("NodeReroute")
			reroute_002_7.name = "Reroute.002"
			#node Group.015
			group_015 = style_preset_4.nodes.new("GeometryNodeGroup")
			group_015.name = "Group.015"
			group_015.node_tree = is_peptide
			#Socket_1
			group_015.inputs[0].default_value = True
			#Socket_3
			group_015.inputs[1].default_value = False
			
			#node Reroute
			reroute_6 = style_preset_4.nodes.new("NodeReroute")
			reroute_6.name = "Reroute"
			#node Reroute.001
			reroute_001_7 = style_preset_4.nodes.new("NodeReroute")
			reroute_001_7.name = "Reroute.001"
			#node Group
			group_16 = style_preset_4.nodes.new("GeometryNodeGroup")
			group_16.name = "Group"
			group_16.node_tree = attribute_map
			#Socket_2
			group_16.inputs[1].default_value = "b_factor"
			#Socket_3
			group_16.inputs[2].default_value = 0.20000000298023224
			#Socket_4
			group_16.inputs[3].default_value = 3.0
			
			#node Reroute.003
			reroute_003_4 = style_preset_4.nodes.new("NodeReroute")
			reroute_003_4.name = "Reroute.003"
			
			
			#Set parents
			join_geometry_005.parent = frame_003_2
			separate_geometry_006_1.parent = frame_003_2
			group_005_2.parent = frame_003_2
			group_011_1.parent = frame_003_2
			reroute_002_7.parent = frame_003_2
			group_015.parent = frame_003_2
			reroute_6.parent = frame_003_2
			reroute_001_7.parent = frame_003_2
			group_16.parent = frame_003_2
			reroute_003_4.parent = frame_003_2
			
			#Set locations
			group_output_40.location = (749.06005859375, 0.0)
			group_input_39.location = (-744.8936157226562, -118.712646484375)
			frame_003_2.location = (827.06005859375, 3586.0)
			join_geometry_005.location = (-387.06005859375, -3646.0)
			separate_geometry_006_1.location = (-895.833251953125, -3555.84814453125)
			group_005_2.location = (-695.833251953125, -3495.84814453125)
			group_011_1.location = (-695.833251953125, -3815.84814453125)
			reroute_002_7.location = (-886.0, -3916.0)
			group_015.location = (-1086.0, -3656.0)
			reroute_6.location = (-886.0, -3876.0)
			reroute_001_7.location = (-886.0, -3896.0)
			group_16.location = (-947.06005859375, -3366.0)
			reroute_003_4.location = (-887.06005859375, -3846.0)
			
			#Set dimensions
			group_output_40.width, group_output_40.height = 140.0, 100.0
			group_input_39.width, group_input_39.height = 140.0, 100.0
			frame_003_2.width, frame_003_2.height = 899.199951171875, 800.39990234375
			...
			group_005_2.width, group_005_2.height = 200.0, 100.0
			group_011_1.width, group_011_1.height = 200.0, 100.0
			...
			group_16.width, group_16.height = 198.40765380859375, 100.0
			reroute_003_4.width, reroute_003_4.height = 16.0, 100.0
			
			#initialize style_preset_4 links
			#separate_geometry_006_1.Inverted -> group_011_1.Atoms
			style_preset_4.links.new(separate_geometry_006_1.outputs[1], group_011_1.inputs[0])
			#group_input_39.Atoms -> separate_geometry_006_1.Geometry
			style_preset_4.links.new(group_input_39.outputs[0], separate_geometry_006_1.inputs[0])
			#group_011_1.Geometry -> join_geometry_005.Geometry
			style_preset_4.links.new(group_011_1.outputs[0], join_geometry_005.inputs[0])
			#group_16.Value -> group_005_2.Radius
			style_preset_4.links.new(group_16.outputs[0], group_005_2.inputs[3])
			#reroute_002_7.Output -> group_005_2.Material
			style_preset_4.links.new(reroute_002_7.outputs[0], group_005_2.inputs[7])
			#reroute_6.Output -> group_011_1.Sphere Subdivisions
			style_preset_4.links.new(reroute_6.outputs[0], group_011_1.inputs[4])
			#reroute_001_7.Output -> group_005_2.Shade Smooth
			style_preset_4.links.new(reroute_001_7.outputs[0], group_005_2.inputs[6])
			#reroute_002_7.Output -> group_011_1.Material
			style_preset_4.links.new(reroute_002_7.outputs[0], group_011_1.inputs[6])
			#reroute_6.Output -> group_005_2.Quality
			style_preset_4.links.new(reroute_6.outputs[0], group_005_2.inputs[2])
			#group_015.Selection -> separate_geometry_006_1.Selection
			style_preset_4.links.new(group_015.outputs[0], separate_geometry_006_1.inputs[1])
			#reroute_001_7.Output -> group_011_1.Shade Smooth
			style_preset_4.links.new(reroute_001_7.outputs[0], group_011_1.inputs[5])
			#separate_geometry_006_1.Selection -> group_005_2.Atoms
			style_preset_4.links.new(separate_geometry_006_1.outputs[0], group_005_2.inputs[0])
			#group_input_39.Material -> reroute_002_7.Input
			style_preset_4.links.new(group_input_39.outputs[5], reroute_002_7.inputs[0])
			#group_input_39.Quality -> reroute_6.Input
			style_preset_4.links.new(group_input_39.outputs[2], reroute_6.inputs[0])
			#group_input_39.Shade Smooth -> reroute_001_7.Input
			style_preset_4.links.new(group_input_39.outputs[4], reroute_001_7.inputs[0])
			#join_geometry_005.Geometry -> group_output_40.Geometry
			style_preset_4.links.new(join_geometry_005.outputs[0], group_output_40.inputs[0])
			#group_input_39.Atoms -> group_16.Sample Atoms
			style_preset_4.links.new(group_input_39.outputs[0], group_16.inputs[0])
			#reroute_003_4.Output -> group_005_2.Selection
			style_preset_4.links.new(reroute_003_4.outputs[0], group_005_2.inputs[1])
			#reroute_003_4.Output -> group_011_1.Selection
			style_preset_4.links.new(reroute_003_4.outputs[0], group_011_1.inputs[1])
			#group_input_39.Selection -> reroute_003_4.Input
			style_preset_4.links.new(group_input_39.outputs[1], reroute_003_4.inputs[0])
			#group_input_39.Color Blur -> group_005_2.Color Blur
			style_preset_4.links.new(group_input_39.outputs[3], group_005_2.inputs[5])
			#group_005_2.Geometry -> join_geometry_005.Geometry
			style_preset_4.links.new(group_005_2.outputs[0], join_geometry_005.inputs[0])
		...
		mod = obj.modifiers.new(name = "Style Preset 4", type = 'NODES')
		mod.node_group = style_preset_4
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(Style_Preset_4.bl_idname)
