...
class Point_Edge_Angle(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        def vector_angle_node_group():
            ...
            # Socket B
            b_socket = vector_angle.interface.new_socket(
            ...
            vector_angle.links.new(
                vector_math_001_1.outputs[0], vector_math_1.inputs[0]
            )
            ...
            vector_angle.links.new(
                group_input_1.outputs[0], vector_math_001_1.inputs[0]
            )
        ...
        def point_edge_angle_node_group():
            ...
            # Socket Is Valid
            is_valid_socket_1 = point_edge_angle.interface.new_socket(
                name="Is Valid", in_out="OUTPUT", socket_type="NodeSocketBool"
            )
            ...
            # Socket Angle
            angle_socket_1 = point_edge_angle.interface.new_socket(
                name="Angle", in_out="OUTPUT", socket_type="NodeSocketFloat"
            )
            ...
            point_edge_angle.links.new(
                boolean_math.outputs[0], boolean_math_001.inputs[1]
            )
