...
class Backbone_Position(bpy.types.Operator):
	bl_idname = "node.backbone_position"
	bl_label = "Backbone Position"
	...
	def execute(self, context):
		...
		mod = obj.modifiers.new(name = "Backbone Position", type = 'NODES')
		mod.node_group = backbone_position
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(Backbone_Position.bl_idname)
