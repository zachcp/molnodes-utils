...
class Helix_Detect(bpy.types.Operator):
	bl_idname = "node.helix_detect"
	bl_label = "Helix Detect"
	...
	def execute(self, context):
		...
		def boolean_run_fill_node_group():
			...
			#node Group Output
			group_output_9 = boolean_run_fill.nodes.new("NodeGroupOutput")
			group_output_9.name = "Group Output"
			group_output_9.is_active_output = True
			
			#node Group Input
			group_input_9 = boolean_run_fill.nodes.new("NodeGroupInput")
			...
			#node Compare
			compare_2 = boolean_run_fill.nodes.new("FunctionNodeCompare")
			compare_2.name = "Compare"
			compare_2.data_type = 'INT'
			compare_2.mode = 'ELEMENT'
			compare_2.operation = 'LESS_EQUAL'
			...
			#Set locations
			group_output_9.location = (430.0, 0.0)
			group_input_9.location = (-480.0, -20.0)
			accumulate_field.location = (-220.0, -120.0)
			accumulate_field_001.location = (-60.0, -120.0)
			compare_2.location = (100.0, -120.0)
			...
			#accumulate_field_001.Trailing -> compare_2.A
			boolean_run_fill.links.new(accumulate_field_001.outputs[1], compare_2.inputs[2])
			...
			#compare_2.Result -> boolean_math_010.Boolean
			boolean_run_fill.links.new(compare_2.outputs[0], boolean_math_010.inputs[0])
			#accumulate_field_001.Total -> compare_001_1.A
			boolean_run_fill.links.new(accumulate_field_001.outputs[2], compare_001_1.inputs[2])
			#reroute_1.Output -> compare_2.B
			boolean_run_fill.links.new(reroute_1.outputs[0], compare_2.inputs[3])
			...
			#boolean_math_1.Boolean -> group_output_9.Boolean
			boolean_run_fill.links.new(boolean_math_1.outputs[0], group_output_9.inputs[0])
			...
			#group_input_9.Fill Size -> reroute_003.Input
			boolean_run_fill.links.new(group_input_9.outputs[1], reroute_003.inputs[0])
			#group_input_9.Boolean -> reroute_002.Input
			boolean_run_fill.links.new(group_input_9.outputs[0], reroute_002.inputs[0])
		...
		def offset_boolean_node_group():
			...
			#node Group Output
			group_output_10 = offset_boolean.nodes.new("NodeGroupOutput")
			group_output_10.name = "Group Output"
			group_output_10.is_active_output = True
			
			#node Group Input
			group_input_10 = offset_boolean.nodes.new("NodeGroupInput")
			...
			#node Math
			math_5 = offset_boolean.nodes.new("ShaderNodeMath")
			math_5.name = "Math"
			...
			#Set locations
			group_output_10.location = (190.0, 0.0)
			group_input_10.location = (-344.3331298828125, -46.23834991455078)
			evaluate_at_index_3.location = (0.0, 0.0)
			math_5.location = (-160.0, 0.0)
			...
			#evaluate_at_index_3.Value -> group_output_10.Boolean
			offset_boolean.links.new(evaluate_at_index_3.outputs[0], group_output_10.inputs[0])
			#group_input_10.Boolean -> evaluate_at_index_3.Value
			offset_boolean.links.new(group_input_10.outputs[1], evaluate_at_index_3.inputs[1])
			#group_input_10.Index -> math_5.Value
			offset_boolean.links.new(group_input_10.outputs[0], math_5.inputs[1])
			#math_5.Value -> evaluate_at_index_3.Index
			offset_boolean.links.new(math_5.outputs[0], evaluate_at_index_3.inputs[0])
			#group_input_10.Offset -> math_5.Value
			offset_boolean.links.new(group_input_10.outputs[2], math_5.inputs[0])
		...
		def vector_angle_node_group():
			...
			#node Group Input
			group_input_11 = vector_angle.nodes.new("NodeGroupInput")
			...
			#node Math
			math_6 = vector_angle.nodes.new("ShaderNodeMath")
			math_6.name = "Math"
			math_6.operation = 'ARCCOSINE'
			math_6.use_clamp = False
			
			#node Group Output
			group_output_11 = vector_angle.nodes.new("NodeGroupOutput")
			...
			#vector_math_3.Value -> math_6.Value
			vector_angle.links.new(vector_math_3.outputs[1], math_6.inputs[0])
			...
			#math_6.Value -> group_output_11.Angle
			vector_angle.links.new(math_6.outputs[0], group_output_11.inputs[0])
			#group_input_11.A -> vector_math_001_1.Vector
			vector_angle.links.new(group_input_11.outputs[0], vector_math_001_1.inputs[0])
			#group_input_11.B -> vector_math_002_2.Vector
			vector_angle.links.new(group_input_11.outputs[1], vector_math_002_2.inputs[0])
			return vector_angle
		...
		def dihedral_angle_node_group():
			...
			#node Group Output
			group_output_12 = dihedral_angle.nodes.new("NodeGroupOutput")
			...
			#node Reroute
			reroute_2 = dihedral_angle.nodes.new("NodeReroute")
			reroute_2.name = "Reroute"
			#node Math
			math_7 = dihedral_angle.nodes.new("ShaderNodeMath")
			math_7.name = "Math"
			...
			#node Group Input.001
			group_input_001_1 = dihedral_angle.nodes.new("NodeGroupInput")
			...
			#node Group Input
			group_input_12 = dihedral_angle.nodes.new("NodeGroupInput")
			...
			group_output_12.location = (920.0, 320.0)
			...
			reroute_2.location = (300.0, 220.0)
			math_7.location = (640.0, 420.0)
			group_input_003.location = (-440.0, 0.0)
			group_input_001_1.location = (-440.0, 420.0)
			group_input_12.location = (-440.0, 280.0)
			...
			#vector_math_006_1.Vector -> reroute_2.Input
			dihedral_angle.links.new(vector_math_006_1.outputs[0], reroute_2.inputs[0])
			...
			#reroute_2.Output -> vector_math_001_2.Vector
			dihedral_angle.links.new(reroute_2.outputs[0], vector_math_001_2.inputs[1])
			#mn_utils_vector_angle_002.Angle -> math_7.Value
			dihedral_angle.links.new(mn_utils_vector_angle_002.outputs[0], math_7.inputs[0])
			...
			#group_input_12.B -> vector_math_004_1.Vector
			dihedral_angle.links.new(group_input_12.outputs[1], vector_math_004_1.inputs[1])
			#group_input_12.B -> vector_math_006_1.Vector
			dihedral_angle.links.new(group_input_12.outputs[1], vector_math_006_1.inputs[1])
			...
			dihedral_angle.links.new(math_7.outputs[0], group_output_12.inputs[0])
			#reroute_002_1.Output -> group_output_12.BA⟂(BC)
			dihedral_angle.links.new(reroute_002_1.outputs[0], group_output_12.inputs[1])
			#reroute_2.Output -> group_output_12.BC
			dihedral_angle.links.new(reroute_2.outputs[0], group_output_12.inputs[3])
			#reroute_001_1.Output -> group_output_12.CD⟂(BC)
			dihedral_angle.links.new(reroute_001_1.outputs[0], group_output_12.inputs[2])
			...
			#math_001_2.Value -> math_7.Value
			dihedral_angle.links.new(math_001_2.outputs[0], math_7.inputs[1])
			...
			#group_input_001_1.A -> vector_math_004_1.Vector
			dihedral_angle.links.new(group_input_001_1.outputs[0], vector_math_004_1.inputs[0])
		...
		def _mn_topo_phi_psi_node_group():
			...
			#node Group Output
			group_output_13 = _mn_topo_phi_psi.nodes.new("NodeGroupOutput")
			group_output_13.name = "Group Output"
			group_output_13.is_active_output = True
			
			#node Group Input
			group_input_13 = _mn_topo_phi_psi.nodes.new("NodeGroupInput")
			...
			#Set locations
			group_output_13.location = (698.508544921875, 198.78929138183594)
			group_input_13.location = (-520.0, 280.0)
			...
			#group_009_2.Angle -> group_output_13.Angle
			_mn_topo_phi_psi.links.new(group_009_2.outputs[0], group_output_13.inputs[0])
			#group_009_2.BA⟂(BC) -> group_output_13.BA⟂(BC)
			_mn_topo_phi_psi.links.new(group_009_2.outputs[1], group_output_13.inputs[1])
			#group_009_2.BC -> group_output_13.BC
			_mn_topo_phi_psi.links.new(group_009_2.outputs[3], group_output_13.inputs[3])
			#index_switch.Output -> group_output_13.A
			_mn_topo_phi_psi.links.new(index_switch.outputs[0], group_output_13.inputs[4])
			#group_008_2.CA -> group_output_13.B
			_mn_topo_phi_psi.links.new(group_008_2.outputs[2], group_output_13.inputs[5])
			#index_switch_001.Output -> group_output_13.C
			_mn_topo_phi_psi.links.new(index_switch_001.outputs[0], group_output_13.inputs[6])
			#index_switch_002.Output -> group_output_13.D
			_mn_topo_phi_psi.links.new(index_switch_002.outputs[0], group_output_13.inputs[7])
			#group_009_2.CD⟂(BC) -> group_output_13.CD⟂(BC)
			_mn_topo_phi_psi.links.new(group_009_2.outputs[2], group_output_13.inputs[2])
			#menu_switch.Output -> index_switch.Index
			_mn_topo_phi_psi.links.new(menu_switch.outputs[0], index_switch.inputs[0])
			#group_input_13.Menu -> menu_switch.Menu
			_mn_topo_phi_psi.links.new(group_input_13.outputs[0], menu_switch.inputs[0])
		...
		def between_float_node_group():
			...
			#Socket Boolean
			boolean_socket_4 = between_float.interface.new_socket(name = "Boolean", in_out='OUTPUT', socket_type = 'NodeSocketBool')
			...
			#node Group Output
			group_output_14 = between_float.nodes.new("NodeGroupOutput")
			group_output_14.name = "Group Output"
			group_output_14.is_active_output = True
			
			#node Group Input
			group_input_14 = between_float.nodes.new("NodeGroupInput")
			group_input_14.name = "Group Input"
			
			#node Compare
			compare_3 = between_float.nodes.new("FunctionNodeCompare")
			...
			#node Compare.001
			compare_001_2 = between_float.nodes.new("FunctionNodeCompare")
			compare_001_2.name = "Compare.001"
			compare_001_2.data_type = 'FLOAT'
			compare_001_2.mode = 'ELEMENT'
			compare_001_2.operation = 'GREATER_EQUAL'
			...
			#Set locations
			group_output_14.location = (270.0, 0.0)
			group_input_14.location = (-280.0, 0.0)
			compare_3.location = (-80.0, -80.0)
			compare_001_2.location = (-80.0, 80.0)
			...
			#compare_3.Result -> boolean_math_2.Boolean
			between_float.links.new(compare_3.outputs[0], boolean_math_2.inputs[1])
			#compare_001_2.Result -> boolean_math_2.Boolean
			between_float.links.new(compare_001_2.outputs[0], boolean_math_2.inputs[0])
			#group_input_14.Value -> compare_3.A
			between_float.links.new(group_input_14.outputs[0], compare_3.inputs[2])
			#group_input_14.Value -> compare_001_2.A
			between_float.links.new(group_input_14.outputs[0], compare_001_2.inputs[2])
			#boolean_math_2.Boolean -> group_output_14.Boolean
			between_float.links.new(boolean_math_2.outputs[0], group_output_14.inputs[0])
			#group_input_14.Lower -> compare_001_2.B
			between_float.links.new(group_input_14.outputs[1], compare_001_2.inputs[3])
			#group_input_14.Upper -> compare_3.B
			between_float.links.new(group_input_14.outputs[2], compare_3.inputs[3])
			#group_input_14.Value -> compare_001_2.A
			between_float.links.new(group_input_14.outputs[0], compare_001_2.inputs[0])
			#group_input_14.Value -> compare_3.A
			between_float.links.new(group_input_14.outputs[0], compare_3.inputs[0])
			#group_input_14.Lower -> compare_001_2.B
			between_float.links.new(group_input_14.outputs[1], compare_001_2.inputs[1])
			#group_input_14.Upper -> compare_3.B
			between_float.links.new(group_input_14.outputs[2], compare_3.inputs[1])
		...
		def helix_detect_node_group():
			...
			#Socket Boolean
			boolean_socket_5 = helix_detect.interface.new_socket(name = "Boolean", in_out='OUTPUT', socket_type = 'NodeSocketBool')
			...
			#node Group Output
			group_output_15 = helix_detect.nodes.new("NodeGroupOutput")
			group_output_15.name = "Group Output"
			group_output_15.is_active_output = True
			
			#node Group Input
			group_input_15 = helix_detect.nodes.new("NodeGroupInput")
			...
			#node Math
			math_8 = helix_detect.nodes.new("ShaderNodeMath")
			math_8.name = "Math"
			...
			#node Reroute
			reroute_3 = helix_detect.nodes.new("NodeReroute")
			...
			boolean_math_001 = helix_detect.nodes.new("FunctionNodeBooleanMath")
			...
			boolean_math_003 = helix_detect.nodes.new("FunctionNodeBooleanMath")
			...
			boolean_math_002 = helix_detect.nodes.new("FunctionNodeBooleanMath")
			...
			#Set locations
			group_output_15.location = (680.0, 180.0)
			group_input_15.location = (-800.0, -260.0)
			group_003_2.location = (-500.0, 100.0)
			group_017.location = (320.0, -20.0)
			math_8.location = (-300.0, -180.0)
			reroute_3.location = (-540.0, -200.0)
			group_4.location = (-500.0, 240.0)
			boolean_math_3.location = (-340.0, 240.0)
			boolean_math_001.location = (-40.0, 240.0)
			...
			boolean_math_003.location = (500.0, 180.0)
			...
			boolean_math_002.location = (774.9362182617188, -98.54428100585938)
			...
			#group_input_15.Helix Size -> math_8.Value
			helix_detect.links.new(group_input_15.outputs[0], math_8.inputs[0])
			#group_input_15.Helix Size -> reroute_3.Input
			helix_detect.links.new(group_input_15.outputs[0], reroute_3.inputs[0])
			#reroute_3.Output -> group_003_2.NH Offset
			helix_detect.links.new(reroute_3.outputs[0], group_003_2.inputs[3])
			...
			#boolean_math_001.Boolean -> group_017.Boolean
			helix_detect.links.new(boolean_math_001.outputs[0], group_017.inputs[0])
			#boolean_math_3.Boolean -> boolean_math_001.Boolean
			helix_detect.links.new(boolean_math_3.outputs[0], boolean_math_001.inputs[0])
			#boolean_math_3.Boolean -> group_001_1.Boolean
			helix_detect.links.new(boolean_math_3.outputs[0], group_001_1.inputs[1])
			#group_001_1.Boolean -> boolean_math_001.Boolean
			helix_detect.links.new(group_001_1.outputs[0], boolean_math_001.inputs[1])
			#math_8.Value -> group_001_1.Offset
			helix_detect.links.new(math_8.outputs[0], group_001_1.inputs[2])
			#reroute_3.Output -> group_017.Fill Size
			helix_detect.links.new(reroute_3.outputs[0], group_017.inputs[1])
			#group_017.Boolean -> boolean_math_003.Boolean
			helix_detect.links.new(group_017.outputs[0], boolean_math_003.inputs[0])
			#boolean_math_003.Boolean -> group_output_15.Boolean
			helix_detect.links.new(boolean_math_003.outputs[0], group_output_15.inputs[0])
			#boolean_math_002.Boolean -> boolean_math_003.Boolean
			helix_detect.links.new(boolean_math_002.outputs[0], boolean_math_003.inputs[1])
			...
			#group_005_1.Boolean -> boolean_math_002.Boolean
			helix_detect.links.new(group_005_1.outputs[0], boolean_math_002.inputs[0])
			#group_006.Boolean -> boolean_math_002.Boolean
			helix_detect.links.new(group_006.outputs[0], boolean_math_002.inputs[1])
			return helix_detect
		...
		mod = obj.modifiers.new(name = "Helix Detect", type = 'NODES')
		mod.node_group = helix_detect
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(Helix_Detect.bl_idname)
