...
class Is_Alpha_Carbon(bpy.types.Operator):
	bl_idname = "node.is_alpha_carbon"
	bl_label = "Is Alpha Carbon"
	...
	def execute(self, context):
		...
		mod = obj.modifiers.new(name = "Is Alpha Carbon", type = 'NODES')
		mod.node_group = is_alpha_carbon
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(Is_Alpha_Carbon.bl_idname)
