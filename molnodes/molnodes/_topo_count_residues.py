...
class _Topo_Count_Residues(bpy.types.Operator):
	bl_idname = "node._topo_count_residues"
	bl_label = ".Topo Count Residues"
	...
	def execute(self, context):
		...
		mod = obj.modifiers.new(name = ".Topo Count Residues", type = 'NODES')
		mod.node_group = _topo_count_residues
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(_Topo_Count_Residues.bl_idname)
