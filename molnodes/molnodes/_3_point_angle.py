...
class _3_Point_Angle(bpy.types.Operator):
	bl_idname = "node._3_point_angle"
	bl_label = "3 Point Angle"
	...
	def execute(self, context):
		...
		def _3_point_angle_node_group():
			_3_point_angle = bpy.data.node_groups.new(type = 'GeometryNodeTree', name = "3 Point Angle")
			...
			#Socket Angle
			angle_socket_1 = _3_point_angle.interface.new_socket(name = "Angle", in_out='OUTPUT', socket_type = 'NodeSocketFloat')
			...
			angle_socket_1.description = "Angle between the points around Index B in radians"
			
			#Socket Index A
			index_a_socket = _3_point_angle.interface.new_socket(name = "Index A", in_out='INPUT', socket_type = 'NodeSocketInt')
			...
			#Socket Index B
			index_b_socket = _3_point_angle.interface.new_socket(name = "Index B", in_out='INPUT', socket_type = 'NodeSocketInt')
			...
			#Socket Index C
			index_c_socket = _3_point_angle.interface.new_socket(name = "Index C", in_out='INPUT', socket_type = 'NodeSocketInt')
			...
			#node Group Input
			group_input_1 = _3_point_angle.nodes.new("NodeGroupInput")
			group_input_1.name = "Group Input"
			
			#node Position
			position = _3_point_angle.nodes.new("GeometryNodeInputPosition")
			position.name = "Position"
			
			#node Evaluate at Index.002
			evaluate_at_index_002 = _3_point_angle.nodes.new("GeometryNodeFieldAtIndex")
			...
			evaluate_at_index = _3_point_angle.nodes.new("GeometryNodeFieldAtIndex")
			evaluate_at_index.name = "Evaluate at Index"
			evaluate_at_index.data_type = 'FLOAT_VECTOR'
			evaluate_at_index.domain = 'POINT'
			
			#node Evaluate at Index.001
			evaluate_at_index_001 = _3_point_angle.nodes.new("GeometryNodeFieldAtIndex")
			...
			#node Vector Math
			vector_math_1 = _3_point_angle.nodes.new("ShaderNodeVectorMath")
			vector_math_1.name = "Vector Math"
			vector_math_1.operation = 'SUBTRACT'
			
			#node Vector Math.001
			vector_math_001_1 = _3_point_angle.nodes.new("ShaderNodeVectorMath")
			vector_math_001_1.name = "Vector Math.001"
			vector_math_001_1.operation = 'SUBTRACT'
			
			#node Group Output
			group_output_1 = _3_point_angle.nodes.new("NodeGroupOutput")
			...
			evaluate_at_index_002.location = (-73.662353515625, -160.290283203125)
			evaluate_at_index.location = (-73.662353515625, 159.709716796875)
			evaluate_at_index_001.location = (-73.662353515625, -0.290283203125)
			vector_math_1.location = (106.638427734375, 160.290283203125)
			vector_math_001_1.location = (126.337646484375, -40.290283203125)
			...
			_3_point_angle.links.new(evaluate_at_index_002.outputs[0], vector_math_001_1.inputs[0])
			#vector_math_1.Vector -> group_075.A
			_3_point_angle.links.new(vector_math_1.outputs[0], group_075.inputs[0])
			#evaluate_at_index.Value -> vector_math_1.Vector
			_3_point_angle.links.new(evaluate_at_index.outputs[0], vector_math_1.inputs[0])
			#position.Position -> evaluate_at_index_002.Value
			_3_point_angle.links.new(position.outputs[0], evaluate_at_index_002.inputs[1])
			#evaluate_at_index_001.Value -> vector_math_001_1.Vector
			_3_point_angle.links.new(evaluate_at_index_001.outputs[0], vector_math_001_1.inputs[1])
			#vector_math_001_1.Vector -> group_075.B
			_3_point_angle.links.new(vector_math_001_1.outputs[0], group_075.inputs[1])
			#evaluate_at_index_001.Value -> vector_math_1.Vector
			_3_point_angle.links.new(evaluate_at_index_001.outputs[0], vector_math_1.inputs[1])
			#position.Position -> evaluate_at_index.Value
			_3_point_angle.links.new(position.outputs[0], evaluate_at_index.inputs[1])
			#position.Position -> evaluate_at_index_001.Value
			_3_point_angle.links.new(position.outputs[0], evaluate_at_index_001.inputs[1])
			#group_input_1.Index A -> evaluate_at_index.Index
			_3_point_angle.links.new(group_input_1.outputs[0], evaluate_at_index.inputs[0])
			#group_input_1.Index B -> evaluate_at_index_001.Index
			_3_point_angle.links.new(group_input_1.outputs[1], evaluate_at_index_001.inputs[0])
			#group_input_1.Index C -> evaluate_at_index_002.Index
			_3_point_angle.links.new(group_input_1.outputs[2], evaluate_at_index_002.inputs[0])
			#group_075.Angle -> group_output_1.Angle
			_3_point_angle.links.new(group_075.outputs[0], group_output_1.inputs[0])
		...
		mod = obj.modifiers.new(name = "3 Point Angle", type = 'NODES')
		mod.node_group = _3_point_angle
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(_3_Point_Angle.bl_idname)
