...
class _Topo_Count_Atoms(bpy.types.Operator):
	bl_idname = "node._topo_count_atoms"
	bl_label = ".Topo Count Atoms"
	...
	def execute(self, context):
		...
		mod = obj.modifiers.new(name = ".Topo Count Atoms", type = 'NODES')
		mod.node_group = _topo_count_atoms
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(_Topo_Count_Atoms.bl_idname)
