...
class _DSSP_Sheet_Checks(bpy.types.Operator):
	bl_idname = "node._dssp_sheet_checks"
	bl_label = ".DSSP Sheet Checks"
	...
	def execute(self, context):
		...
		def hbond_backbone_check_backup_node_group():
			...
			#node Group Output
			group_output_9 = hbond_backbone_check_backup.nodes.new("NodeGroupOutput")
			group_output_9.name = "Group Output"
			group_output_9.is_active_output = True
			
			#node Group Input
			group_input_9 = hbond_backbone_check_backup.nodes.new("NodeGroupInput")
			...
			#node Math
			math_5 = hbond_backbone_check_backup.nodes.new("ShaderNodeMath")
			math_5.name = "Math"
			...
			#node Compare
			compare_2 = hbond_backbone_check_backup.nodes.new("FunctionNodeCompare")
			...
			#node Compare.001
			compare_001_1 = hbond_backbone_check_backup.nodes.new("FunctionNodeCompare")
			...
			#group_008_2.Bond Energy -> group_output_9.Bond Energy
			hbond_backbone_check_backup.links.new(group_008_2.outputs[1], group_output_9.inputs[1])
			#group_008_2.Bond Vector -> group_output_9.H->O
			hbond_backbone_check_backup.links.new(group_008_2.outputs[2], group_output_9.inputs[2])
			...
			#math_5.Value -> evaluate_at_index_002_2.Index
			hbond_backbone_check_backup.links.new(math_5.outputs[0], evaluate_at_index_002_2.inputs[0])
			#math_5.Value -> evaluate_at_index_003_2.Index
			hbond_backbone_check_backup.links.new(math_5.outputs[0], evaluate_at_index_003_2.inputs[0])
			#group_input_9.CO Index -> math_5.Value
			hbond_backbone_check_backup.links.new(group_input_9.outputs[0], math_5.inputs[0])
			#group_input_9.CO Offset -> math_5.Value
			hbond_backbone_check_backup.links.new(group_input_9.outputs[1], math_5.inputs[1])
			#group_input_9.NH Index -> math_001_2.Value
			hbond_backbone_check_backup.links.new(group_input_9.outputs[2], math_001_2.inputs[0])
			#group_input_9.NH Offset -> math_001_2.Value
			hbond_backbone_check_backup.links.new(group_input_9.outputs[3], math_001_2.inputs[1])
			#math_5.Value -> math_002_3.Value
			hbond_backbone_check_backup.links.new(math_5.outputs[0], math_002_3.inputs[0])
			...
			#math_003_2.Value -> compare_2.A
			hbond_backbone_check_backup.links.new(math_003_2.outputs[0], compare_2.inputs[0])
			#integer_1.Integer -> compare_2.B
			hbond_backbone_check_backup.links.new(integer_1.outputs[0], compare_2.inputs[1])
			#compare_2.Result -> switch_2.Switch
			hbond_backbone_check_backup.links.new(compare_2.outputs[0], switch_2.inputs[0])
			...
			#vector_math_3.Value -> compare_001_1.A
			hbond_backbone_check_backup.links.new(vector_math_3.outputs[1], compare_001_1.inputs[0])
			#group_4.Angstrom -> compare_001_1.B
			hbond_backbone_check_backup.links.new(group_4.outputs[0], compare_001_1.inputs[1])
			#switch_2.Output -> group_output_9.Is Bonded
			hbond_backbone_check_backup.links.new(switch_2.outputs[0], group_output_9.inputs[0])
		...
		def _hbond_i__j__and_hbond_j__i__node_group():
			...
			#Socket Boolean
			boolean_socket = _hbond_i__j__and_hbond_j__i_.interface.new_socket(name = "Boolean", in_out='OUTPUT', socket_type = 'NodeSocketBool')
			...
			#node Group Output
			group_output_10 = _hbond_i__j__and_hbond_j__i_.nodes.new("NodeGroupOutput")
			group_output_10.name = "Group Output"
			group_output_10.is_active_output = True
			
			#node Group Input
			group_input_10 = _hbond_i__j__and_hbond_j__i_.nodes.new("NodeGroupInput")
			...
			boolean_math_003 = _hbond_i__j__and_hbond_j__i_.nodes.new("FunctionNodeBooleanMath")
			...
			#Set locations
			group_output_10.location = (640.0, 180.0)
			group_input_10.location = (-235.75640869140625, 47.462432861328125)
			group_010_1.location = (-640.0, 40.0)
			group_011.location = (-640.0, -220.0)
			frame_2.location = (635.0, 20.0)
			frame_001.location = (630.0, 140.0)
			boolean_math_003.location = (435.0, 180.0)
			...
			#group_010_1.Is Bonded -> boolean_math_003.Boolean
			_hbond_i__j__and_hbond_j__i_.links.new(group_010_1.outputs[0], boolean_math_003.inputs[0])
			#group_011.Is Bonded -> boolean_math_003.Boolean
			_hbond_i__j__and_hbond_j__i_.links.new(group_011.outputs[0], boolean_math_003.inputs[1])
			#boolean_math_003.Boolean -> group_output_10.Boolean
			_hbond_i__j__and_hbond_j__i_.links.new(boolean_math_003.outputs[0], group_output_10.inputs[0])
			#group_input_10.j -> group_010_1.NH Index
			_hbond_i__j__and_hbond_j__i_.links.new(group_input_10.outputs[1], group_010_1.inputs[2])
			#group_input_10.j -> group_011.CO Index
			_hbond_i__j__and_hbond_j__i_.links.new(group_input_10.outputs[1], group_011.inputs[0])
			#group_input_10.i -> group_010_1.CO Index
			_hbond_i__j__and_hbond_j__i_.links.new(group_input_10.outputs[0], group_010_1.inputs[0])
			#group_input_10.i -> group_011.NH Index
			_hbond_i__j__and_hbond_j__i_.links.new(group_input_10.outputs[0], group_011.inputs[2])
		...
		def _hbond_i___1__j___1__and_hbond_j___1__i___1__node_group():
			...
			#Socket Boolean
			boolean_socket_1 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.interface.new_socket(name = "Boolean", in_out='OUTPUT', socket_type = 'NodeSocketBool')
			...
			#node Group Output
			group_output_11 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.nodes.new("NodeGroupOutput")
			group_output_11.name = "Group Output"
			group_output_11.is_active_output = True
			
			#node Group Input
			group_input_11 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.nodes.new("NodeGroupInput")
			...
			#node Boolean Math.003
			boolean_math_003_1 = _hbond_i___1__j___1__and_hbond_j___1__i___1_.nodes.new("FunctionNodeBooleanMath")
			...
			#Set locations
			group_output_11.location = (625.0, 0.0)
			group_input_11.location = (-394.84100341796875, -236.38262939453125)
			...
			#group_010_2.Is Bonded -> boolean_math_003_1.Boolean
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_010_2.outputs[0], boolean_math_003_1.inputs[0])
			#group_011_1.Is Bonded -> boolean_math_003_1.Boolean
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_011_1.outputs[0], boolean_math_003_1.inputs[1])
			#boolean_math_003_1.Boolean -> group_output_11.Boolean
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(boolean_math_003_1.outputs[0], group_output_11.inputs[0])
			#group_input_11.j -> group_010_2.NH Index
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_input_11.outputs[1], group_010_2.inputs[2])
			#group_input_11.j -> group_011_1.CO Index
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_input_11.outputs[1], group_011_1.inputs[0])
			#group_input_11.i -> group_010_2.CO Index
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_input_11.outputs[0], group_010_2.inputs[0])
			#group_input_11.i -> group_011_1.NH Index
			_hbond_i___1__j___1__and_hbond_j___1__i___1_.links.new(group_input_11.outputs[0], group_011_1.inputs[2])
		...
		def _hbond_i___1_j__and_hbond_j_i___1__node_group():
			...
			#Socket Boolean
			boolean_socket_2 = _hbond_i___1_j__and_hbond_j_i___1_.interface.new_socket(name = "Boolean", in_out='OUTPUT', socket_type = 'NodeSocketBool')
			...
			#node Group Output
			group_output_12 = _hbond_i___1_j__and_hbond_j_i___1_.nodes.new("NodeGroupOutput")
			group_output_12.name = "Group Output"
			group_output_12.is_active_output = True
			
			#node Group Input
			group_input_12 = _hbond_i___1_j__and_hbond_j_i___1_.nodes.new("NodeGroupInput")
			...
			#node Boolean Math.003
			boolean_math_003_2 = _hbond_i___1_j__and_hbond_j_i___1_.nodes.new("FunctionNodeBooleanMath")
			...
			#Set locations
			group_output_12.location = (625.0, 0.0)
			group_input_12.location = (-373.2626953125, 13.94732666015625)
			...
			#group_010_3.Is Bonded -> boolean_math_003_2.Boolean
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_010_3.outputs[0], boolean_math_003_2.inputs[0])
			#group_011_2.Is Bonded -> boolean_math_003_2.Boolean
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_011_2.outputs[0], boolean_math_003_2.inputs[1])
			#boolean_math_003_2.Boolean -> group_output_12.Boolean
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(boolean_math_003_2.outputs[0], group_output_12.inputs[0])
			#group_input_12.j -> group_010_3.NH Index
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_input_12.outputs[1], group_010_3.inputs[2])
			#group_input_12.j -> group_011_2.CO Index
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_input_12.outputs[1], group_011_2.inputs[0])
			#group_input_12.i -> group_010_3.CO Index
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_input_12.outputs[0], group_010_3.inputs[0])
			#group_input_12.i -> group_011_2.NH Index
			_hbond_i___1_j__and_hbond_j_i___1_.links.new(group_input_12.outputs[0], group_011_2.inputs[2])
		...
		def _hbond_j___1_i_and_hbond_i_j___1__node_group():
			...
			#Socket Boolean
			boolean_socket_3 = _hbond_j___1_i_and_hbond_i_j___1_.interface.new_socket(name = "Boolean", in_out='OUTPUT', socket_type = 'NodeSocketBool')
			...
			#node Group Output
			group_output_13 = _hbond_j___1_i_and_hbond_i_j___1_.nodes.new("NodeGroupOutput")
			group_output_13.name = "Group Output"
			group_output_13.is_active_output = True
			
			#node Group Input
			group_input_13 = _hbond_j___1_i_and_hbond_i_j___1_.nodes.new("NodeGroupInput")
			...
			#node Boolean Math.003
			boolean_math_003_3 = _hbond_j___1_i_and_hbond_i_j___1_.nodes.new("FunctionNodeBooleanMath")
			...
			#Set locations
			group_output_13.location = (625.0, 0.0)
			group_input_13.location = (-360.0, 120.0)
			...
			#group_010_4.Is Bonded -> boolean_math_003_3.Boolean
			_hbond_j___1_i_and_hbond_i_j___1_.links.new(group_010_4.outputs[0], boolean_math_003_3.inputs[0])
			#group_011_3.Is Bonded -> boolean_math_003_3.Boolean
			_hbond_j___1_i_and_hbond_i_j___1_.links.new(group_011_3.outputs[0], boolean_math_003_3.inputs[1])
			#boolean_math_003_3.Boolean -> group_output_13.Boolean
			_hbond_j___1_i_and_hbond_i_j___1_.links.new(boolean_math_003_3.outputs[0], group_output_13.inputs[0])
			#group_input_13.j -> group_011_3.NH Index
			_hbond_j___1_i_and_hbond_i_j___1_.links.new(group_input_13.outputs[1], group_011_3.inputs[2])
			#group_input_13.j -> group_010_4.CO Index
			_hbond_j___1_i_and_hbond_i_j___1_.links.new(group_input_13.outputs[1], group_010_4.inputs[0])
			#group_input_13.i -> group_010_4.NH Index
			_hbond_j___1_i_and_hbond_i_j___1_.links.new(group_input_13.outputs[0], group_010_4.inputs[2])
			#group_input_13.i -> group_011_3.CO Index
			_hbond_j___1_i_and_hbond_i_j___1_.links.new(group_input_13.outputs[0], group_011_3.inputs[0])
		...
		def _dssp_sheet_checks_node_group():
			...
			#Socket Boolean
			boolean_socket_4 = _dssp_sheet_checks.interface.new_socket(name = "Boolean", in_out='OUTPUT', socket_type = 'NodeSocketBool')
			...
			#node Group Output
			group_output_14 = _dssp_sheet_checks.nodes.new("NodeGroupOutput")
			group_output_14.name = "Group Output"
			group_output_14.is_active_output = True
			
			#node Group Input
			group_input_14 = _dssp_sheet_checks.nodes.new("NodeGroupInput")
			...
			#node Boolean Math
			boolean_math_1 = _dssp_sheet_checks.nodes.new("FunctionNodeBooleanMath")
			...
			boolean_math_001 = _dssp_sheet_checks.nodes.new("FunctionNodeBooleanMath")
			boolean_math_001.name = "Boolean Math.001"
			boolean_math_001.operation = 'OR'
			
			#node Boolean Math.002
			boolean_math_002 = _dssp_sheet_checks.nodes.new("FunctionNodeBooleanMath")
			...
			boolean_math_1.parent = frame_6
			group_004.parent = frame_001_4
			boolean_math_001.parent = frame_001_4
			group_005.parent = frame_001_4
			
			#Set locations
			group_output_14.location = (570.0, 0.0)
			group_input_14.location = (-657.7005004882812, 1.8694610595703125)
			group_001_1.location = (-800.0, 160.0)
			group_002_1.location = (-800.0, 0.0)
			boolean_math_1.location = (-440.0, 160.0)
			group_004.location = (-800.0, -300.0)
			frame_6.location = (580.0, 180.0)
			frame_001_4.location = (580.0, 180.0)
			boolean_math_001.location = (-440.0, -300.0)
			boolean_math_002.location = (380.0, 140.0)
			...
			#group_001_1.Boolean -> boolean_math_1.Boolean
			_dssp_sheet_checks.links.new(group_001_1.outputs[0], boolean_math_1.inputs[0])
			#group_input_14.j -> group_002_1.j
			_dssp_sheet_checks.links.new(group_input_14.outputs[1], group_002_1.inputs[1])
			#boolean_math_001.Boolean -> boolean_math_002.Boolean
			_dssp_sheet_checks.links.new(boolean_math_001.outputs[0], boolean_math_002.inputs[1])
			#group_004.Boolean -> boolean_math_001.Boolean
			_dssp_sheet_checks.links.new(group_004.outputs[0], boolean_math_001.inputs[0])
			#group_input_14.j -> group_005.j
			_dssp_sheet_checks.links.new(group_input_14.outputs[1], group_005.inputs[1])
			#group_002_1.Boolean -> boolean_math_1.Boolean
			_dssp_sheet_checks.links.new(group_002_1.outputs[0], boolean_math_1.inputs[1])
			#group_input_14.j -> group_001_1.j
			_dssp_sheet_checks.links.new(group_input_14.outputs[1], group_001_1.inputs[1])
			#boolean_math_1.Boolean -> boolean_math_002.Boolean
			_dssp_sheet_checks.links.new(boolean_math_1.outputs[0], boolean_math_002.inputs[0])
			#group_005.Boolean -> boolean_math_001.Boolean
			_dssp_sheet_checks.links.new(group_005.outputs[0], boolean_math_001.inputs[1])
			#group_input_14.j -> group_004.j
			_dssp_sheet_checks.links.new(group_input_14.outputs[1], group_004.inputs[1])
			#boolean_math_002.Boolean -> group_output_14.Boolean
			_dssp_sheet_checks.links.new(boolean_math_002.outputs[0], group_output_14.inputs[0])
			#group_input_14.Index -> group_001_1.i
			_dssp_sheet_checks.links.new(group_input_14.outputs[0], group_001_1.inputs[0])
			#group_input_14.Index -> group_002_1.i
			_dssp_sheet_checks.links.new(group_input_14.outputs[0], group_002_1.inputs[0])
			#group_input_14.Index -> group_004.i
			_dssp_sheet_checks.links.new(group_input_14.outputs[0], group_004.inputs[0])
			#group_input_14.Index -> group_005.i
			_dssp_sheet_checks.links.new(group_input_14.outputs[0], group_005.inputs[0])
			#group_input_14.j -> group_output_14.j
			_dssp_sheet_checks.links.new(group_input_14.outputs[1], group_output_14.inputs[1])
		...
		mod = obj.modifiers.new(name = ".DSSP Sheet Checks", type = 'NODES')
		mod.node_group = _dssp_sheet_checks
		return {'FINISHED'}

def menu_func(self, context):
	self.layout.operator(_DSSP_Sheet_Checks.bl_idname)
